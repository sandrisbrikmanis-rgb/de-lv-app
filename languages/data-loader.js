(function () {
  ...
  function loadScript(src) {
    return new Promise((resolve, reject) => {
      const cacheVersion = window.__APP_DATA_CACHE_VERSION__ || "118";
  ...
  async function loadNativeLanguageData(nativeLanguageCode) {
    ...
    for (const dataset of datasets) {
      ...
      try {
        ...
        if ((nativeLanguage === "lt" || nativeLanguage === "uk" || nativeLanguage === "ru" || nativeLanguage === "sl" || nativeLanguage === "bs" || nativeLanguage === "sr" || nativeLanguage === "hr" || nativeLanguage === "sk" || nativeLanguage === "cs" || nativeLanguage === "fi" || nativeLanguage === "sv" || nativeLanguage === "nb" || nativeLanguage === "nn" || nativeLanguage === "da" || nativeLanguage === "nl" || nativeLanguage === "lb" || nativeLanguage === "fr" || nativeLanguage === "it" || nativeLanguage === "es" || nativeLanguage === "pt" || nativeLanguage === "en" || nativeLanguage === "hu" || nativeLanguage === "is") && dataset === "courseLessons") {
