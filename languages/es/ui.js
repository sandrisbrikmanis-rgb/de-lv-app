window.LANGUAGE_UI_STRINGS = {
  ...
  "notices": {
    ...
    "sessionMovedToKnown": "Las palabras de la sesión pasaron a conocidas.",
    "verbShuffleOn": "Mezcla de verbos.",
    "verbShuffleOff": "Conjugación verbal desactivada.",
    "spellingOn": "Modo de ortografía activado.",
    ...
    "movedToKnown": "¡Palabra movida a Conocidas!",
    "problemsFinishedMoved": "Palabras problemáticas aprendidas. ¡Palabra movida a Conocidas!",
    ...
    "answerRevealed": "La respuesta se revela. La palabra permanece en la sesión.",
    ...
    "showingTimeReview": "Mostrando: {label}.",
    "continueTimeReview": "Continuando: {label}.",
    ...
    "addedMastered": "Palabra añadida a 100% conocida.",
    "alreadyMastered": "La palabra ya está en la lista 100% conocida.",
  ...
  "kurss": {
    ...
    "verbBasics": "Fundamentos de los verbos",
    "verbBasicsDesc": "Personas, formas y verbos frecuentes.",
    ...
    "lessonsSubtitle": "Lecciones en orden secuencial del 1 al 21.",
    ...
    "consonantsDesc": "Los sonidos consonánticos más importantes para principiantes.",
    ...
    "exerciseMeta": {
      ...
      "chooseCasePlural": "¡Pon el caso correcto y hazlo en plural!",
