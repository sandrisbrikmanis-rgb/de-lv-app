const COURSE_LESSON_HTML = {
  "kurssArticlesLesson": "\n  <h3>Artículos</h3>\n\n  <div class=\"artikuli-info artikuli-intro-info\">\n    <span class=\"artikuli-info-icon\">i</span>\n    <div>Vācu artikuls ne vienmēr sakrīt ar latviešu dzimti. Tāpēc lietvārdus vislabāk mācīties kopā ar artikulu.</div>\n  </div>\n\n  <section class=\"artikuli-block\">\n    <h4 class=\"artikuli-header\"><span>•</span>Artículo pieméri</h4>\n    <div class=\"artikuli-grid\">\n      <div class=\"kurss-example\">Der Tisch - galdos</div>\n      <div class=\"kurss-example\">Die Tür — durvis</div>\n      <div class=\"kurss-example\">Das Messer - nazis</div>\n      <div class=\"kurss-example\">Das Mädchen — meitene</div>\n    </div>\n  </section>\n\n  <section class=\"artikuli-block\">\n    <h4 class=\"artikuli-header\"><span>♂</span>Bieži DER</h4>\n    <p class=\"artikuli-explain\">DER bieži ir vīriešu personas, dienas, mēneši, gadalaiki un daži vārdi ar noteiktām galotnēm.</p>\n\n    <h5 class=\"artikuli-subtitle\">Noteikumi</h5>\n    <div class=\"artikuli-grid\">\n      <div class=\"kurss-example\">-er → bieži DER, piemēram: der Computer, der Lehrer <span class=\"artikuli-note\">Bet ne vienmēr</span></div>\n      <div class=\"kurss-example\">-ling → bieži DER, piemēram: der Schmetterling</div>\n      <div class=\"kurss-example\">-ismo → bieži DER, piemēram: der Tourismus, der Kapitalismus</div>\n      <div class=\"kurss-example\">Vīriešu personas → der Mann, der Vater</div>\n      <div class=\"kurss-example\">Profesiones → der Lehrer, der Arzt</div>\n      <div class=\"kurss-example\">Marcas de automóviles → der BMW, der Mercedes</div>\n      <div class=\"kurss-example\">Dienas → der Montag, der Dienstag</div>\n      <div class=\"kurss-example\">Mēneši → de agosto, de diciembre</div>\n      <div class=\"kurss-example\">Gadalaiki → der Sommer, der Winter</div>\n    </div>\n\n    <h5 class=\"artikuli-subtitle\">Pieméri</h5>\n    <div class=\"artikuli-grid\">\n      <div class=\"kurss-example\">Der Mann - vīrietis</div>\n      <div class=\"kurss-example\">Der Vater — tēvs</div>\n      <div class=\"kurss-example\">Der Montag — pirmdiena</div>\n      <div class=\"kurss-example\">Der August - agostos</div>\n      <div class=\"kurss-example\">Der zomer — zomer</div>\n      <div class=\"kurss-example\">Der Lehrer — skolotājs</div>\n      <div class=\"kurss-example\">Der Computer — dadores</div>\n      <div class=\"kurss-example\">Der Schmetterling - taurenis</div>\n    </div>\n  </section>\n\n  <section class=\"artikuli-block\">\n    <h4 class=\"artikuli-header\"><span>♀</span>Bieži DIE</h4>\n    <p class=\"artikuli-explain\">DIE bieži ir sieviešu personas, daudzskaitlis un vārdi ar galotnēm -ung, -heit, -keit, -schaft, -ion, -tät, -ei.</p>\n\n    <h5 class=\"artikuli-subtitle\">Noteikumi</h5>\n    <div class=\"artikuli-grid\">\n      <div class=\"kurss-example\">- → el apartamento, la factura</div>\n      <div class=\"kurss-example\">-heit → die Freiheit, die Gesundheit</div>\n      <div class=\"kurss-example\">-keit → die Möglichkeit</div>\n      <div class=\"kurss-example\">-schaft → la Mannschaft</div>\n      <div class=\"kurss-example\">-ion ​​→ la nación</div>\n      <div class=\"kurss-example\">-tät → la universidad</div>\n      <div class=\"kurss-example\">-ei → die Polizei, die Bäckerei</div>\n      <div class=\"kurss-example\">Sieviešu personas → die Frau, die Mutter</div>\n      <div class=\"kurss-example\">Marcas de motos → Harley-Davidson, Yamaha</div>\n      <div class=\"kurss-example\">Daudzskaitlis → die Autos, die Häuser</div>\n      <div class=\"kurss-example\">Daudzskaitlis gandrīz vienmēr → los Autos, los Häuser, los Kinder</div>\n    </div>\n\n    <h5 class=\"artikuli-subtitle\">Pieméri</h5>\n    <div class=\"artikuli-grid\">\n      <div class=\"kurss-example\">Die Frau — siviete</div>\n      <div class=\"kurss-example\">Die Mutter - māte</div>\n      <div class=\"kurss-example\">Die Wohnung — dzīvoklis</div>\n      <div class=\"kurss-example\">Die Rechnung — rēķins</div>\n      <div class=\"kurss-example\">Die Freiheit — brīvība</div>\n      <div class=\"kurss-example\">Die Möglichkeit — iespēja</div>\n      <div class=\"kurss-example\">La Mannschaft - komanda</div>\n      <div class=\"kurss-example\">Die Nation — nācija</div>\n      <div class=\"kurss-example\">Die Universität — universitāte</div>\n      <div class=\"kurss-example\">Die Polizei — policija</div>\n    </div>\n  </section>\n\n  <section class=\"artikuli-block\">\n    <h4 class=\"artikuli-header\"><span>◇</span>Bieži DAS</h4>\n    <p class=\"artikuli-explain\">DAS bieži ir pamazināmie ar -chen / -lein, daudzi vārdi ar -ment / -um un darbības vārdi kā lietvārdi.</p>\n\n    <h5 class=\"artikuli-subtitle\">Noteikumi</h5>\n    <div class=\"artikuli-grid\">\n      <div class=\"kurss-example\">-chen → das Mädchen, das Häuschen</div>\n      <div class=\"kurss-example\">-lein → das Fräulein</div>\n      <div class=\"kurss-example\">-ment → das Instrumento</div>\n      <div class=\"kurss-example\">-um → das Zentrum, das Museo</div>\n      <div class=\"kurss-example\">Metales → das Gold, das Silber, das Eisen</div>\n      <div class=\"kurss-example\">Elementos Ķīmiskie → das Eisen, das Sauerstoff</div>\n      <div class=\"kurss-example\">Viesnīcas → das Hotel</div>\n      <div class=\"kurss-example\">Krāsas kā lietvārdi → das Rot, das Blau</div>\n      <div class=\"kurss-example\">Darbības vārds kā lietvārds → das Essen, das Lernen</div>\n      <div class=\"kurss-example\">Darbības vārdi kā lietvārdi → das Essen, das Lernen, das Lesen</div>\n    </div>\n\n    <h5 class=\"artikuli-subtitle\">Pieméri</h5>\n    <div class=\"artikuli-grid\">\n      <div class=\"kurss-example\">Das Kind — bērns</div>\n      <div class=\"kurss-example\">Das Mädchen — meitene</div>\n      <div class=\"kurss-example\">Das Häuschen — mājiņa</div>\n      <div class=\"kurss-example\">Das Instrument — instrumentos</div>\n      <div class=\"kurss-example\">Das Zentrum - centros</div>\n      <div class=\"kurss-example\">Museo Das — muzejs</div>\n      <div class=\"kurss-example\">Das Essen — ēšana / ēdiens</div>\n      <div class=\"kurss-example\">Das Lernen — mācīšanās</div>\n    </div>\n  </section>\n\n  <section class=\"artikuli-block\">\n    <h4 class=\"artikuli-header\"><span>!</span>Svarīgi izņēmumi / jāiemācās ar artikulu</h4>\n    <p class=\"artikuli-explain\">Veamos el artículo nunca droši noteikt pēc galotnes vai latviešu dzimtes. Tos vislabāk mācīties kopā ar artikulu.</p>\n    <div class=\"artikuli-grid\">\n      <div class=\"kurss-example\">Die Tür — durvis</div>\n      <div class=\"kurss-example\">Das Messer - nazis</div>\n      <div class=\"kurss-example\">Die Sonne — saule</div>\n      <div class=\"kurss-example\">Der Mond — mēness</div>\n      <div class=\"kurss-example\">Das Mädchen — meitene</div>\n      <div class=\"kurss-example\">Das Auto — automašīna</div>\n      <div class=\"kurss-example\">Der Käse — siers</div>\n      <div class=\"kurss-example\">Die Gabel — dakša</div>\n    </div>\n  </section>\n\n  <div class=\"artikuli-info artikuli-bottom-info\">\n    <span class=\"artikuli-info-icon\">i</span>\n    <div>Galotnes un vārdu groups palīdz uzminēt artikulu, bet tās nav 100% drošs likums. Ja neesi pārliecināts, mācies vārdu kopā ar artikulu.</div>\n  </div>\n",
  "kurssPronounsLesson": "\n            <h3>Vietniekvardi</h3>\n            <p class=\"kurss-lesson-intro\">Nominativ, Akkusativ un Dativ — vietniekvārdu formas.</p>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Nominativo — kas?</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Ich - por ejemplo</div><div class=\"kurss-example\">Vous — hacer</div><div class=\"kurss-example\">Er — viņš</div><div class=\"kurss-example\">Sie — viņa</div><div class=\"kurss-example\">Ex—tas</div><div class=\"kurss-example\">Wir — mēs</div><div class=\"kurss-example\">Ihr—jūs</div><div class=\"kurss-example\">Sie — viņi / viņas</div><div class=\"kurss-example\">Sie - Jūs (pieklājības)</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Akkusativ—ko?</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Mich - manos</div><div class=\"kurss-example\">Di - vamos</div><div class=\"kurss-example\">Ihn—viņu (v.)</div><div class=\"kurss-example\">Sie — viņu (s.)</div><div class=\"kurss-example\">Es - a</div><div class=\"kurss-example\">Uns — mūs</div><div class=\"kurss-example\">Euch—jūs</div><div class=\"kurss-example\">Sie - zij/haar</div><div class=\"kurss-example\">Sie - Jūs (pieklājības)</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Dativ—kam?</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Mir-hombre</div><div class=\"kurss-example\">Dir - tev</div><div class=\"kurss-example\">Ihm—viņam/tam</div><div class=\"kurss-example\">Ihr — viņai</div><div class=\"kurss-example\">Uns - mamás</div><div class=\"kurss-example\">Euch - jums</div><div class=\"kurss-example\">Ihnen - para gallina / gallina</div><div class=\"kurss-example\">Ihnen - Jums (pieklājības)</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>¿Kā izvēlēties formu?</h4>\n              <ul class=\"kurss-summary-list\"><li><span class=\"case-blue\">Nombre</span> — teikuma priekšmets (kas dara?)</li><li><span class=\"case-red\">Akkusativ</span> — tiešais objekts (ko?)</li><li><span class=\"case-green\">Dativo</span> — netiešais objekts (kam?)</li></ul>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Pieméri</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Ich sehe <span class=\"case-red\">Dic</span>. —Es tevi redzu.</div><div class=\"kurss-example\">Ich sehe <span class=\"case-red\">Ihn</span>. — Es viņu redzu.</div><div class=\"kurss-example\">Wir mögen <span class=\"case-red\">Euch</span>. - Mamás jūs patīkat.</div><div class=\"kurss-example\">Ich helfe <span class=\"case-green\">Rico</span>. — Es tev palīdzu.</div><div class=\"kurss-example\">Ich gebe <span class=\"case-green\">Mmm</span> ein Buch. — Es dodu viņam grāmatu.</div><div class=\"kurss-example\">Wir danken <span class=\"case-green\">Euch</span>. — Mēs jums pateicamies.</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>¡Acuerdos!</h4>\n              <p>Nominativ vienmēr ir teikuma priekšmets, bet Akkusativ un Dativ — objekti. Skaties uz darbības vārdu un jautā: <span class=\"case-red\">¿Ko?</span> vai <span class=\"case-green\">¿Kam?</span></p>\n            </section>\n",
  "kurssPronunciationLesson": "\n            <h3>Patskaņi — garš un īss</h3>\n            <p class=\"kurss-lesson-intro\">Vācu valodā patskaņi var būt gari vai īsi. Tas ietekmē vārda izrunu.</p>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Garš patskanis</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Chaud (varm) - limones</div><div class=\"kurss-example\">Tripa (gūt) - laboratorios</div><div class=\"kurss-example\">Tat (tāt) — darbs / rīcība</div><div class=\"kurss-example\">Couloir (flūr) — gaitenis</div><div class=\"kurss-example\">Weg (vēk) — ceļš</div><div class=\"kurss-example\">Choza (hūt) - cepure</div><div class=\"kurss-example\">Hof (hōf) - pagalms</div><div class=\"kurss-example\">Schlaf (šlāf) — miegs</div></div>\n              <p>Ja pēc patskaņa seko viens līdzskanis, patskani bieži izrunā gari.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Īss patskanis</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Pilz (pilc) — sene</div><div class=\"kurss-example\">Mosto (vort) - vārds</div><div class=\"kurss-example\">Mund (munt) - mudo</div><div class=\"kurss-example\">Calvo (balt) - drīz</div><div class=\"kurss-example\">Scharf (šarf) - culo</div><div class=\"kurss-example\">Feld (fieltro) - lauks</div><div class=\"kurss-example\">Voll (fol) - vol</div></div>\n              <p>Ja pēc patskaņa seko divi vai vairāk līdzskaņi, patskani bieži izrunā īsi.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Galotnes en / el / er</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Singen (zingen) - dziedāt</div><div class=\"kurss-example\">Tragen (trāgen) - nido</div><div class=\"kurss-example\">Garten (jardín) - dārzs</div><div class=\"kurss-example\">Vogel (fogel) — putns</div><div class=\"kurss-example\">Segel (zēgel) — bura</div><div class=\"kurss-example\">Braten (brāten) - cepetis</div><div class=\"kurss-example\">Bogen (bōgen) - loks</div><div class=\"kurss-example\">Spiegel (špīgel) - spogulis</div><div class=\"kurss-example\">Dedo (dedo) — pirksts</div><div class=\"kurss-example\">Cabestro (cabestrillo) - turētājs</div><div class=\"kurss-example\">Arbeiter (arbaiter) — strādnieks</div><div class=\"kurss-example\">Häuser (hoizer) - mājas</div><div class=\"kurss-example\">Wieder (vīder) — atkal</div><div class=\"kurss-example\">Breiter (braiter) — platāks</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Burts h kā garumzīme</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Rahmen (rāmen) - rāmis</div><div class=\"kurss-example\">Ohr (ōr) – auxiliar</div><div class=\"kurss-example\">Kohle (kōle) - miradas con los ojos</div><div class=\"kurss-example\">Zahl (cāl) - skaitlis</div><div class=\"kurss-example\">Ihn (īn) — viņu</div><div class=\"kurss-example\">Ihm (īm) — viņam</div><div class=\"kurss-example\">Huhn (hūn) - vista</div><div class=\"kurss-example\">Nahm (nām) — ņēma</div><div class=\"kurss-example\">Nehmen (nēmen) — ņemt</div><div class=\"kurss-example\">Schuh (šū) — kurpe</div></div>\n              <p>Dažos vārdos h pagarina iepriekšējo patskani. Šādos gadījumos h parasti neizrunā.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Galotnes son e</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Lámpara (lampe) — lámpara</div><div class=\"kurss-example\">Hase (hāze) - zaķis</div><div class=\"kurss-example\">Knabe (knābe) - zēns</div><div class=\"kurss-example\">Rabe (rābe) - krauklis</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Garais i = es decir</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Die (dī) — artikuls “morir”</div><div class=\"kurss-example\">Diese (dīze) - šī / šie</div><div class=\"kurss-example\">Wieder (vīder) — atkal</div><div class=\"kurss-example\">Fliege (flīge) - muša</div><div class=\"kurss-example\">Ziege (cīge) - kaza</div><div class=\"kurss-example\">Stiel (štīl) - kāts</div><div class=\"kurss-example\">Voleur (dīp) - zaglis</div><div class=\"kurss-example\">Hier (hīr) - šeit</div></div>\n              <p>Garais i vācu valodā bieži tiek rakstīts kā ie.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Patskaņi dudoso</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Saal (gras) - hal</div><div class=\"kurss-example\">Saat (zāt) - sēja</div><div class=\"kurss-example\">Staat (štāt) - valsts</div><div class=\"kurss-example\">Beere (bēre) - oga</div><div class=\"kurss-example\">Ver (zē) — ezers / jūra</div><div class=\"kurss-example\">Remolacha (bēt) - dobe</div><div class=\"kurss-example\">Bota (bōt) - laiva</div><div class=\"kurss-example\">Moro (mōr) - purvs</div><div class=\"kurss-example\">Moos (mōs) - sūnas</div></div>\n              <p>Dubulie patskaņi parasti tiek izrunāti gari.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>ä</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Varita (vant) — siena</div><div class=\"kurss-example\">Wände (vende) — sienas</div><div class=\"kurss-example\">Vater (fāter) - tēvs</div><div class=\"kurss-example\">Väter (fēter) - vaders</div><div class=\"kurss-example\">Schrank (šrank) - skapis</div><div class=\"kurss-example\">Schränke (šrenke) — skapji</div><div class=\"kurss-example\">Banco (banco) — soles / banka</div><div class=\"kurss-example\">Bänke (benke) - solo</div><div class=\"kurss-example\">Tal (tāl) — ieleja</div><div class=\"kurss-example\">Täler (tēler) — ielejas</div></div>\n              <p>Ä ir a pārskaņojums.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>ö</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Rosa (rōze) - rosa</div><div class=\"kurss-example\">Röschen (rēschen) — rozīte</div><div class=\"kurss-example\">Ofen (ōfen) - krāsns</div><div class=\"kurss-example\">Öfen (ēfen) - krāsnis</div><div class=\"kurss-example\">Roca (rok) - svārki</div><div class=\"kurss-example\">Jupes (jupes) — svārki</div></div>\n              <p>Ö ir o pārskaņojums.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>ü</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Kurz (kurc) — īss</div><div class=\"kurss-example\">Kürzer (kurcer) — īsāks</div><div class=\"kurss-example\">Kunst (kunst) - māksla</div><div class=\"kurss-example\">Künste (künste) - mākslas</div><div class=\"kurss-example\">Murmurar (muter) - māte</div><div class=\"kurss-example\">Mütter (murmullo) - mātes</div></div>\n              <p>Ü ir u pārskaņojums.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Divskaņi: äu</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Baum (baum) - un boom</div><div class=\"kurss-example\">Bäume (boime) - koki</div><div class=\"kurss-example\">Casa (haus) - māja</div><div class=\"kurss-example\">Häuser (hoizer) - mājas</div><div class=\"kurss-example\">Strauch (štrauh) — krūms</div><div class=\"kurss-example\">Sträucher (štroiher) — krūmi</div><div class=\"kurss-example\">Maus (maus) — pele</div><div class=\"kurss-example\">Mäuse (moize) - peles</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Divskaņi: ue</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Heute (hoite) — šodien</div><div class=\"kurss-example\">Leute (loite) - cilvēki</div><div class=\"kurss-example\">Neu (nosotros) — amarillos</div><div class=\"kurss-example\">Neun (noin) — deviņi</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Divskaņi: ei</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Mein (principal) - hombres</div><div class=\"kurss-example\">Dein (dain) — pl</div><div class=\"kurss-example\">Sein (zain) - viņa / viņas / būt</div><div class=\"kurss-example\">Frei (frai) - brīvs</div><div class=\"kurss-example\">Arbeiten (arbaiten) - strādāt</div></div>\n            </section>\n            <section class=\"kurss-lesson-section\">\n              <h4>2. lekcijas izrunas piezīmes</h4>\n              <ul class=\"kurss-summary-list\"><li>Vārdos ich, nicht, rechnen, zeichnen “ch” izrunā mīksti</li><li>Vārdos arbeiten un zeichnen “ei” izrunā kā “ai”</li><li>“sp” vārda sākumā izrunā kā “šp”</li><li>Darbības vārdā tun burts “u” izrunājams garš</li></ul>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Kopsavilkums</h4>\n              <ul class=\"kurss-summary-list\"><li>Viens līdzskanis pēc patskaņa → bieži garš patskanis</li><li>Divi vai vairāk līdzskaņi → bieži īss patskanis</li><li>H var pagarināt patskani</li><li>Es decir, bieži nozīmē garo i</li><li>Dudoso patskaņi parasti ir gari</li></ul>\n            </section>",
  "kurssConsonantsLesson": "\n            <h3>Līdzskaņi un burtu savienojumi</h3>\n            <p class=\"kurss-lesson-intro\">Vācu valodā daži līdzskaņi un burtu savienojumi tiek izrunāti citādi nekā tos raksta. Šajā lekcijā ir svarīgākie piemēri iesācējam.</p>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Enlaces médicos</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Das Rad (rāt) - ritenis</div><div class=\"kurss-example\">Die Räder (rēder) — riteņi</div><div class=\"kurss-example\">Malo (bāt) - vanna</div><div class=\"kurss-example\">Bäder (bēder) - vannas</div></div>\n              <p>Vārda beigās līdzskaņi bieži netiek izrunāti tāpat kā rakstīti.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>ch</h4>\n              <p>“ch” var izrunāt mīksti vai cieti. Dažos vārdos tas skan kā “h”, citos tuvāk “k”.</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Rechnen (rehnen) - rēķināt</div><div class=\"kurss-example\">Zeichnen (caihnen) - zīmēt</div><div class=\"kurss-example\">Nicht (niht) - ne</div><div class=\"kurss-example\">Malo (šleht) - slikts</div><div class=\"kurss-example\">Mich (mih) - manos</div><div class=\"kurss-example\">Dich (dih) - estar allí</div><div class=\"kurss-example\">Strauch (štrauh) — krūms</div><div class=\"kurss-example\">Noch (noh) - vēl</div><div class=\"kurss-example\">Nacht (naht) - nakts</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Sch</h4>\n              <p>“sch” vācu valodā izrunā kā latviešu “š”.</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Schule (šūle) - skola</div><div class=\"kurss-example\">Schüler (šūler) — skolēns</div><div class=\"kurss-example\">Schiff (šif) — kuģis</div><div class=\"kurss-example\">Schraube (šraube) — skrūve</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Sp un st vārda sākumā</h4>\n              <p>Vārda vai zilbes sākumā “sp” bieži izrunā kā “šp”, bet “st” kā “št”.</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Spielen (špīlen) — spēlēt</div><div class=\"kurss-example\">Sprung (šprung) — lēciens</div><div class=\"kurss-example\">Stehen (štēen) — stāvēt</div><div class=\"kurss-example\">Puesto (štal) - kūts</div><div class=\"kurss-example\">Stand (štant) — stāvoklis / prohíbe</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>qu</h4>\n              <p>“qu” vācu valodā parasti izrunā kā “kv”.</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Qual (kvāl) - mokas</div><div class=\"kurss-example\">Quartier (kvartīr) - kvartāls / apmešanās prohíbe</div><div class=\"kurss-example\">Quer (kvēr) — šķērsām</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>S a z</h4>\n              <p>Vārda sākumā “s” bieži skan kā “z”. Burts “z” vācu valodā skan kā latviešu “c”.</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Sagen (zāgen) - teikt</div><div class=\"kurss-example\">Singen (zingen) - dziedāt</div><div class=\"kurss-example\">Rosa (rōze) - rosa</div><div class=\"kurss-example\">Zahl (cāl) - skaitlis</div><div class=\"kurss-example\">Zeit (cait) - laiks</div><div class=\"kurss-example\">Zink (cink) - cinks</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>v</h4>\n              <p>Vācu valodā “v” bieži izrunā kā “f”. Svešvārdos tas bieži skan kā latviešu “v”.</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Vater (fāter) - tēvs</div><div class=\"kurss-example\">Von (fon)—no</div><div class=\"kurss-example\">Beaucoup (fīl) - daudz</div><div class=\"kurss-example\">Vier (fīr) — četri</div><div class=\"kurss-example\">Villa (villa) — villa</div><div class=\"kurss-example\">Klavier (klavīr) - klavieres</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>X e y</h4>\n              <p>“x” izrunā kā “ks”. “y” dažos vārdos izrunā kā “ü”.</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Felix (fēliks) — Fēlikss</div><div class=\"kurss-example\">Axt (akst) - cirvis</div><div class=\"kurss-example\">Mystik (mūstik) - mistika</div><div class=\"kurss-example\">Nyx (nūks) — Nikse</div><div class=\"kurss-example\">Mythe (mūte) - mīts</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>ß</h4>\n              <p>“ß” vācu valodā izrunā kā “s”.</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Fuß (fūs) - pēda</div><div class=\"kurss-example\">Füße (fūse) - pēdas</div><div class=\"kurss-example\">Grüße (grūse) — sveicieni</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Kopsavilkums</h4>\n              <ul class=\"kurss-summary-list\"><li>Sch → š</li><li>Sp / st sākumā → šp / št</li><li>Qu → kv</li><li>Z → c</li><li>V bieži → f</li><li>X → ks</li><li>SS → s</li></ul>\n            </section>",
  "kurssVerbBasicsLesson": "\n            <h3>Darbības vārdu pamati</h3>\n            <p class=\"kurss-lesson-intro\">1. lekcijas darbības vārdi un locījumi.</p>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Darbības vārdi</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Kommen — nākt</div><div class=\"kurss-example\">Gehen - es decir</div><div class=\"kurss-example\">Stehen — stāvēt</div><div class=\"kurss-example\">Singen — dziedāt</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Kommen</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Ich komme — es nāku</div><div class=\"kurss-example\">Du kommst — tu nāc</div><div class=\"kurss-example\">Er kommt — viņš nāk</div><div class=\"kurss-example\">Sie kommt — viņa nāk</div><div class=\"kurss-example\">Wir kommen - we komen eraan</div><div class=\"kurss-example\">Ihr kommt — jūs nākat</div><div class=\"kurss-example\">Sie kommen — viņi / viņas nāk</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Gehen</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Ich gehe — es eju</div><div class=\"kurss-example\">Du gehst — tu ej</div><div class=\"kurss-example\">Er geht — viņš iet</div><div class=\"kurss-example\">Sie geht — viņa iet</div><div class=\"kurss-example\">Wir gehen — mēs ejam</div><div class=\"kurss-example\">Ihr geht — jūs ejat</div><div class=\"kurss-example\">Sie gehen — viņi / viņas iet</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Esteban</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Ich stehe - Ik sta</div><div class=\"kurss-example\">Du stehst—tu stāvi</div><div class=\"kurss-example\">Er steht — viņš stāv</div><div class=\"kurss-example\">Sie steht — viņa stāv</div><div class=\"kurss-example\">Wir stehen—mēs stāvam</div><div class=\"kurss-example\">Ihr steht—jūs stāvat</div><div class=\"kurss-example\">Sie stehen — viņi / viņas stāv</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Cantar</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Me chamusco — es dziedu</div><div class=\"kurss-example\">Du singst - tu dziedi</div><div class=\"kurss-example\">Er singt — viņš dzied</div><div class=\"kurss-example\">Sie singt — viņa dzied</div><div class=\"kurss-example\">Wir singen — mēs dziedam</div><div class=\"kurss-example\">Ihr singt — jūs dziedat</div><div class=\"kurss-example\">Sie singen — viņi / viņas dzied</div></div>\n            </section>\n            <section class=\"kurss-lesson-section\">\n              <h4>2. lekcijas darbības vārdi</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Juegos — spēlēt</div><div class=\"kurss-example\">Arbeiten — strādāt</div><div class=\"kurss-example\">Fragen — jautāt</div><div class=\"kurss-example\">Respuestas — atbildēt</div><div class=\"kurss-example\">Rechnen — rēķināt</div><div class=\"kurss-example\">Zeichnen — zīmēt</div><div class=\"kurss-example\">Tun—darīt</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Juegos</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Ich spiele — es spēlēju</div><div class=\"kurss-example\">Du spielst — tu spēlē</div><div class=\"kurss-example\">Er spielt - hij speelt</div><div class=\"kurss-example\">Sie spielt — viņa spēlē</div><div class=\"kurss-example\">Wir spielen — mēs spēlējam</div><div class=\"kurss-example\">Ihr spielt — jūs spēlējat</div><div class=\"kurss-example\">Sie spielen — viņi / viņas spēlē</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Arbeiten</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Ich arbeite—es strādāju</div><div class=\"kurss-example\">Du arbeitest—tu strādā</div><div class=\"kurss-example\">Er arbeitet—viņš strādā</div><div class=\"kurss-example\">Sie arbeitet—viņa strādā</div><div class=\"kurss-example\">Wir arbeiten — mēs strādājam</div><div class=\"kurss-example\">Ihr arbeitet—jūs strādājat</div><div class=\"kurss-example\">Sie arbeiten—viņi / viņas strādā</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Fragen</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Ich frage — es jautāju</div><div class=\"kurss-example\">Du fragst — tu jautā</div><div class=\"kurss-example\">La demanda — viņš jautā</div><div class=\"kurss-example\">Sie fragt — viņa jautā</div><div class=\"kurss-example\">Wir fragen — mēs jautājam</div><div class=\"kurss-example\">Ihr fragt—jūs jautājat</div><div class=\"kurss-example\">Sie fragen — viņi / viņas jautā</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Responder</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Ich antworte — es atbildu</div><div class=\"kurss-example\">Du respuesta — usted atbildi</div><div class=\"kurss-example\">Er antwortet — viņš atbild</div><div class=\"kurss-example\">Sie antortet - zij antwoordt</div><div class=\"kurss-example\">Wir antworten — mēs atbildam</div><div class=\"kurss-example\">Ihr antwortet — jūs atbildat</div><div class=\"kurss-example\">Sie antworten — viņi / viņas atbild</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Rechnen</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Ich rechne — es rēķinu</div><div class=\"kurss-example\">Du rechnest — tu rēķini</div><div class=\"kurss-example\">Er rechnet — viņš rēķina</div><div class=\"kurss-example\">Sie rechnet — viņa rēķina</div><div class=\"kurss-example\">Wir rechnen — mēs rēķinām</div><div class=\"kurss-example\">Ihr rechnet — jūs rēķināt</div><div class=\"kurss-example\">Sie rechnen — viņi / viņas rēķina</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Zeichnen</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Ich zeichne — es zīmēju</div><div class=\"kurss-example\">Du zeichnest — tu zīmē</div><div class=\"kurss-example\">Er zeichnet — viņš zīmē</div><div class=\"kurss-example\">Sie zeichnet — viņa zīmē</div><div class=\"kurss-example\">Wir zeichnen — mēs zīmējam</div><div class=\"kurss-example\">Ihr zeichnet — jūs zīmējat</div><div class=\"kurss-example\">Sie zeichnen — viņi / viņas zīmē</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Tonel</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Ich tue — es daru</div><div class=\"kurss-example\">Du tust - tu dari</div><div class=\"kurss-example\">Er todo - viņš dara</div><div class=\"kurss-example\">Sie tut — viņa dara</div><div class=\"kurss-example\">Wir tun — mēs darām</div><div class=\"kurss-example\">Ihr tut—jūs darāt</div><div class=\"kurss-example\">Sie tun — viņi / viņas dara</div></div>\n            </section>",
  "kurssSentenceStructureLesson": "\n            <h3>Teikumu uzbūve</h3>\n            <p class=\"kurss-lesson-intro\">Jautājuma teikumā darbības vārds vācu valodā parasti stāv pirmajā vietā.</p>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Pieméri</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Du kommst. — Tú nāc.</div><div class=\"kurss-example\">Kommst du? — ¿Vas a nāc?</div><div class=\"kurss-example\">Er canta. —Viņš dzied.</div><div class=\"kurss-example\">¿Cantar? — ¿Ir viņš dzied?</div><div class=\"kurss-example\">Stehst du? - ¿Vas a ir?</div><div class=\"kurss-example\">Ja, ich stehe. — Jā, es stāvu.</div><div class=\"kurss-example\">¿Geht ihr? — ¿Vai jūs ejat?</div><div class=\"kurss-example\">Sí, lo haremos. — Jā, mēs ejam.</div></div>\n            </section>\n            <section class=\"kurss-lesson-section\">\n              <h4>Jautājumi ar “era”</h4>\n              <p>Jautājums sākas ar jautājamo vārdu, darbības vārds vācu valodā parasti stāv tūlīt aiz jautājamā vārda.</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">¿Eras tú? — ¿Ko tu dari?</div><div class=\"kurss-example\">¿Fue todo? — Ko viņš dara?</div><div class=\"kurss-example\">¿Estaba todo allí? — Ko viņa dara?</div><div class=\"kurss-example\">¿Era éste? — Ko viņi / viņas dara?</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Los noliegums son “nicht”</h4>\n              <p>Ja noliegums “nicht” attiecas uz darbības vārdu, tas vācu valodā parasti stāv pēc darbības vārda.</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">No hablo. — Es nespēlēju.</div><div class=\"kurss-example\">Fragmento de Paul nicht. — Paulus vraagt ​​​​het niet.</div><div class=\"kurss-example\">Er kommt nicht. — Viņš nenāk.</div><div class=\"kurss-example\">Singen nicht. — Viņi / viņas nedzied.</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Teikumi no 2. lekcijas</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Spielst du? — ¿Vas a spēlē?</div><div class=\"kurss-example\">Nein, ich spiele nicht, ich arbeite. — Nē, es nespēlēju, es strādāju.</div><div class=\"kurss-example\">Paul fragt nicht, er arbeitet. —Paul nejautā, viņš strādā.</div><div class=\"kurss-example\">Arbeitest du? — ¿Vas a la calle?</div><div class=\"kurss-example\">Nein, ich arbeite nicht, ich singe. — Nē, es nestrādāju, es dziedu.</div><div class=\"kurss-example\">¿Fue todo Pablo? —¿Ko dara Paul?</div><div class=\"kurss-example\">Er dijo. — Viņš spēlē.</div><div class=\"kurss-example\">¿Fue todo María? — ¿Ko dara María?</div><div class=\"kurss-example\">Sie canta. —Viña dzied.</div><div class=\"kurss-example\">Paul spielt, aber María singt. — Paul spēlē, apuesta María dzied.</div><div class=\"kurss-example\">¿Estás cantando? — Vai jūs dziedat?</div><div class=\"kurss-example\">Nein, wir singen nicht, wir arbeiten. — Nē, mēs nedziedam, mēs strādājam.</div><div class=\"kurss-example\">¿Fueron Pablo y María? — ¿Qué le diría Pablo a María?</div><div class=\"kurss-example\">Sie fragen. — Viņi jautā.</div><div class=\"kurss-example\">No valen la pena. — Viņi nicebild.</div><div class=\"kurss-example\">¿Estamos beitet? — ¿Kas strādā?</div><div class=\"kurss-example\">Wir arbeiten. —Mēs strādājam.</div><div class=\"kurss-example\">Wir rechnen und zeichnen. — Mēs rēķinām un zīmējam.</div><div class=\"kurss-example\">Eres como, eres fragen, eres antworten, eres arbeiten, eres spielen, estás cantando, eres gehen. — Viņi / viņas nāk, jautā, atbild, strādā, spēlē, dzied un iet.</div></div>\n            </section>",
  "kurssLesson2": "            <h3>Lekcija 2</h3>\n            <p class=\"kurss-lesson-intro\">Otrā lekcija: dialogi, vārdi, izruna, gramatika un pārtulkošana.</p>\n            <details class=\"lesson1-accordion\" open>\n              <summary><span class=\"lesson1-number lesson1-number-red\">1.</span><span>Diálogos / teikumi</span><span class=\"lesson1-chevron\">⌃</span></summary>\n              <div class=\"lesson1-content\">\n                <div class=\"lesson1-card-grid\">\n                  <div class=\"kurss-example\">Spielst du?<br>Nein, ik speel niet, ik ben niet bezig.</div>\n                  <div class=\"kurss-example\">Paul fragt nicht, er arbeitet.</div>\n                  <div class=\"kurss-example\">Arbeitest du?<br>Nein, ich arbeite nicht, ich singe.</div>\n                  <div class=\"kurss-example\">¿Fue todo Pablo?<br>La joue.</div>\n                  <div class=\"kurss-example\">¿Fue todo María?<br>Sie canta.</div>\n                  <div class=\"kurss-example\">Paul spielt, aber María singt.</div>\n                  <div class=\"kurss-example\">¿Estás cantando?<br>Nein, wir singen nicht, wir arbeiten.</div>\n                  <div class=\"kurss-example\">¿Fueron Pablo y María?<br>Sie fragen.<br>No valen la pena.</div>\n                  <div class=\"kurss-example\">¿Estamos beitet?<br>Wir arbeiten.<br>Wir rechnen und zeichnen.</div>\n                  <div class=\"kurss-example\">Eres como, eres fragen, eres antworten, eres arbeiten, eres spielen, estás cantando, eres gehen.</div>\n                </div>\n              </div>\n            </details>\n            <details class=\"lesson1-accordion\">\n              <summary><span class=\"lesson1-number lesson1-number-green\">2.</span><span>Vardi</span><span class=\"lesson1-chevron\">⌄</span></summary>\n              <div class=\"lesson1-content\">\n                <div class=\"lesson1-card-grid\">\n                  <div class=\"kurss-example\">Juegos — rotaļāties • Spēlēt</div>\n                  <div class=\"kurss-example\">Nein - nē</div>\n                  <div class=\"kurss-example\">Nicht - niet</div>\n                  <div class=\"kurss-example\">Arbeiten — strādāt</div>\n                  <div class=\"kurss-example\">Fragen — jautāt</div>\n                  <div class=\"kurss-example\">¿Fue todo? — ko viņš dara?</div>\n                  <div class=\"kurss-example\">¿Era éste? — ko viņi / viņas dara?</div>\n                  <div class=\"kurss-example\">Aber - apuesta</div>\n                  <div class=\"kurss-example\">Respuestas — atbildēt</div>\n                  <div class=\"kurss-example\">Rechnen — rēķināt</div>\n                  <div class=\"kurss-example\">Zeichnen — zīmēt</div>\n                  <div class=\"kurss-example\">María - María</div>\n                </div>\n              </div>\n            </details>\n                        <details class=\"lesson1-accordion\">\n              <summary><span class=\"lesson1-number lesson1-number-purple\">3.</span><span>Izruná</span><span class=\"lesson1-chevron\">⌄</span></summary>\n              <div class=\"lesson1-content\">\n                <div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Vārdos ich, nicht, rechnen, zeichnen skaņu ch izrunā mīksti, apmēram tā, kā latviski vārdos: technika, Frīdrihs.</div><div class=\"kurss-example\">Vārdos arbeiten, zeichnen divskani ei izrunā apmēram kā latviešu plato e skaņu, kam seko i.</div><div class=\"kurss-example\">Līdzskaņu kopojumu sp izrunā kā šp: spielen (špīlen).</div><div class=\"kurss-example\">Darbības vārdā tun u izrunājams gari visās personās.</div></div>\n              </div>\n            </details>\n<details class=\"lesson1-accordion\">\n              <summary><span class=\"lesson1-number lesson1-number-blue\">4.</span><span>Gramática</span><span class=\"lesson1-chevron\">⌄</span></summary>\n              <div class=\"lesson1-content lesson1-grammar-content\">\n                <section class=\"lesson1-block\">\n                  <h4 class=\"lesson1-grammar-header\"><span>1</span>Galotnes son e</h4>\n                  <div class=\"lesson1-grammar-note\">Ja darbības vārda celms beidzas ar t, d, chn, tad lokot galotņu -st un -t priekšā stāv e.</div>\n                  <h5 class=\"lesson2-subtitle\">Arbeiten</h5>\n                  <div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Yo arbeite</div><div class=\"kurss-example\">Du arbeitest</div><div class=\"kurss-example\">Er beitet</div><div class=\"kurss-example\">Sie arbeitet</div><div class=\"kurss-example\">Nosotros arbeiten</div><div class=\"kurss-example\">Su arbeitet</div><div class=\"kurss-example\">Estan listos</div></div>\n                  <h5 class=\"lesson2-subtitle\">Rechnen</h5>\n                  <div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Ich rechne</div><div class=\"kurss-example\">Du rechnest</div><div class=\"kurss-example\">Er rechnet</div><div class=\"kurss-example\">Sie rechnet</div><div class=\"kurss-example\">Nosotros rechnen</div><div class=\"kurss-example\">Su derecho</div><div class=\"kurss-example\">Sie rechnen</div></div>\n                  <h5 class=\"lesson2-subtitle\">Tonel</h5>\n                  <div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Soy tuyo</div><div class=\"kurss-example\">Du tust</div><div class=\"kurss-example\">Er todo</div><div class=\"kurss-example\">Si todos</div><div class=\"kurss-example\">Wir tun</div><div class=\"kurss-example\">En todos</div><div class=\"kurss-example\">Si tun</div></div>\n                </section>\n                <section class=\"lesson1-block\">\n                  <h4 class=\"lesson1-grammar-header\"><span>2</span>Jautājamais vārds</h4>\n                  <div class=\"lesson1-grammar-note\">Jautājamos teikumos, kas sākas ar jautājamo vārdu, piemēram: ko? kas? ¿kursh? kāpēc? kādēļ? etc., darbības vārds stāv tūlīt aiz jautājamā vārda.</div>\n                  <div class=\"lesson1-card-grid\"><div class=\"kurss-example\">¿Eras tú? — ¿Ko tu dari?</div><div class=\"kurss-example\">¿Fue todo? — Ko viņš dara?</div><div class=\"kurss-example\">¿Estaba todo allí? — Ko viņa dara?</div><div class=\"kurss-example\">¿Era éste? — Ko viņi / viņas dara?</div></div>\n                </section>\n                <section class=\"lesson1-block\">\n                  <h4 class=\"lesson1-grammar-header\"><span>3</span>Ontkenning se reunió con la noche</h4>\n                  <div class=\"lesson1-grammar-note\">Ja noliegums nicht attiecas uz darbības vārdu, tad noliedzamais vārds stāv pēc darbības vārda.</div>\n                  <div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Er kommt nicht. — Viņš nenāk.</div><div class=\"kurss-example\">Singen nicht. —Viņi nedzied.</div></div>\n                </section>\n              </div>\n            </details>\n                                    <details class=\"lesson1-accordion\">\n              <summary><span class=\"lesson1-number lesson1-number-orange\">5.</span><span>Partulko</span><span class=\"lesson1-chevron\">⌄</span></summary>\n              <div class=\"lesson1-content\">\n                <div class=\"lesson1-training-wrap\">\n                  <button class=\"lesson1-training-flashcard\" type=\"button\" data-lesson2-training-card data-training-index=\"0\" data-showing-back=\"false\" aria-label=\"Lekcija 2 pārtulkošanas kartīte\">\n                    <span class=\"lesson1-training-progress\">Lekcija 2 · Partulko: 1 / 15</span>\n                    <span class=\"lesson1-training-text\">Kas jauta?</span>\n                  </button>\n                  <p class=\"lesson1-training-hint\">Klikšķini uz kartītes, lai redzētu vācu tulkojumu. Pēc atbildes nākamais klikšķis rāda nākamo kartīti.</p>\n                </div>\n              </div>\n            </details>",
  "kurssLesson6": "\n    <h3>Lekcija 6</h3>\n    <p class=\"kurss-lesson-intro\">Skaitļi, daudzskaitlis, umlauti un lietvārdu daudzskaitļa formas.</p>\n\n    <details class=\"lesson1-accordion\" open>\n      <summary><span class=\"lesson1-number lesson1-number-red\">1.</span><span>Diálogos / teikumi</span><span class=\"lesson1-chevron\">⌄</span></summary>\n      <div class=\"lesson1-content\"><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Heer liegt ein Bleistift.</div><div class=\"kurss-example\">Dort liegen einige Messer.</div><div class=\"kurss-example\">Edgar toma un couteau, deux couteaux, trois couteaux.</div><div class=\"kurss-example\">Er lee die Messer wieder hin.</div><div class=\"kurss-example\">Todos los messer sin bufanda.</div><div class=\"kurss-example\">Dann nimmt er wieder ein Messer.</div><div class=\"kurss-example\">Er macht das Messer auf.</div><div class=\"kurss-example\">Er nimmt den Bleistift.</div><div class=\"kurss-example\">Er spitzt den Bleistift an.</div><div class=\"kurss-example\">Er leyó das Messer hin.</div><div class=\"kurss-example\">Er setzt sich und zeichnet.</div><div class=\"kurss-example\">¿Fue zeichnet er? Er zeichnet einen Schlüssel.</div><div class=\"kurss-example\">Gertrud zeichnet a Fenster und a Tafel.</div><div class=\"kurss-example\">Anna zeichnet einen Garten.</div><div class=\"kurss-example\">Hier liegen vier Löffel.</div><div class=\"kurss-example\">Dort liegen fünf Nadeln.</div><div class=\"kurss-example\">Gertrud kommt und zählt die Löffel: das est ein Löffel • Das sind dos, drei, vier Löffel.</div><div class=\"kurss-example\">Anna zählt die Nadeln: das ist eine Nadeln • Das sind dos, drei, vier, fünf Nadeln.</div><div class=\"kurss-example\">Wieviel Nadeln ¿está aquí?</div><div class=\"kurss-example\">Aquí hay un Nadel.</div><div class=\"kurss-example\">Dort sind zwei, drei, vier Nadeln.</div><div class=\"kurss-example\">Fünf Schlüssel está aquí.</div><div class=\"kurss-example\">Sechs Löffel sind dort.</div><div class=\"kurss-example\">¿Fue esto?</div><div class=\"kurss-example\">Este es un martillo. Este es Hammer.</div><div class=\"kurss-example\">Este es un Deckel. Este es Deckel.</div><div class=\"kurss-example\">Este es un Eimer. Este es Eimer.</div><div class=\"kurss-example\">Este es un cajero. Éste es Teller.</div><div class=\"kurss-example\">Este es un auto. Estos no son autos.</div><div class=\"kurss-example\">Este es un Schlitten. Esto es exactamente lo que es Schlitten.</div><div class=\"kurss-example\">¿Cómo sind die Dinge?</div><div class=\"kurss-example\">El Martillo es pequeño. Los Hämmer son pequeños.</div><div class=\"kurss-example\">Der Deckel es grande. Los Deckel son grandes.</div><div class=\"kurss-example\">Der Eimer está voll. Die Eimer sind voll.</div><div class=\"kurss-example\">Se lee Der Teller. Die Teller sind leer.</div><div class=\"kurss-example\">Der Wagen ist schwer. Die Wagen sind schwer.</div><div class=\"kurss-example\">Der Schlitten es justo. Die Schlitten sind leicht.</div></div></div>\n    </details>\n\n    <details class=\"lesson1-accordion\">\n      <summary><span class=\"lesson1-number lesson1-number-green\">2.</span><span>Vardi</span><span class=\"lesson1-chevron\">⌄</span></summary>\n      <div class=\"lesson1-content\"><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Ontkennen - gelokaliseerd, es, liegt</div><div class=\"kurss-example\">Der Bleistift (bleištift) — zīmulis</div><div class=\"kurss-example\">Einige (einige) — daži</div><div class=\"kurss-example\">Hinlegen — nolikt</div><div class=\"kurss-example\">Legt hin — noliek</div><div class=\"kurss-example\">Wieder (vīder) — atkal</div><div class=\"kurss-example\">Aufmachen—attaīsīt</div><div class=\"kurss-example\">Er macht auf — viņš attaisa</div><div class=\"kurss-example\">Anspitzen (anšpicen) — uzsmailināt</div><div class=\"kurss-example\">Er spitzt an — viņš uzsmailina</div><div class=\"kurss-example\">Sich setzen — apsēsties</div><div class=\"kurss-example\">Setzt sich — apsēžas</div><div class=\"kurss-example\">Der Schlüssel (šlūsel) — atslēga</div><div class=\"kurss-example\">Das Fenster (fenster) - troncos</div><div class=\"kurss-example\">Die Tafel (dī tāfel) - tāfele</div><div class=\"kurss-example\">Der Garten — dārzs</div><div class=\"kurss-example\">Der Löffel - karote</div><div class=\"kurss-example\">Zählen (cēlen) — skaitīt</div><div class=\"kurss-example\">Die Nadel — adata</div><div class=\"kurss-example\">Was ist das — kas tas ir?</div><div class=\"kurss-example\">El martillo - veseris</div><div class=\"kurss-example\">Sterven Hämmer - martillos</div><div class=\"kurss-example\">Der Deckel (dēr dekel) - vāks</div><div class=\"kurss-example\">Der Teller — šķīvis</div><div class=\"kurss-example\">Der Wagen — rati</div><div class=\"kurss-example\">Der Schlitten - ragavas, kamanas</div><div class=\"kurss-example\">Das Ding - feliz</div><div class=\"kurss-example\">Die Dinge - feliz</div><div class=\"kurss-example\">¿Cómo sind die Dinge? — kādas ir happyas?</div><div class=\"kurss-example\">Voll (fōl) - pilns</div><div class=\"kurss-example\">Leer (lēr) — tukšs</div><div class=\"kurss-example\">Schwer (švēr) - smags, grūts</div><div class=\"kurss-example\">Leicht — viegls</div><div class=\"kurss-example\">Der Eimer - España</div><div class=\"kurss-example\">Combien (vīfīl) — cik</div><div class=\"kurss-example\">Wieviel Nadeln — cik adatu</div><div class=\"kurss-example\">Hier (hīr) - šeit</div><div class=\"kurss-example\">Dort — recorrido</div></div></div>\n    </details>\n\n    <details class=\"lesson1-accordion\">\n      <summary><span class=\"lesson1-number lesson1-number-purple\">3.</span><span>Izruná</span><span class=\"lesson1-chevron\">⌄</span></summary>\n      <div class=\"lesson1-content\"><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Ä ir patskaņa a pārskanojums, un to izrunā kā īso vai garo šauro e.</div><div class=\"kurss-example\">Piemēri: das Mädchen (mētchen), die Bänke (dī benke), der Vater (dēr fāter), die Väter (dī fēter).</div><div class=\"kurss-example\">Ü ir patskaņa u pārskanojums. To izrunājot, lūpas ļoti jāapaļo un jāmēģina ar apaļi veidotām lūpām izrunāt i.</div><div class=\"kurss-example\">Piemēri: fünf, der Schlüssel (šlūsel).</div><div class=\"kurss-example\">Ö izrunā ar apaļi veidotām lūpām, mēģinot izrunāt e: der Löffel.</div><div class=\"kurss-example\">Divkāršots patskanis apzīmē garu patskani: leer (lēr).</div><div class=\"kurss-example\">Divskani eu izrunā kā oi: neun (noin).</div></div></div>\n    </details>\n\n    <details class=\"lesson1-accordion\">\n      <summary><span class=\"lesson1-number lesson1-number-blue\">4.</span><span>Gramática</span><span class=\"lesson1-chevron\">⌄</span></summary>\n      <div class=\"lesson1-content lesson1-grammar-content\">\n        <section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\">Gramática y paskaidrojumi</h4><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Salikta darbības vārda uzsvērtais priedēklis tagadnē atdalās no darbības vārda un stāv teikuma beigās.</div><div class=\"kurss-example\">Piemēri: hinlegen — er legt hin • Aufmachen — er macht auf • Anspitzen — er spitzt an.</div><div class=\"kurss-example\">Skaitļa vārds viens ir visās trīs kārtās, ja to happy ar lietvārdu: vīriešu kārtā ein, sieviešu kārtā eine, vidējā kārtā ein.</div><div class=\"kurss-example\">Piemēri: ein Schüler — viens skolnieks • Eine Schülerin — viena skolniece • Ein Kind — viens bērns.</div><div class=\"kurss-example\">Skaitļi: eins, zwei, drei, vier (fīr), fünf, sechs (zeks), sieben (zīben), acht, neun (noin), zehn (cēn).</div><div class=\"kurss-example\">Saitaiņa vācu valodā ir vienskaitļa un daudzskaitļa forma: der Schüler ist klein • Die Schüler sind klein.</div><div class=\"kurss-example\">Norādāmais vietniekvārds tas latviešu valodā mainās skaitlī un kārtā, bet vācu valodā encantado de venir formu: das.</div><div class=\"kurss-example\">Piemēri: tas ir veseris — das ist ein Hammer • Tā ir adata — das ist eine Nadel • Tie ir veseri — das sind Hämmer • Tās ir adatas — das sind Nadeln.</div><div class=\"kurss-example\">Der Wagen — rati un der Schlitten — ragavas latviešu valodā ir daudzskaitlinieki, bet vācu valodā šos vārdus happy vienskaitlī a daudzskaitlī.</div><div class=\"kurss-example\">Vīriešu un vidējās kārtas lietvārdi ar galotni -er, -el, -en daudzskaitlī bieži nepieņem galotni.</div><div class=\"kurss-example\">Piemēri: der Hammer — die Hämmer • Der Garten — die Gärten • Das Fenster — die Fenster • Das Messer — die Messer.</div><div class=\"kurss-example\">Sieviešu kārtas lietvārdi ar galotni -el, -er daudzskaitlī pieņem -n.</div><div class=\"kurss-example\">Piemēri: die Nadel — die Nadeln • Die Feder — die Federn.</div><div class=\"kurss-example\">Izņēmumi: die Mutter (māte) — die Mütter (mātes) • Die Tochter (meita) — die Töchter (meitas).</div><div class=\"kurss-example\">Nenoteiktajam artikulam daudzskaitļa nav: das ist ein Wagen — das sind Wagen • Das ist eine Nadel — das sind Nadeln.</div><div class=\"kurss-example\">Stāstāmā teikumā izteicējs-darbības vārds stāv otrā vietā: er legt den Schlüssel hin • Dann legt er den Schlüssel hin.</div></div></section>\n      </div>\n    </details>\n\n    <details class=\"lesson1-accordion\">\n      <summary><span class=\"lesson1-number lesson1-number-orange\">5.</span><span>Partulko</span><span class=\"lesson1-chevron\">⌄</span></summary>\n      <div class=\"lesson1-content\"><div class=\"lesson1-training-wrap\"><button class=\"lesson1-training-flashcard\" type=\"button\" data-lesson6-training-card data-training-index=\"0\" data-showing-back=\"false\" aria-label=\"Lekcija 6 pārtulkošanas kartīte\"><span class=\"lesson1-training-progress\">Lekcija 6 · Partulko: 1 / 21</span><span class=\"lesson1-training-text\">Paul ņem zīmuli un zīmē.</span></button><p class=\"lesson1-training-hint\">Klikšķini uz kartītes, lai redzētu vācu tulkojumu. Pēc atbildes nākamais klikšķis rāda nākamo kartīti.</p></div></div>\n    </details>\n  ",
  "kurssLesson5": "\n    <h3>Lekcija 5</h3>\n    <p class=\"kurss-lesson-intro\">Wen?, accuseef, sitzen, fragen en -in einde.</p>\n\n    <details class=\"lesson1-accordion\" open>\n      <summary><span class=\"lesson1-number lesson1-number-red\">1.</span><span>Diálogos / teikumi</span><span class=\"lesson1-chevron\">⌄</span></summary>\n      <div class=\"lesson1-content\"><div class=\"lesson1-card-grid\">\n        <div class=\"kurss-example\">¿Estamos sentados y fragmentados? Der Lehrer sitzt und fragt.</div>\n        <div class=\"kurss-example\">¿Wer steht und antwortet? Der Schüler steht und antwortet.</div>\n        <div class=\"kurss-example\">¿Cómo respondió el estudiante? Der Schüler respondió gut.</div>\n        <div class=\"kurss-example\">¿Cómo lobt der Lehrer? Der Lehrer lobt den Schüler.</div>\n        <div class=\"kurss-example\">¿Wie ist der Schüler? Der Schüler es pequeño.</div>\n        <div class=\"kurss-example\">¿El Schüler es más pequeño o más grande? Er ist klein.</div>\n        <div class=\"kurss-example\">¿Wen fragt die Lehrerin? Die Lehrerin fragt die Schülerin.</div>\n        <div class=\"kurss-example\">¿Cómo respondió el Schülerin? Die Schülerin respondió schlecht.</div>\n        <div class=\"kurss-example\">¿Todo fue Lehrerin? Sie tadelt die Schülerin.</div>\n        <div class=\"kurss-example\">Die Schülerin no es pequeño, es grande.</div>\n        <div class=\"kurss-example\">Ein Kind dijo. Este tipo es artesanal.</div>\n        <div class=\"kurss-example\">Die Mutter liebt das Kind. Der Vater lanzó das Kind.</div>\n      </div></div>\n    </details>\n\n    <details class=\"lesson1-accordion\">\n      <summary><span class=\"lesson1-number lesson1-number-green\">2.</span><span>Vardi</span><span class=\"lesson1-chevron\">⌄</span></summary>\n      <div class=\"lesson1-content\"><div class=\"lesson1-card-grid\">\n        <div class=\"kurss-example\">Sitzen (zicen) - sēdēt</div>\n        <div class=\"kurss-example\">Fragen (frāgen) - jautāt</div>\n        <div class=\"kurss-example\">Der Lehrer (dēr lērer) - skolotājs</div>\n        <div class=\"kurss-example\">Tripa (gūt) - labi</div>\n        <div class=\"kurss-example\">Wen (ven) - ko</div>\n        <div class=\"kurss-example\">Loben — slavēt</div>\n        <div class=\"kurss-example\">Der Schüler (šūler) — skolnieks</div>\n        <div class=\"kurss-example\">Klein — mazs</div>\n        <div class=\"kurss-example\">Groß (grōs) - mentiras</div>\n        <div class=\"kurss-example\">Die Lehrerin — skolotāja</div>\n        <div class=\"kurss-example\">Die Schülerin — skolniece</div>\n        <div class=\"kurss-example\">Schlecht (šleht) — slikti</div>\n        <div class=\"kurss-example\">Tadeln — vacht</div>\n        <div class=\"kurss-example\">Oder (ōder) - ir</div>\n        <div class=\"kurss-example\">Das Kind (kint) - bērns</div>\n        <div class=\"kurss-example\">Artig (ārtich) - rātns</div>\n        <div class=\"kurss-example\">Die Mutter - māte</div>\n        <div class=\"kurss-example\">Lieben (līben) - mīlēt</div>\n        <div class=\"kurss-example\">Der Vater (fāter) — tēvs</div>\n      </div></div>\n    </details>\n\n        <details class=\"lesson1-accordion\">\n      <summary><span class=\"lesson1-number lesson1-number-purple\">3.</span><span>Izruná</span><span class=\"lesson1-chevron\">⌄</span></summary>\n      <div class=\"lesson1-content\"><div class=\"lesson1-card-grid\">\n        <div class=\"kurss-example\">Tz ir dubultots z skanis un izrunājams kā z: sitzen (zicen).</div>\n        <div class=\"kurss-example\">V vācu vārdos izrunā kā f: der Vater (fāter).</div>\n        <div class=\"kurss-example\">SS sauc par escet un izrunā kā latviešu s: grande (grōs), weiß (veis).</div>\n      </div></div>\n    </details>\n\n<details class=\"lesson1-accordion\">\n      <summary><span class=\"lesson1-number lesson1-number-blue\">4.</span><span>Gramática</span><span class=\"lesson1-chevron\">⌄</span></summary>\n      <div class=\"lesson1-content lesson1-grammar-content\">\n        <section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\">Nominativs un akuzatīvs</h4><div class=\"lesson1-grammar-note\">Latviešu valodā nominatīvs atbild uz jautājumu kas?, bet akuzatīvs uz jautājumu ko?.</div><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Vācu valodā nominatīvā jautājums ir wer? personam a era? priekšmetiem.</div><div class=\"kurss-example\">¿Akuzatīvā jautājums ir wen? personam a era? priekšmetiem.</div></div></section>\n        <section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\">Artikulu maiņa akuzatīvā</h4><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Nombre: der Vater, die Mutter, das Kind.</div><div class=\"kurss-example\">Akkusativ: den Vater, die Mutter, das Kind.</div><div class=\"kurss-example\">Nombre: der Federhalter, die Feder, das Messer.</div><div class=\"kurss-example\">Akkusativ: den Federhalter, die Feder, das Messer.</div></div></section>\n        <section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\">Sentarse</h4><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Estoy sentado</div><div class=\"kurss-example\">Du sitzt</div><div class=\"kurss-example\">Er/sie/es sitzt</div><div class=\"kurss-example\">Estamos sentados</div><div class=\"kurss-example\">Estoy sentado</div><div class=\"kurss-example\">Sentarse</div></div></section>\n        <section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\">Fragen + akuzatīvs</h4><div class=\"lesson1-grammar-note\">Darbības vārds fragen vācu valodā prasa akuzatīvu.</div><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">¿Wen fragt der Lehrer?</div><div class=\"kurss-example\">Le professeur demande à l'élève.</div></div></section>\n        <section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\">-en galotón</h4><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Daudz sieviešu kārtas vārdu atvasina ar galotni -in.</div><div class=\"kurss-example\">Die Lehrerin</div><div class=\"kurss-example\">Sternen Schülerin</div></div></section>\n        <section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\">Darbības vārda prohíbe</h4><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Stāstāmā teikumā darbības vārds stāv otrā vietā.</div><div class=\"kurss-example\">Damn geht das Mädchen hinaus und arbeitet.</div><div class=\"kurss-example\">Das Mädchen geht dann hinaus und arbeitet.</div></div></section>\n      </div>\n    </details>\n\n    <details class=\"lesson1-accordion\">\n      <summary><span class=\"lesson1-number lesson1-number-orange\">5.</span><span>Partulko</span><span class=\"lesson1-chevron\">⌄</span></summary>\n      <div class=\"lesson1-content\"><div class=\"lesson1-training-wrap\"><button class=\"lesson1-training-flashcard\" type=\"button\" data-lesson5-training-card data-training-index=\"0\" data-showing-back=\"false\" aria-label=\"Lekcija 5 pārtulkošanas kartīte\"><span class=\"lesson1-training-progress\">Lekcija 5 · Partulko: 1 / 16</span><span class=\"lesson1-training-text\">Ko mīl tēvs?</span></button><p class=\"lesson1-training-hint\">Klikšķini uz kartītes, lai redzētu vācu tulkojumu. Pēc atbildes nākamais klikšķis rāda nākamo kartīti.</p></div></div>\n    </details>\n  ",
  "kurssLesson4": "            <h3>Lekcija 4</h3>\n            <p class=\"kurss-lesson-intro\">Akuzatīvs, nehmen, hinlegen, hinausgehen un īpašības vārdi.</p>\n            <details class=\"lesson1-accordion\" open>\n              <summary><span class=\"lesson1-number lesson1-number-red\">1.</span><span>Diálogos / teikumi</span><span class=\"lesson1-chevron\">⌃</span></summary>\n              <div class=\"lesson1-content\"><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Paul kommt und nimmt einen Federhalter.</div><div class=\"kurss-example\">Er zeigt den Federhalter.</div><div class=\"kurss-example\">Er fragt: \"¿Wie ist der Federhalter?\"</div><div class=\"kurss-example\">Olga respondió: \"Der Federhalter es negro.\"</div><div class=\"kurss-example\">¿El Federhalter es blanco? Tampoco, el Federhalter no es blanco, es negro.</div><div class=\"kurss-example\">María kommt und nimmt eine Feder.</div><div class=\"kurss-example\">Sie fragt: \"¿Wie ist die Feder?\"</div><div class=\"kurss-example\">Olga respondió: \"Die Feder ist spitz.\"</div><div class=\"kurss-example\">¿Feder es tonto? Tampoco, el Feder no es un muñón, es un perro de Pomerania.</div><div class=\"kurss-example\">¿Se leyó el Mädchen? Es legt die Feder hin.</div><div class=\"kurss-example\">¿Fue nimmst du? No soy un messer.</div><div class=\"kurss-example\">¿Wie ist das Messer? El Messer es scharf.</div><div class=\"kurss-example\">¿Es este Messer Stumpf? Nein, es ist nicht stumpf, es ist scharf.</div><div class=\"kurss-example\">¿Era Legt du Hin? Leí el Messer, el Feder y el Federhalter hin.</div><div class=\"kurss-example\">Maldito gehe ich hinaus und arbeite.</div></div></div>\n            </details>\n            <details class=\"lesson1-accordion\"><summary><span class=\"lesson1-number lesson1-number-green\">2.</span><span>Vardi</span><span class=\"lesson1-chevron\">⌄</span></summary><div class=\"lesson1-content\"><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Nehmen (nēmen) — ņemt</div><div class=\"kurss-example\">Er nimmt (nimt) — viņš ņem</div><div class=\"kurss-example\">Der Federhalter (dēr fēderhalter) - spalvaskāts</div><div class=\"kurss-example\">Einen Federhalter — spalvaskātu</div><div class=\"kurss-example\">Zeigen - rādīt</div><div class=\"kurss-example\">Negro (schwarz) - negro</div><div class=\"kurss-example\">Weiß (veis) - balts</div><div class=\"kurss-example\">Die Feder (dī fēder) - difundir</div><div class=\"kurss-example\">Eine Feder — spalvu</div><div class=\"kurss-example\">Spitz (špic) — smails</div><div class=\"kurss-example\">Hinlegen — nolikt</div><div class=\"kurss-example\">Legt hin — noliek</div><div class=\"kurss-example\">Das Mädchen (mētchen) — meitene</div><div class=\"kurss-example\">Das Messer - nazis</div><div class=\"kurss-example\">Ein Messer - Nazi</div><div class=\"kurss-example\">Scharf - culo</div><div class=\"kurss-example\">Stumpf (štumpf) - neass, truls</div><div class=\"kurss-example\">Dann - un poco</div><div class=\"kurss-example\">Hinaus—ārā</div><div class=\"kurss-example\">Hinausgehen—iziet, iet ārā</div></div></div></details>\n                        <details class=\"lesson1-accordion\"><summary><span class=\"lesson1-number lesson1-number-purple\">3.</span><span>Izruná</span><span class=\"lesson1-chevron\">⌄</span></summary><div class=\"lesson1-content\"><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Galotnes -en, -er, -el ir neuzsvērtas, tāpēc e šajās galotnēs ir vāji sadzirdams: kommen, nehmen, der Federhalter.</div><div class=\"kurss-example\">H vācu valodā var būt gan skaņa, gan garumzīme iepriekšējam patskanim.</div><div class=\"kurss-example\">Als h lang is, wordt deze niet als klank uitgesproken: nehmen (nēmen).</div><div class=\"kurss-example\">Ja patskanim seko tikai viens līdzskanis, patskani izrunā gari: die (dī) Feder (fēder), den (dēn).</div></div></div></details>\n<details class=\"lesson1-accordion\"><summary><span class=\"lesson1-number lesson1-number-blue\">4.</span><span>Gramática</span><span class=\"lesson1-chevron\">⌄</span></summary><div class=\"lesson1-content lesson1-grammar-content\"><section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>1</span>Akuzativs</h4><div class=\"lesson1-grammar-note\">Sieviešu un vidējā kārtā akuzatīvs ir vienāds ar nominatīvu. Mainās tikai vīriešu kārta.</div><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Nombre: der Federhalter, die Feder, das Messer.</div><div class=\"kurss-example\">Akkusativ: den Federhalter, die Feder, das Messer.</div><div class=\"kurss-example\">Nombre: un Federhalter, un Feder, un Messer.</div><div class=\"kurss-example\">Akkusativ: einen Federhalter, eine Feder, ein Messer.</div></div></section><section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>2</span>Nehmen</h4><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Yo soy nehme</div><div class=\"kurss-example\">Du nimmst</div><div class=\"kurss-example\">Er/sie nimmt</div><div class=\"kurss-example\">Nous prenons</div><div class=\"kurss-example\">Mi nehmt</div><div class=\"kurss-example\">Sie nehmen</div></div></section><section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>3</span>Vietniekvardi</h4><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Er—vīriešu kārta</div><div class=\"kurss-example\">Sie — sieviešu kārta</div><div class=\"kurss-example\">Ej: vidējā kārta</div><div class=\"kurss-example\">Daudzskaitlī — sie</div></div></section><section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>4</span>Atdalāmie darbības vārdi</h4><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Hinlegen → ich lege das Messer hin</div><div class=\"kurss-example\">Hinausgehen → María geht hinaus</div></div></section><section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>5</span>Īpašības vārdi</h4><div class=\"lesson1-grammar-note\">Ja īpašības vārds teikumā ir izteicējs, tas nemainās ne kārtā, ne skaitlī.</div><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Der Federhalter es pequeño</div><div class=\"kurss-example\">La Feder es pequeña</div><div class=\"kurss-example\">Das Messer es pequeño</div><div class=\"kurss-example\">El messer es pequeño</div></div></section><section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>6</span>Ontkenning se reunió con la noche</h4><div class=\"lesson1-grammar-note\">Ja nicht noliedz īpašības vārdu, tas stāv noliedzamā vārda priekšā.</div><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">El Federhalter no es blanco</div><div class=\"kurss-example\">El Messer no es scharf</div></div></section><section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>7</span>-chen / -lein</h4><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Lietvārdi ar galotni -chen un -lein ir vidējā kārtā: das Mädchen.</div></div></section></div></details>\n            <details class=\"lesson1-accordion\"><summary><span class=\"lesson1-number lesson1-number-orange\">5.</span><span>Partulko</span><span class=\"lesson1-chevron\">⌄</span></summary><div class=\"lesson1-content\"><div class=\"lesson1-training-wrap\"><button class=\"lesson1-training-flashcard\" type=\"button\" data-lesson4-training-card data-training-index=\"0\" data-showing-back=\"false\" aria-label=\"Lekcija 4 pārtulkošanas kartīte\"><span class=\"lesson1-training-progress\">Lekcija 4 · Partulko: 1 / 16</span><span class=\"lesson1-training-text\">Meitene ņem spalvas kātu.</span></button><p class=\"lesson1-training-hint\">Klikšķini uz kartītes, lai redzētu vācu tulkojumu. Pēc atbildes nākamais klikšķis rāda nākamo kartīti.</p></div></div></details>",
  "kurssLesson3": "            <h3>Lekcija 3</h3>\n            <p class=\"kurss-lesson-intro\">Tresā lekcija: dialogi, vārdi, izruna, gramatika un pārtulkošana.</p>\n            <details class=\"lesson1-accordion\" open>\n              <summary><span class=\"lesson1-number lesson1-number-red\">1.</span><span>Diálogos / teikumi</span><span class=\"lesson1-chevron\">⌃</span></summary>\n              <div class=\"lesson1-content\"><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Wer rechnet und zeichnet?<br>Wir rechnen und zeichnen.</div><div class=\"kurss-example\">¿Estamos kommt?<br>Pablo y Ana también.</div><div class=\"kurss-example\">¿Estaba aquí?<br>Hier steht ein Tisch.</div><div class=\"kurss-example\">¿Había vuelto?<br>Dort steht un banco.</div><div class=\"kurss-example\">¿Estaba contento aquí?<br>Aquí lee un libro.</div><div class=\"kurss-example\">¿Estaba liegt dort?<br>Dort liegt ein Heft.</div><div class=\"kurss-example\">¿Estaba colgado allí?<br>Aquí cuelga una imagen.</div><div class=\"kurss-example\">¿Estaba aguantando?<br>Dort hangt aine Tafel.</div><div class=\"kurss-example\">Wie ist das Buch?<br>Das Buch es un imbécil.</div><div class=\"kurss-example\">¿Wie ist das Heft?<br>Das Heft ist dünn.</div><div class=\"kurss-example\">¿Cómo es el Banco?<br>El banco es niedrig.</div><div class=\"kurss-example\">Wie ist der Tisch?<br>Der Tisch es alto.</div></div></div>\n            </details>\n            <details class=\"lesson1-accordion\"><summary><span class=\"lesson1-number lesson1-number-green\">2.</span><span>Vardi</span><span class=\"lesson1-chevron\">⌄</span></summary><div class=\"lesson1-content\"><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Wer-kas</div><div class=\"kurss-example\">Era - kas</div><div class=\"kurss-example\">Aquí — šeit</div><div class=\"kurss-example\">Dort — recorrido</div><div class=\"kurss-example\">Der Tisch - galdos</div><div class=\"kurss-example\">Ein Tisch - galdos</div><div class=\"kurss-example\">Banco de troqueles — sol</div><div class=\"kurss-example\">Eine Bank - un banco</div><div class=\"kurss-example\">Liegen — atrasties guļus</div><div class=\"kurss-example\">¿Lees un libro? — vai šeit ir / atrodas grāmata?</div><div class=\"kurss-example\">Das Buch — grāmata</div><div class=\"kurss-example\">Ein Buch - grāmata</div><div class=\"kurss-example\">Hängen — karāties</div><div class=\"kurss-example\">Das Bild — imagen</div><div class=\"kurss-example\">Ein Bild — imagen</div><div class=\"kurss-example\">Die Tafel — tāfele</div><div class=\"kurss-example\">Eine Tafel — tāfele</div><div class=\"kurss-example\">Wie — kāds, kāda</div><div class=\"kurss-example\">Ist—ir</div><div class=\"kurss-example\">Dick — biezs, resns</div><div class=\"kurss-example\">Das Heft — burtnīca</div><div class=\"kurss-example\">Ein Heft - burtnīca</div><div class=\"kurss-example\">Dünn — plans, tievs</div><div class=\"kurss-example\">Niedrig - zems</div><div class=\"kurss-example\">Hoch - agosto</div></div></div></details>\n                        <details class=\"lesson1-accordion\"><summary><span class=\"lesson1-number lesson1-number-purple\">3.</span><span>Izruná</span><span class=\"lesson1-chevron\">⌄</span></summary><div class=\"lesson1-content\"><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Garo ī skaņu vācu valodā apzīmē ar es decir: liegen (līgen), hier (hīr), wie (vī).</div><div class=\"kurss-example\">Ck ir divkāršs k: dick (dikk).</div><div class=\"kurss-example\">Īpašības un apstākļu vārdos galotne -ig izskan kā viegls -ich: niedrig (nīdrich).</div><div class=\"kurss-example\">Ja galotne -ig beidzas are e: -ige, tad g izrunā kā noteiktu g skaņu: niedrige (nīdrige) Bänke.</div></div></div></details>\n<details class=\"lesson1-accordion\"><summary><span class=\"lesson1-number lesson1-number-blue\">4.</span><span>Gramática</span><span class=\"lesson1-chevron\">⌄</span></summary><div class=\"lesson1-content lesson1-grammar-content\"><section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>1</span>Teikuma priekšmets</h4><div class=\"lesson1-grammar-note\">Het onderwerp van een zin in het Duits beantwoordt de vraag waar? / ¿Qué? en staat in de nominaef.</div><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">¿Ar wer? jautā pēc personām.</div><div class=\"kurss-example\">¿Ar fue? jautā pēc priekšmetiem.</div><div class=\"kurss-example\">Aquí canta? —Elle cante.</div><div class=\"kurss-example\">¿Estaba contento aquí? — Hier liegt ein Buch.</div></div></section><section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>2</span>Artículos</h4><div class=\"lesson1-grammar-note\">Vācu valodā lietas vārdam ir 3 kārtas: vīriešu, sieviešu un vidējā. Lietu vārdu priekšā parasti stāv vārdiņš, ko sauc par artikulu. Šo vārdiņu netulko.</div><h5 class=\"lesson2-subtitle\">Artículos notados</h5><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Vīriešu kārta — der</div><div class=\"kurss-example\">Sieviešu kārta—morir</div><div class=\"kurss-example\">Vidējā kārta—das</div><div class=\"kurss-example\">Daudzskaitlī noteiktais artikuls visām trim kārtām ir die.</div><div class=\"kurss-example\">Der Tisch — die Tische</div><div class=\"kurss-example\">El banco — el banco</div><div class=\"kurss-example\">Das Heft — die Hefte</div></div><h5 class=\"lesson2-subtitle\">Artículos nenoteiktais</h5><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Vīriešu kārta—ein</div><div class=\"kurss-example\">Vrouwenbeurt - uno</div><div class=\"kurss-example\">Vidējā kārta—ein</div><div class=\"kurss-example\">Nenoteiktajam artikulam daudzskaitļa nav.</div><div class=\"kurss-example\">Ein Tisch — Tisch</div><div class=\"kurss-example\">Ein Heft — Hefte</div></div></section><section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>3</span>Īpašvārdi</h4><div class=\"lesson1-grammar-note\">Īpašvārdu priekšā artikulu nelieto.</div><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Hans spielt, aber María singt.</div></div></section><section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>4</span>Darbības vārda prohíbe</h4><div class=\"lesson1-grammar-note\">Stāstāmā teikumā darbības vārds stāv otrā vietā.</div><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Aquí cuelga una tarjeta.</div></div></section><section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>5</span>Stehen / liegen / hängen</h4><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Mira por primera vez, siempre y cuando tengas razón, ya sabes, la primera vez:<br>El estilo de Tisch<br>El banco se encuentra</div><div class=\"kurss-example\">Par priekšmetiem, kas atrodas horizontaltālā stāvoklī, saka, ka tie guļ:<br>Das Buch liegt<br>Das Heft liegt</div><div class=\"kurss-example\">Priekšmeti var arī karāties:<br>La tarjeta cuelga<br>Die Tafel colgado</div></div></section></div></details>\n            <details class=\"lesson1-accordion\"><summary><span class=\"lesson1-number lesson1-number-orange\">5.</span><span>Partulko</span><span class=\"lesson1-chevron\">⌄</span></summary><div class=\"lesson1-content\"><div class=\"lesson1-training-wrap\"><button class=\"lesson1-training-flashcard\" type=\"button\" data-lesson3-training-card data-training-index=\"0\" data-showing-back=\"false\" aria-label=\"Lekcija 3 pārtulkošanas kartīte\"><span class=\"lesson1-training-progress\">Lekcija 3 · Partulko: 1 / 22</span><span class=\"lesson1-training-text\">¿Vas a rēķini?</span></button><p class=\"lesson1-training-hint\">Klikšķini uz kartītes, lai redzētu vācu tulkojumu. Pēc atbildes nākamais klikšķis rāda nākamo kartīti.</p></div></div></details>",
  "kurssLesson7": "            <h3>Lekcija 7</h3>\n            <p class=\"kurss-lesson-intro\">Septītā lekcija: pavēles izteiksme, uzrunas forma un daudzskaitlis.</p>\n            <details class=\"lesson1-accordion\" open>\n              <summary><span class=\"lesson1-number lesson1-number-red\">1.</span><span>Diálogos / teikumi</span><span class=\"lesson1-chevron\">⌃</span></summary>\n              <div class=\"lesson1-content\"><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">¡Hans, canta una canción! ¿Eras tú? Canto una canción.</div><div class=\"kurss-example\">¡Hans y Olga, canten una canción! ¿Todo fue ayer? Cantemos una canción.</div><div class=\"kurss-example\">¡Fräulein Müller, singen Sie, bitte, ein Lied! ¿Era tun Sie? Canto una canción.</div><div class=\"kurss-example\">¡Hans, ve al Cajero! ¿Fue todo Hans? Er zählt die Teller.</div><div class=\"kurss-example\">¡Hans y Olga, vean al Cajero! ¿Fueron Hans y Olga? Sie zählen die Teller.</div><div class=\"kurss-example\">¡Fräulein Müller, zählen Sie, bitte, die Teller!</div><div class=\"kurss-example\">¡Hans, fuera del Fenster! ¿Fue todo Hans? Er öffnet das Fenster.</div><div class=\"kurss-example\">¡Hans y Olga, salid de la ventana! ¿Fueron Hans y Olga? Sie öffnen die Fenster.</div><div class=\"kurss-example\">Fräulein Müller, öffnen Sie, bitte, all Fenster!</div><div class=\"kurss-example\">Fräulein Müller öffnet alle Fenster.</div><div class=\"kurss-example\">C'est le miroir. Hay milagros.</div><div class=\"kurss-example\">Este es el Lappen. Este es el Lappen.</div><div class=\"kurss-example\">Este es el Spaten. Este es el Spaten.</div><div class=\"kurss-example\">Éste es el Besen. Éste es el Besen.</div><div class=\"kurss-example\">Éste es el Schaufel. Éste es el Schaufeln.</div><div class=\"kurss-example\">Éste es el Schuessel. Este es el Schüsseln.</div><div class=\"kurss-example\">Éste es el Zimmer. Éste es el Zimmer.</div><div class=\"kurss-example\">Este es el Ufer. Este es el Ufer.</div></div></div>\n            </details>\n            <details class=\"lesson1-accordion\"><summary><span class=\"lesson1-number lesson1-number-green\">2.</span><span>Vardi</span><span class=\"lesson1-chevron\">⌄</span></summary><div class=\"lesson1-content\"><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Singen — dziedāt</div><div class=\"kurss-example\">Singe — dziedi</div><div class=\"kurss-example\">Singt — dieta dziet</div><div class=\"kurss-example\">Singen Sie — dziediet</div><div class=\"kurss-example\">Das Lied (das līt) - dziesma</div><div class=\"kurss-example\">Sie — Jūs</div><div class=\"kurss-example\">Zählen — skaitīt</div><div class=\"kurss-example\">Das Fräulein (froilein) - jaunkundze</div><div class=\"kurss-example\">Der Müller — dzirnavnieks</div><div class=\"kurss-example\">Öffnen — atvērt</div><div class=\"kurss-example\">Das Fenster (fenster) - troncos</div><div class=\"kurss-example\">En - caras</div><div class=\"kurss-example\">Der Spiegel (špīgel) - spogulis</div><div class=\"kurss-example\">Der Lappen — lupata, slaukis</div><div class=\"kurss-example\">Der Spaten — lāpsta</div><div class=\"kurss-example\">Der Besen — slota</div><div class=\"kurss-example\">Die Schaufel — lāpstiņa</div><div class=\"kurss-example\">Die Schüssel — bļoda</div><div class=\"kurss-example\">Das Zimmer — istaba</div><div class=\"kurss-example\">Das Ufer (ūfer) - krasts</div></div></div></details>\n            <details class=\"lesson1-accordion\"><summary><span class=\"lesson1-number lesson1-number-purple\">3.</span><span>Izruná</span><span class=\"lesson1-chevron\">⌄</span></summary><div class=\"lesson1-content\"><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Sp vārda vai zilbes sākumā izrunā kā šp: der Spiegel (dēr špīgel).</div><div class=\"kurss-example\">Sch izrunā kā latviešu š: die Schaufel (dī šaufel), die Schüssel (dī šūsel).</div><div class=\"kurss-example\">Divskani äu izrunā kā latviešu oi: das Fräulein (das froilein).</div></div></div></details>\n            <details class=\"lesson1-accordion\"><summary><span class=\"lesson1-number lesson1-number-blue\">4.</span><span>Gramática</span><span class=\"lesson1-chevron\">⌄</span></summary><div class=\"lesson1-content lesson1-grammar-content\"><section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>1</span>Comando-expreso</h4><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Pavēles izteiksme vienskaitļa 2. personā atbilst darbības vārda 2. personai vienskaitlī bez personu galotnes -st, pieliekot galotni -e.</div><div class=\"kurss-example\">Piemēri: antworte!, arbeite!, öffne!, zeichne!</div><div class=\"kurss-example\">Ļoti bieži galotne -e netiek alegrea, ja pavēles forma ar to kļūst vienzilbīga: ¡geh!, steh!, komm!, tu!, ¡sing!, frag!</div></div></section><section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>2</span>Daudzskaitļa pavēle</h4><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Pavēles forma 2. personā daudzskaitlī līdzinās tagadnes daudzskaitļa 2. personai, bet tiek alegrea bez vietniekvārda.</div><div class=\"kurss-example\">Piemēri: antwortet!, arbeitet!, öffnet!, zeichnet!, geht!, steht!, tut!</div></div></section><section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>3</span>Uzrunas forma ar Sie</h4><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Uzrunas forma ar “Jūs” līdzinās daudzskaitļa 3. personai. Vietniekvārds Sie rakstāms ar lielo burtu un stāv pēc darbības vārda.</div><div class=\"kurss-example\">Piemēri: antworten Sie!, arbeiten Sie!, öffnen Sie!, zeichnen Sie!, gehen Sie!, stehen Sie!, tun Sie!</div></div></section><section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>4</span>Öffnen</h4><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Darbības vārdam öffnen vieglākas izrunas dēļ 2. un 3. personā vienskaitlī un 2. personā daudzskaitlī starp celmu un galotni iesprauž e: du öffnest, er öffnet, ihr öffnet.</div></div></section></div></details>\n            <details class=\"lesson1-accordion\"><summary><span class=\"lesson1-number lesson1-number-orange\">5.</span><span>Übung / Vingrinājums</span><span class=\"lesson1-chevron\">⌄</span></summary><div class=\"lesson1-content\"><div class=\"lesson1-training-wrap\"><button class=\"lesson1-training-flashcard\" type=\"button\" data-lesson7-exercise-card data-training-index=\"0\" data-showing-back=\"false\" aria-label=\"Lekcija 7 vingrinājuma kartīte\"><span class=\"lesson1-training-progress\">Lekcija 7 · Revisión: 1 / 16</span><span class=\"lesson1-training-text\">Fragen — jautāt</span></button><p class=\"lesson1-training-hint\">Pieskaries kartītei, lai redzētu pavēles formas.</p></div></div></details>",
  "kurssLesson1": "            <h3>Lekcija 1</h3>\n            <p class=\"kurss-lesson-intro\">Pirmā lekcija: darbības vārdi tagadnē, vārdiņi, izruna, gramatika un pārtulko.</p>\n            <details class=\"lesson1-accordion\" open>\n              <summary><span class=\"lesson1-number lesson1-number-red\">1.</span><span>Darbības vārdi tagadnē</span><span class=\"lesson1-chevron\">⌃</span></summary>\n              <div class=\"lesson1-content\">\n                <div class=\"lesson1-info\">Darbības vārdi un to locījumi tagadnē.</div>\n                <div class=\"lesson1-verb-cards\">\n                  <article class=\"lesson1-verb-card\">\n                    <h4><span class=\"lesson1-verb-icon\">♟</span>Kommen — nākt</h4>\n                    <div class=\"lesson1-conjugation\"><span>Yo</span><strong>Komme</strong><span>Es nāku</span><span>du</span><strong>Komst</strong><span>Tu nāc</span><span>Er/si</span><strong>Venir</strong><span>Viņš / viņa nāk</span><span>Wir</span><strong>Kommen</strong><span>Mēs nākam</span><span>Aquí</span><strong>Venir</strong><span>Jūs nākat</span><span>Sie / Sie</span><strong>Kommen</strong><span>Viņi / Jūs nāk</span></div>\n                  </article>\n                  <article class=\"lesson1-verb-card\">\n                    <h4><span class=\"lesson1-verb-icon\">♟</span>Gehen - es decir</h4>\n                    <div class=\"lesson1-conjugation\"><span>Yo</span><strong>Gehe</strong><span>Es eju</span><span>du</span><strong>Gehst</strong><span>Tu ej</span><span>Er/si</span><strong>Geht</strong><span>Viņš / viņa iet</span><span>Wir</span><strong>Gehen</strong><span>Más ejam</span><span>Aquí</span><strong>Geht</strong><span>Jūs ejat</span><span>Sie / Sie</span><strong>Gehen</strong><span>Viņi / Jūs iet</span></div>\n                  </article>\n                  <article class=\"lesson1-verb-card\">\n                    <h4><span class=\"lesson1-verb-icon\">♟</span>Stehen — stāvēt</h4>\n                    <div class=\"lesson1-conjugation\"><span>Yo</span><strong>Estehe</strong><span>Es stavu</span><span>du</span><strong>Stehst</strong><span>Jij estado</span><span>Er/si</span><strong>Steht</strong><span>Viņš / viņa stāv</span><span>Wir</span><strong>Esteban</strong><span>Mēs stāvam</span><span>Aquí</span><strong>Steht</strong><span>Jūs stāvat</span><span>Sie / Sie</span><strong>Esteban</strong><span>Viņi / Jūs stāv</span></div>\n                  </article>\n                  <article class=\"lesson1-verb-card\">\n                    <h4><span class=\"lesson1-verb-icon\">♟</span>Singen — dziedāt</h4>\n                    <div class=\"lesson1-conjugation\"><span>Yo</span><strong>Chamuscar</strong><span>Es dziedu</span><span>du</span><strong>Cantar</strong><span>Tu preguntas</span><span>Er/si</span><strong>Cantar</strong><span>Viņš / viņa dzied</span><span>Wir</span><strong>Cantar</strong><span>Más dziedam</span><span>Aquí</span><strong>Cantar</strong><span>Jūs dziedat</span><span>Sie / Sie</span><strong>Cantar</strong><span>Zij/jij zingt</span></div>\n                  </article>\n                </div>\n                <section class=\"lesson1-block\">\n                  <h4>Pieméri</h4>\n                  <div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Stehst du?<br>Ja, ich stehe.</div><div class=\"kurss-example\">¿Estet Albert?<br>Sí, sí.</div><div class=\"kurss-example\">¿Steht Marta?<br>Sí, sí.</div><div class=\"kurss-example\">Wer kommt und singt?<br>Albert y Marta se juntan y cantan.</div><div class=\"kurss-example\">¿Geht ihr?<br>Sí, lo haremos.</div><div class=\"kurss-example\">Wer steht en singt?<br>Albert y Marta stehen und singen.</div></div>\n                </section>\n              </div>\n            </details>\n            <details class=\"lesson1-accordion\">\n              <summary><span class=\"lesson1-number lesson1-number-green\">2.</span><span>Vardiņi</span><span class=\"lesson1-chevron\">⌄</span></summary>\n              <div class=\"lesson1-content\">\n                <div class=\"lesson1-info lesson1-vardini-info\"><span class=\"lesson1-info-icon\" aria-hidden=\"true\">i</span><span>Vārdu aptuvenā izruna ir dota iekavās ar latviešu burtiem.<br>To jāievēro arī turpmākajās lekcijās.</span></div>\n                <div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Wir (vīr) — mēs</div><div class=\"kurss-example\">Vārdā “wir” burts i tiek izrunāts gari.</div><div class=\"kurss-example\">Kommen (komen) - nākt</div><div class=\"kurss-example\">Gehen (gē-en) — es decir</div><div class=\"kurss-example\">Stehen (štē-en) — stāvēt</div><div class=\"kurss-example\">Singen (zingen) - dziedāt</div><div class=\"kurss-example\">Du (dū) kommst — tu nāc</div><div class=\"kurss-example\">Er (ēr) kommt — viņš nāk</div><div class=\"kurss-example\">Sie (zī) kommt — viņa nāk</div><div class=\"kurss-example\">Wer (vēr) — kas?</div><div class=\"kurss-example\">Ja (jā) — jā</div></div>\n              </div>\n            </details>\n                        <details class=\"lesson1-accordion\">\n              <summary><span class=\"lesson1-number lesson1-number-purple\">3.</span><span>Izruná</span><span class=\"lesson1-chevron\">⌄</span></summary>\n              <div class=\"lesson1-content\">\n                <div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Vārdu pareiza izruna, apzīmēta latviešu burtiem, ir dota lekcijās.</div><div class=\"kurss-example\">Wir (vīr)—mēs. Vārdā wir ī izrunājams vienmēr gari.</div></div>\n              </div>\n            </details>\n<details class=\"lesson1-accordion\">\n              <summary><span class=\"lesson1-number lesson1-number-blue\">4.</span><span>Gramática</span><span class=\"lesson1-chevron\">⌄</span></summary>\n              <div class=\"lesson1-content lesson1-grammar-content\">\n                <section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>∞</span>Infinitīvs</h4><div class=\"lesson1-grammar-note\">Darbības vārda pamatforma. Parasti infinitīvs beidzas ar -en.</div><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Kommen</div><div class=\"kurss-example\">Gehen</div><div class=\"kurss-example\">Esteban</div><div class=\"kurss-example\">Cantar</div></div></section>\n                <section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>♟</span>Tagadnes galotnes</h4><div class=\"lesson1-ending-info\"><span class=\"lesson1-info-icon\" aria-hidden=\"true\">i</span><div class=\"lesson1-ending-info-body\"><p><strong>Noņem <span class=\"lesson1-ending-accent\">-es</span> no darbības vārda pamatformas un pieliec galotni.</strong></p><p>Piemērs: kommen → komm + galotne</p><div class=\"lesson1-ending-process\" aria-label=\"Tagadnes galotnes veidošanas process\"><div class=\"lesson1-ending-step\"><strong>Kommen</strong><span>Pamatforma</span></div><span class=\"lesson1-ending-arrow\">→</span><div class=\"lesson1-ending-step\"><strong>noņem <span class=\"lesson1-ending-accent\">-es</span></strong><span>Paliek sakne</span></div><span class=\"lesson1-ending-arrow\">→</span><div class=\"lesson1-ending-step\"><strong>Komm</strong><span>Sakne</span></div><span class=\"lesson1-ending-arrow\">→</span><div class=\"lesson1-ending-step\"><strong>Pieliec galotni</strong><span>E/st/t</span></div><span class=\"lesson1-ending-arrow\">→</span><div class=\"lesson1-ending-results\"><div>komm + <span class=\"lesson1-ending-accent\">e</span> = <strong>Komme</strong></div><div>komm + <span class=\"lesson1-ending-accent\">st</span> = <strong>Komst</strong></div><div>komm + <span class=\"lesson1-ending-accent\">t</span> = <strong>Venir</strong></div></div></div></div></div><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Ich → -e</div><div class=\"kurss-example\">Du → -st</div><div class=\"kurss-example\">Er/sie → -t</div><div class=\"kurss-example\">Wir → -es</div><div class=\"kurss-example\">Ihr → -t</div><div class=\"kurss-example\">Sie → -en</div></div></section>\n                <section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>●</span>Pieméri</h4><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Ich komme</div><div class=\"kurss-example\">Du kommst</div><div class=\"kurss-example\">Er kommt</div><div class=\"kurss-example\">Nosotros vamos</div></div></section>\n                <section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>?</span>Jautājuma teikumi</h4><div class=\"lesson1-grammar-info\"><span class=\"lesson1-info-icon\" aria-hidden=\"true\">i</span><span>Vācu jautājuma teikumā darbības vārds parasti pārvietojas uz pirmo vietu.</span></div><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Latviešu valoda:<br>Tú no.<br>¿Vas a ir a Nac?</div><div class=\"kurss-example\">Vācu valodā:<br>Du kommst.<br>Kommst du?</div><div class=\"kurss-example\">Du kommst — tu nāc<br>Kommst du? - ¿Vas a nāc?</div><div class=\"kurss-example\">Er singt — viņš dzied<br>¿Cantar? — ir viņš dzied?</div></div></section>\n                <section class=\"lesson1-block\"><h4 class=\"lesson1-grammar-header\"><span>♣</span>Personas atšķirība</h4><div class=\"lesson1-card-grid\"><div class=\"kurss-example\">Er kommt — viņš nāk</div><div class=\"kurss-example\">Sie kommt — viņa nāk</div><div class=\"kurss-example\">Sie kommen — viņi / viņas nāk</div></div></section>\n              </div>\n            </details>\n                        <details class=\"lesson1-accordion\">\n              <summary><span class=\"lesson1-number lesson1-number-orange\">5.</span><span>Partulko</span><span class=\"lesson1-chevron\">⌄</span></summary>\n              <div class=\"lesson1-content\">\n                <div class=\"lesson1-training-wrap\">\n                  <button class=\"lesson1-training-flashcard\" type=\"button\" data-lesson1-training-card data-training-index=\"0\" data-showing-back=\"false\" aria-label=\"Lekcija 1 treniņa kartīte\">\n                    <span class=\"lesson1-training-progress\">Lekcija 1 · Partulko: 1 / 11</span>\n                    <span class=\"lesson1-training-text\">¿Vas a ir a Nac?</span>\n                  </button>\n                  <p class=\"lesson1-training-hint\">Klikšķini uz kartītes, lai redzētu vācu tulkojumu. Pēc atbildes nākamais klikšķis rāda nākamo kartīti.</p>\n                </div>\n              </div>\n            </details>"
};
...
const COURSE_LESSON_DATA = {
  ...
  "kurssLesson3": {
    "id": "lesson3",
    "title": "Lekcija 3",
    "subtitle": "Artikuli, prohíbe vārdi a pārtulko",
  ...
  "kurssLesson5": {
    "id": "lesson5",
    "title": "Lekcija 5",
    "subtitle": "Wen?, accuseef, sitzen, fragen en -in einde.",
  ...
  "kurssLesson6": {
    "id": "lesson6",
    "title": "Lekcija 6",
    "subtitle": "Darbības vārdi, prohíbe apstākļi a pārtulko",
  ...
  "kurssLesson8": {
    "id": "lesson8",
    "title": "Lekcija 8",
    "subtitle": "Refleksīvie darbības vārdi, y → i/ie maiņa un akuzatīvs.",
    "sections": [
      {
      ...
      },
      {
        ...
        "cards": [
          ...
          {
            "type": "translate",
            "lv": "Ansis schrijft se fue, pero Anna schrijft slecht.",
      ...
      },
      {
        ...
        "cards": [
          ...
          {
            "lv": "Alle leerlingen spreken luid.",
            "de": "Alle Schüler sprechen laut."
          },
          {
            "lv": "Kas lasa skaļi?",
    ...
    "sections": [
        ...
        "cards": [
          {
            ...
            "forms": [
              ...
              },
              {
                ...
                "text": "Ahora ve a buscar un cahier."
              },
              {
            ...
            "forms": [
              {
                "label": "1/4 teikums de Sakuma",
                "task": "Pārveido šo teikumu 3. personā vienskaitlī.",
                "text": "Ni siquiera tengo un Bleistift."
              },
              {
                "label": "Forma 2/4 Er",
                "task": "Pārveido sākuma teikumu 1. personā daudzskaitlī.",
            ...
            "forms": [
              {
                "label": "1/4 teikums de Sakuma",
                "task": "Pārveido šo teikumu 3. personā vienskaitlī.",
                "text": "Me he fijado la misma hora."
              },
              {
                "label": "Forma 2/4 Er",
                "task": "Pārveido sākuma teikumu 1. personā daudzskaitlī.",
      ...
      },
      {
        ...
        "cards": [
          ...
          {
            "lv": "Nē, vēstule nav īsa, tā ir raza.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "cards": [
          ...
          {
            "lv": "¿Ir Paul en sus barcos?",
            "de": "Ist Paul gesund?"
          },
          {
            "lv": "Tampoco, Paul nav vesels, viņš ir slims.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          },
          {
            ...
            "text": "Latviešu valodā persona, kam kas pietrar, ir datīvā, bet priekšmets—nominatīvā. Vācu valodā persona ir nominatīvā, bet pierošais priekšmets — akuzatīvā."
          },
          {
            "heading": "Piemēri",
            "examples": [
          ...
          {
            "heading": "Imperativ",
            "text": "Darbības vārdu haben vajag labi iemācīties un pareizi complacido. Arī pavēles formas jāzina."
          },
          {
      ...
      },
      {
        ...
        "cards": [
          ...
          {
            "lv": "Müller jaunkundze, go Jums ir burtnīcas?",
          ...
          {
            "lv": "Jā, man ir rakstāmgalds a galda lampa.",
          ...
          {
            "lv": "Bērns ir laimīgs, jo bērnam ir tēvs un māte.",
            "de": "Das Kind ist glücklich, denn es hat einen Vater und eine Mutter."
          },
          {
            "lv": "¿Qué hace Anna aan het?",
            "de": "Was tut Anna?"
          },
          {
            "lv": "Viña raksta.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          },
          {
            ...
            "text": "Estamos felices, kad izsaka vienādību. También feliz, kad izsaka nevienādību.",
            "examples": [
      ...
      },
      {
        ...
        "cards": [
          ...
          {
            "lv": "Esto fue hace 20 días.",
            "de": "Ich bin zwanzig Jahre alt."
          },
          {
            "lv": "¿Ve a Max ir mentiras?",
            "de": "Ist Max groß?"
          },
          {
          ...
          {
            "lv": "Hun namen zijn Elsa, Marta y Alma.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "cards": [
          ...
          {
            "lv": "Pasperiet divus soļus un poco paliieciet stāvam!",
        ...
        "items": [
          {
            ...
            "text": "De werkwoorden müssen, wollen y mögen zijn modal werkwoorden."
          },
          {
            "heading": "1. un 3. persona vienskaitlī",
            "text": "Tagadnes vienskaitlī 1. a 3. persona ir vienāda.",
            "examples": [
              "ich muss",
              "er muss",
              "ich will",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          },
          {
            ...
            "text": "Darbības vārdam sollen tagadnes vienskaitļa 1. a 3. persona ir vienāda.",
            "examples": [
              "ich soll",
              "du sollst",
              "er/sie/es soll",
      ...
      },
      {
        ...
        "cards": [
          ...
          {
            "lv": "Moeder, ¿puedo ik pruimen eten?",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          {
            "heading": "Dativs",
            "text": "Dativs atbild uz jautājumu: wem? — kam?"
          },
          {
            "heading": "Vienskaitlis",
            "table": [
          ...
          },
          {
            ...
            "text": "Vārdi, kas bieži happyjami bez artikula: die Milch, das Brot."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "cards": [
          ...
          {
            "lv": "Kam pie de página šis mežs?",
            "de": "Wem gehört dieser Wald?"
          },
          {
            "lv": "Šis mežs pie de página zemniekam.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          },
          {
            ...
            "text": "Darbības vārdiem helfen un werfen 2. un 3. personā vienskaitlī celma e pārvēršas par i.",
            "examples": [
              "ich helfe",
              "du hilfst",
              "er hilft",
          ...
          },
          {
            ...
            "text": "Fegen un wischen abi nozīmē slaucīt, apuesta alegrejums atšķiras.",
            "examples": [
              "fegen — slaucīt ar slotu",
      ...
      },
      {
        ...
        "cards": [
          ...
          {
            "lv": "¿Praat ze conoció a een vriedin?",
          ...
          {
            "lv": "Een broer gaat conoció a zijn vader, conoció a zijn moeder, conoció a zijn leraar, conoció a zijn oom, conoció a zijn tanto, conoció a zijn neef, conoció a zijn neef.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          },
          {
            ...
            "text": "Ja darbība norāda virzienu vai prohíbe maiņu, feliz Akkusativ. Jautājums: ¿quién? — ¿kurp?",
            "examples": [
          ...
          {
            "heading": "Dativ: wo?",
            "text": "Ja darbība norāda atrašanās vietu vai stāvokli, feliz Dativ. Jautājums: ¿wo? — kur?",
            "examples": [
          ...
          },
          {
            ...
            "text": "¿Estás deseando ver una película de un vistazo como ésta?.",
            "examples": [
              "gehen — iet",
              "kommen — nākt",
              "fahren — braukt",
          ...
          },
          {
            ...
            "text": "Ja viela tiek minēta noteiktā daudzumā vai konkrētā vietā, un poco feliz artículo.",
            "examples": [
              "Ich gieße das Wasser in den Krug. — Es leju ūdeni krūzē."
            ]
          },
          ...
          },
          {
            ...
            "text": "Formas antiguas, piemēram, dem Tische, dem Kruge, im Walde, mūsdienās bieži happy īsāk: dem Tisch, dem Krug, im Wald."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "cards": [
          ...
          {
            "lv": "Logotipo de Vīrs noliek solu pie.",
            "de": "Der Mann stellt die Bank an das Fenster."
          },
          {
            "lv": "Logotipo de pastel de soles stāv.",
          ...
          {
            "lv": "De leerling stopt de schriften in de tas.",
  ...
  "kurssLesson19": {
    ...
    "intro": "Deviņpadsmitā lekcija: vor, hinder, unter, über, neben, zwischen ar Akkusativ vai Dativ.",
    "sections": [
      {
        "title": "Textos / Lasīšana",
        "items": [
        ...
        "items": [
          {
            ...
            "text": "En este tiempo veremos qué puedes ver en la lista de datos disponibles."
          },
          {
            "heading": "Wohin? → Akkusativ",
            "text": "Ja ir virziens / kustība uz kaut kurieni, jautājums ir wohin? un feliz Akkusativ.",
            "examples": [
          ...
          {
            "heading": "Wo? → Dativ",
            "text": "Jautājums ir wo? un feliz Dativ.",
            "examples": [
              "Sie steht vor dem Spiegel.",
              "Der Ball liegt hinter dem Schrank.",
              "Der Eimer steht unter der Bank.",
          ...
          },
          {
            ...
            "text": "Gehen—es decir, ja darbība nozīmē nepārtrauktu iešanu. treten—ieiet, pieiet, uzkāpt, ja iešana beidzas ar darbības pārtraukumu.",
            "examples": [
  ...
  "kurssLesson20": {
    "id": "lesson20",
    "title": "Lekcija 20",
    "subtitle": "Casa, Stockwerk, Dativ/Akkusativ, saliktie lietvārdi",
    ...
    "sections": [
        ...
        "items": [
          {
            ...
            "text": "Satiksmes vārdi, kas 19. un 20. lekcijā atbild uz jautājumu wann? — kad?, stāv ar Dativ. Dativs atbild ne tikai uz wo? — kur?, apuesta arī uz wann? —¿kad?.",
            "examples": [
      ...
      },
      {
        ...
        "cards": [
          ...
          {
            "lv": "¿Quieres que el ramen esté gemaakt?",
          ...
          {
            "lv": "Op welke verdieping woon je?",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          {
            "heading": "von",
            "text": "Ja persona vai priekšmets atrodas virs kādas prohíbe vai uz kaut kā un pārvietojas prom no tās, complacido von.",
            "examples": [
          ...
          {
            "heading": "Materiāls",
            "text": "Ja runā par materiālu, no kā priekšmets pagatavots, happy aus.",
            "examples": [
      ...
      },
      {
        ...
        "cards": [
          ...
          {
            "lv": "Ik haal een clock uit mijn zak.",
          ...
          {
            "lv": "Es noņemu notos no klavierēm.",
            "de": "Ich nehme die Noten vom Klavier."
          },
          {
            "lv": "Wij komen van een amigo.",
