  ...
  "kurssLesson8": {
    ...
    "sections": [
      ...
      },
      {
        "title": "Izruna",
        "items": [
          "ä, kā jau minēts, izrunā gan kā šauro īso vai garo e skaņu. Eksempler: der Bäcker (bēker), das Mädchen (mētchen).",
          "ä vēl izrunā arī kā plato e, piemēram, vārdā der Gärtner (dēr gertner).",
          "I ordene Schüler, Bücher er ü langt, i Müller er ü kort.",
      ...
      },
      {
        ...
        "items": [
          ...
          "For disse verber har imperativ ental også i eller ie i stedet for e i stammen: Paul, sprich! Lies! Paul und Hans, lest und sprecht!",
            ...
            "forms": [
              {
                ...
                "task": "Ændr denne sætning til 3. person ental.",
                "text": "Ich nehme ein Heft."
              },
              {
                "label": "2/4 Er forma",
                "task": "Ændr indledningssætningen til 1. person flertal.",
                "text": "Er nimmt ein Heft."
              },
              {
                "label": "3/4 Wir forma",
                "task": "Brug flertal i stedet for ental.",
                "text": "Wir nehmen ein Heft."
              },
              {
                "label": "4/4 Flertal",
                "task": "Klar. Næste tryk viser næste kort.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          "Dansk o er ikke det samme som tysk o, fx: fond, nominativ, fotograf.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          "I ordene Schwester og am jüngsten udtales st som almindeligt st.",
          "I ordet der Federhalter udtales h som en lyd, mens h i ordet der Sohn kun forlænger den foregående vokal."
        ]
      },
      {
        "title": "Gramatika",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          "Hvis andre former har ss, kan der stå ß før endelsen: müssen, ich muss, du musst, ihr müsst.",
          "I ordet mögen udtales ö tydeligt.",
          "Hvis g efterfølges af t, lyder g tættere på k: du magst, ihr mögt.",
          "På samme måde lyder g før s tættere på k, fx i ord med gs-klynger."
        ]
      },
      {
        "title": "Oversætte",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          "I ordet Äpfel udtales ä kort, fordi to konsonanter følger efter vokalen.",
          "I ordet schälen udtales ä langt, fordi kun én konsonant følger efter vokalen.",
          "I ordet gern er e kort og fladt.",
  ...
  "kurssLesson16": {
    ...
    "sections": [
      ...
      },
      {
        "title": "Izruna",
        "items": [
          "I ordene wem, dem, den, der er e langt og smalt.",
          "I ordet gehorchen høres h: ge-hor-chen.",
  ...
  "kurssLesson17": {
    ...
    "sections": [
      ...
      },
      {
        "title": "Izruna",
        "items": [
          "I ordet werfen er det første e fladt: werfen.",
          "I ordet wieder er e fladt: wieder.",
          "I ordene wieder og die Diele betyder ie lang i.",
          "I ordet der Spaten udtales sp som sp."
        ]
      },
      {
        "title": "Øvelse",
  ...
  "kurssLesson18": {
    ...
    "sections": [
      ...
      },
      {
        "title": "Izruna",
        "items": [
          "I ordet wohin høres h: wo-hin.",
          "I ordet wo er o langt: wo."
        ]
      },
      {
        "title": "Øvelse",
        "cards": [
          {
            ...
            "task": "Vælg den rigtige bøjning: dativ eller akkusativ.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          "I ordet hinter høres h, og e er fladt.",
          "I ordet der Stuhl udtales st som st; h forlænger vokalen og udtales ikke.",
          "I ordet der Strauch udtales st som st.",
        ...
        "cards": [
          {
            ...
            "task": "Vælg den rigtige bøjning: wohin? → akkusativ, wo? → dativ",
  ...
  "kurssLesson20": {
    ...
    "sections": [
      ...
      },
      {
        "title": "Izruna",
        "items": [
          "I ordene Stockwerk, Stein, Stadt, stecken udtales st som st.",
          "I ordene der Ofen, der Boden er o langt.",
          "sch izrunā kā š: der Schornstein, der Mensch.",
          "I ordene das Haus, das Holz høres h og skal udtales.",
          "I ordene die Wohnung, wohnen er h længdemarkør og udtales ikke.",
          "I ordene die Küche, die Dächer udtales ch som ich-lyden.",
        ...
        "cards": [
          {
            ...
            "task": "Vælg den rigtige bøjning: wo/wann → dativ, wohin → akkusativ.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          "I ordene arbeiten, das Beil, steigen udtales ei som ai.",
          "I ordet die Scheune udtales eu som oi.",
