const B2_WORDS = [
  ...
  },
  {
    ...
    "study": {
      ...
      "translation": "Μέλος",
      "explanation": "Κύρια ιδέα: Genosse σημαίνει κοινωνικός ή κομματικός αρχηγός, ειδικά σε πολιτικό ή ιστορικό πλαίσιο. Το Mitglied είναι ουδέτερο μέλος. Οι κάμερες είναι σύντροφος με στρατιωτική ή φιλική έννοια.",
      "examples": [
        {
          "de": "Genosse Müller spricht heute.",
          "lv": "Θα μιλήσει σήμερα ο κοινωνικός Müller."
        },
        {
          "de": "Er ist Mitglied im Verein.",
          "lv": "Είναι μέλος του συλλόγου."
        },
        {
          "de": "Er war mein Kamerad in der Armee.",
          "lv": "Ήταν ο σύντροφός μου στο στρατό."
        }
      ],
      "comparison": [
        {
          "word": "Der Geno",
          "meaning": "Κοινωνικός / αρχηγός κόμματος",
          "example": "Genosse Müller spricht. = Ο κοινωνικός Müller μιλάει."
        },
        {
          "word": "Das Mitglied",
          "meaning": "Μέλος",
          "example": "Er ist Mitglied im Verein. = Είναι μέλος του συλλόγου."
        },
        {
          "word": "Der Cameras",
          "meaning": "Σύντροφος",
          "example": "Er war mein Kamerad. = Ήταν ο σύντροφός μου."
        }
      ],
      "tip": "Το Genosse συνδέεται στενά με ένα πολιτικό ή ιστορικό πλαίσιο.",
      "important": "Μην χρησιμοποιείτε απλώς Genosse αντί για μέλος. Το Mitglied είναι πιο ουδέτερο.",
      "sectionAccents": {
        "explanation": {
          "blue": "Genosse",
          "purple": "seltsiline",
  ...
  },
  {
    ...
    "study": {
      "id": "b2-genossin",
      "layout": "standardStudy",
      "translation": "Μέλος (γυναίκα)",
      "explanation": "Κύρια ιδέα: die Genossin είναι μια γυναίκα Genosse. Όπως και ο Genosse, σημαίνει κοινωνικός ή κομματικός ηγέτης, ειδικά σε πολιτικό ή ιστορικό πλαίσιο.",
      "examples": [
        {
          "de": "Genossin Schmidt spricht heute.",
          "lv": "Θα μιλήσει σήμερα ο κοινωνικός Σμιτ."
        },
        {
      ...
      "comparison": [
        {
          "word": "Die Genossen",
          "meaning": "Κοινωνικός (θηλυκός)",
          "example": "Genossin Schmidt spricht. = Ο κοινωνικός Σμιντ μιλάει."
        },
        {
          "word": "Das Mitglied",
          "meaning": "Μέλος",
          "example": "Sie ist Mitglied im Verein. = Είναι μέλος του συλλόγου."
        },
        {
          "word": "Die Kameradin",
          "meaning": "Σύντροφος (γυναίκα)",
          "example": "Sie war meine Kameradin. = Ήταν ο σύντροφός μου."
        }
      ],
      "tip": "Ο Genossin ακολουθεί την ίδια λογική με τον Genosse, αλλά σε γυναικεία μορφή.",
      "important": "Μην χρησιμοποιείτε απλώς το Genoss αντί για μέλος. Το Mitglied είναι πιο ουδέτερο.",
      "sectionAccents": {
        "explanation": {
          "blue": "Genossin",
          "purple": "seltsiline",
      ...
      "comparison": [
        {
          ...
          "example": "Es gibt Hochwasser. = Υπάρχει πλημμύρα."
        },
        {
          "word": "Die Überschwemmung",
          "meaning": "Πλημμύρα (μπετόν)",
          "example": "Die Überschwemmung zerstörte Häuser. = Η πλημμύρα κατέστρεψε τα σπίτια."
        },
        {
          "word": "Der Pegel",
          "meaning": "Στάθμη νερού",
          "example": "Der Pegel steigt. = Η στάθμη του νερού ανεβαίνει."
        }
      ],
      "tip": {
        "leftBlocks": [
      ...
      "comparison": [
        {
          ...
          "example": "Er legt Nachdruck auf die Frist. = Τονίζει την προθεσμία."
        },
        {
          "word": "Der Nachdruck (Buch)",
          "meaning": "Ανατύπωση",
          "example": "Der Nachdruck erschien im Frühjahr. = Η επανέκδοση κυκλοφόρησε την άνοιξη."
        },
        {
          "word": "Der Druck",
          "meaning": "Πίεση / εκτύπωση",
          "example": "Unter Druck stehen = Όντας υπό πίεση."
        }
      ],
      "tip": [
  ...
  },
  {
    ...
    "study": {
      ...
      "layout": "standardStudy",
      "translation": "Αράπης",
      "explanation": "Κύρια ιδέα: Ο Νέγρος είναι μια ιστορική και σήμερα προσβλητική λέξη για ένα μελαχρινό άτομο. Στα γερμανικά, η λέξη δεν χρησιμοποιείται πλέον στην ουδέτερη ή σύγχρονη γλώσσα.",
      "examples": [
        {
          "de": "In alten Texten steht das Wort Neger.",
          "lv": "Η λέξη νέγρος απαντάται σε παλιά κείμενα."
        },
        {
          "de": "Heute sagt man schwarze Person oder Person afrikanischer Herkunft.",
          "lv": "Σήμερα λέει κάποιος μαύρος ή άτομο αφρικανικής καταγωγής."
        }
      ],
      "comparison": [
        {
          "word": "Νέγρος",
          "meaning": "Ιστορικός, προσβλητικός",
          "example": "In alten Texten steht Neger. = Στα παλιά κείμενα υπάρχει ένας νέγρος."
        },
        {
          "word": "Schwarze Πρόσωπο",
          "meaning": "Μοντέρνο, ουδέτερο",
          "example": "Heute sagt man schwarze Person. = Σήμερα λέγεται ένας μαύρος."
        }
      ],
      "tip": "Μάθετε τη λέξη για το ιστορικό πλαίσιο, αλλά μην τη χρησιμοποιείτε στην καθημερινή γλώσσα.",
      "important": "Ένας νέγρος είναι προσβλητικός αυτές τις μέρες. Στα σύγχρονα γερμανικά, χρησιμοποιήστε πιο ουδέτερες εκφράσεις.",
      "sectionAccents": {
        "explanation": {
          "blue": "Neger",
          "purple": "neeger",
  ...
  },
  {
    ...
    "study": {
      ...
      "layout": "standardStudy",
      "translation": "Ενοίκιο",
      "explanation": "Κύρια ιδέα: το die Pacht είναι μια σύμβαση μίσθωσης για ένα κομμάτι γης, ένα χωράφι ή μια επιχείρηση. Die Miete είναι το ενοίκιο μιας κατοικίας. Το Pacht δίνει έμφαση στο δικαίωμα χρήσης, όχι στον χώρο διαβίωσης.",
      "examples": [
        {
          "de": "Er zahlt die Pacht für das Feld.",
          "lv": "Πληρώνει ενοίκιο για το χωράφι."
        },
        {
          "de": "Die Miete für die Wohnung ist hoch.",
          "lv": "Το ενοίκιο του διαμερίσματος είναι υψηλό."
        },
        {
          "de": "Der Pachtvertrag läuft zehn Jahre.",
          "lv": "Η μίσθωση ισχύει για δέκα χρόνια."
        }
      ],
      "comparison": [
        {
          "word": "Die Pacht",
          "meaning": "Ενοικίαση (οικόπεδο, εταιρεία)",
          "example": "Die Pacht für das Feld ist hoch. = Το ενοίκιο του χωραφιού είναι υψηλό."
        },
        {
          "word": "Die Miete",
          "meaning": "Ενοικίαση (χώρος διαβίωσης)",
          "example": "Die Miete ist hoch. = Το ενοίκιο είναι υψηλό."
        },
        {
          "word": "Der Pachtvertrag",
          "meaning": "Συμφωνητικό ενοικίασης",
          "example": "Der Pachtvertrag läuft zehn Jahre. = Η μίσθωση ισχύει για δέκα χρόνια."
        }
      ],
      "tip": "Το Pacht είναι για ένα κομμάτι γης ή μια επιχείρηση. Το Miete είναι για χώρο διαβίωσης.",
      "important": "Μην μεταφράζετε το Pacht με τη λέξη rent, αν πρόκειται για χωράφι ή επιχείρηση.",
      "sectionAccents": {
        "explanation": {
          "blue": "die Pacht",
          "purple": "rent",
      ...
      "comparison": [
        {
          ...
          "example": "Er weist die Aufgabe zu. = Αυτός θέτει το καθήκον."
        },
        {
          "word": "Δίνω",
          "meaning": "Να δώσει",
          "example": "Er gibt mir die Arbeit. = Μου δίνει δουλειά."
        },
        {
          "word": "Συγκρίνω",
          "meaning": "Διανέμω",
          "example": "Er verteilt die Aufgaben. = Κατανέμει καθήκοντα."
        }
      ],
      "tip": {
        "leftBlocks": [
      ...
      "comparison": [
        {
          ...
          "example": "Ich biete Hilfe an. = Προσφέρω βοήθεια."
        },
        {
          "word": "Παντζάρι",
          "meaning": "Να προσφέρει • Να δώσει",
          "example": "Er bietet viel Geld. = Προσφέρει πολλά χρήματα."
        },
        {
          "word": "Vorschlagen",
          "meaning": "Να βάλει μπροστά",
          "example": "Ich schlage vor. = Θα το βάλω μπροστά."
        }
      ],
      "tip": {
        "leftBlocks": [
