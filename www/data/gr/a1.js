const A1_WORDS = [
  ...
  },
  {
    ...
    "study": {
      "id": "a1-noch-study",
      "layout": "standardStudy",
      "translation": "ακόμη • ακόμα",
      "explanation": [
        "Κύρια ιδέα: το noch δηλώνει ότι κάτι συνεχίζεται ή δεν έχει ολοκληρωθεί.",
        "Σημαίνει συνήθως «ακόμη» ή «ακόμα».",
        "Χρησιμοποιείται για κατάσταση που εξακολουθεί να ισχύει.",
        "Σε ερώτηση μπορεί να σημαίνει «είσαι ακόμη εδώ;»."
      ],
      "examples": [
        {
          "de": "Ich bin noch zu Hause.",
          "lv": "Είμαι ακόμη στο σπίτι."
        },
        {
          "de": "Ich bin noch zu Hause.",
          "lv": "Είμαι ακόμη στο σπίτι."
      ...
      "tip": [
        "Το noch δηλώνει συνέχεια ή κάτι που δεν έχει τελειώσει ακόμη.",
        "Χρησιμοποίησε το noch με τη σημασία «ακόμη / ακόμα»."
      ],
      "important": [
        "noch = ακόμη / ακόμα.",
        "Δηλώνει συνέχεια ή μη ολοκληρωμένη κατάσταση."
      ],
      "sectionAccents": {
        "explanation": {
          "blue": [
  ...
  {
    "de": "nur",
    "lv": "μόνο • αποκλειστικά",
    "level": "A1",
    "study": {
      "id": "a1-nur-study",
      "layout": "standardStudy",
      "translation": "μόνο • αποκλειστικά",
      "explanation": [
        "Κύρια ιδέα: το nur περιορίζει μια ποσότητα, ένα πρόσωπο, μια επιλογή ή μια δυνατότητα.",
        "Σημαίνει συνήθως «μόνο» ή «αποκλειστικά».",
        "Μπορεί να περιορίζει χρήματα, πρόσωπα ή αντικείμενα.",
        "Το ακριβές νόημα εξαρτάται από το στοιχείο που περιορίζει."
      ],
      "examples": [
        {
      ...
      "tip": [
        "Το nur περιορίζει ποσότητα, πρόσωπο ή επιλογή.",
        "Χρησιμοποίησε το nur με τη σημασία «μόνο»."
      ],
      "important": [
        "Το ελληνικό «μόνο» δεν αποδίδεται πάντοτε με nur.",
  ...
  {
    "de": "passen",
    "lv": "ταιριάζω • μου πηγαίνει",
    "level": "A1",
    "study": {
      "id": "a1-passen",
      "layout": "standardStudy",
      "translation": "ταιριάζω • μου πηγαίνει",
      "explanation": [
        "Κύρια ιδέα: το passen σημαίνει ταιριάζω, εφαρμόζω ή μου πηγαίνει.",
        "Για ρούχα αναφέρεται συχνά στο σωστό μέγεθος.",
        "Για χρώματα ή στιλ δηλώνει ότι κάτι πηγαίνει σε κάποιον.",
        "Η φράση Das passt. σημαίνει «Αυτό ταιριάζει / Αυτό είναι εντάξει»."
      ],
      "examples": [
        {
          "de": "Die Jacke passt mir.",
          "lv": "Το μπουφάν μού κάνει."
        },
        {
          "de": "Das Kleid passt gut.",
          "lv": "Το φόρεμα εφαρμόζει καλά."
        },
        {
          "de": "Die Farbe passt zu dir.",
          "lv": "Το χρώμα σού πηγαίνει."
        },
        {
          "de": "Das passt.",
          "lv": "Αυτό ταιριάζει."
      ...
      "tip": {
        "text": "Θυμήσου: Das passt. = Αυτό ταιριάζει / Αυτό είναι εντάξει."
      },
      "important": [
        "Το passen δεν αφορά μόνο ρούχα.",
        "Μπορεί επίσης να δηλώνει ότι μια ώρα, ένα σχέδιο ή μια λύση ταιριάζει."
      ],
      "comparison": [
        {
          "word": "passen",
          "meaning": "ταιριάζω / μου κάνει",
          "example": "Die Jacke passt mir. – Το μπουφάν μού κάνει."
        },
        {
          "word": "stehen",
          "meaning": "μου πηγαίνει (χρώμα ή στιλ)",
          "example": "Rot steht dir gut. – Το κόκκινο σου πηγαίνει."
        },
        {
          "word": "geeignet sein",
          "meaning": "είναι κατάλληλο",
          "example": "Das ist geeignet. – Αυτό είναι κατάλληλο."
        },
        {
          "word": "funktionieren",
          "meaning": "λειτουργώ",
          "example": "Das funktioniert. – Αυτό λειτουργεί."
        }
      ],
      "sectionAccents": {
        "explanation": {
