const A1_WORDS = [
      ...
      "comparison": [
        {
          ...
          "example": "Ich bleibe bis morgen. – Залишуся до 18:00."
        },
        {
          "word": "bis zu",
          "meaning": "поки (до певного часу)",
          "example": "bis zum Bahnhof – Працюю з 9 до 17."
        },
        {
          "word": "bis jetzt",
          "meaning": "поки",
    ...
    "study": {
      ...
      "comparison": [
        ...
        },
        {
          ...
          "example": "Ich bringe dir ein Buch. – Брінгст du Brot mit?"
        },
        {
          "word": "nehmen",
          "meaning": "брати",
      ...
      "comparison": [
        {
          ...
          "example": "Erst lernen, dann spielen. – Erst arbeiten, dann Pause. = Спочатку попрацюйте, потім зробіть паузу."
        },
        {
          "word": "zuerst",
  ...
  },
  {
    ...
    "study": {
      ...
      "explanation": [
        "ihr має кілька значень: ви при звертанні до кількох людей, їй як давальний відмінок від sie та її як присвійний займенник.",
        "Коли ihr є підметом із формою дієслова для другої особи множини, воно означає ви: Kommt ihr mit?",
        "Як давальний відмінок від sie, ihr означає їй: Ich gebe ihr das Buch.",
        "Як присвійний займенник перед іменником, ihr означає її: ihr Buch.",
        "Ввічливе звертання німецькою завжди Sie з великої літери, а не ihr."
      ],
      "examples": [
        {
      ...
      "tip": [
        {
          "text": "ihr із дієсловом у другій особі множини = ви; ihr як давальний або присвійний займенник = їй або її."
        },
        {
          "text": "Habt ihr...? / Kommt ihr...? = ви; Ich gebe ihr... / ihr Buch = їй / її."
        }
      ],
      "important": [
        "ihr залежно від контексту означає ви, їй або її.",
