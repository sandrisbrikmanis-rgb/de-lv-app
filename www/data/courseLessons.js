...
const COURSE_LESSON_DATA = {
  ...
  kurssLesson17: {
    ...
    sections: [
      ...
      { title: "Vingrinājums", cards: [
        { prompt: "Wen sieht der Knecht? (der Jäger, der Müller, der Tischler)", task: "Atbildi vienskaitlī, pēc tam daudzskaitlī.", task2: "Tagad atbildi daudzskaitlī.", answer: "Der Knecht sieht den Jäger, den Müller, den Tischler.", answer2: "Der Knecht sieht die Jäger, die Müller, die Tischler." },
        { prompt: "Was sieht der Knecht? (der Besen, die Schaufel, der Garten)", task: "Atbildi vienskaitlī, pēc tam daudzskaitlī.", task2: "Tagad atbildi daudzskaitlī.", answer: "Der Knecht sieht den Besen, die Schaufel, den Garten.", answer2: "Der Knecht sieht die Besen, die Schaufeln, die Gärten." },
        { prompt: "Mit wem spricht der Knecht? (der Vetter, die Base, das Mädchen)", task: "Atbildi vienskaitlī, pēc tam daudzskaitlī.", task2: "Tagad atbildi daudzskaitlī.", answer: "Der Knecht spricht mit dem Vetter, mit der Base, mit dem Mädchen.", answer2: "Der Knecht spricht mit den Vettern, mit den Basen, mit den Mädchen." },
        { prompt: "Womit arbeitet der Knecht? (der Spaten, dieses Beil, jene Säge)", task: "Atbildi vienskaitlī, pēc tam daudzskaitlī.", task2: "Tagad atbildi daudzskaitlī.", answer: "Der Knecht arbeitet mit dem Spaten, mit diesem Beil, mit jener Säge.", answer2: "Der Knecht arbeitet mit den Spaten, mit diesen Beilen, mit jenen Sägen." },
        { prompt: "Wem hilft der Knecht? (dieser Tischler, jene Frau, das Fräulein)", task: "Atbildi vienskaitlī, pēc tam daudzskaitlī.", task2: "Tagad atbildi daudzskaitlī.", answer: "Der Knecht hilft diesem Tischler, jener Frau, dem Fräulein.", answer2: "Der Knecht hilft diesen Tischlern, jenen Frauen, den Fräulein." }
      ] },
      { title: "Pārtulko", type: "translationCards", cards: [
  ...
  kurssLesson19: {
    ...
    sections: [
      ...
      { title: "Vingrinājums", cards: [
        { prompt: "Anna geht in d... Garten, an d... Teich, vor d... Mühle, hinter d... Scheune, auf d... Feld, über d... Brücke, unter d... Baum, zwischen d... Strauch und d... Laube.", task: "Izvēlies pareizo locījumu: wohin? → Akkusativ, wo? → Dativ.", answer: "Anna geht in den Garten, an den Teich, vor die Mühle, hinter die Scheune, auf das Feld, über die Brücke, unter den Baum, zwischen den Strauch und die Laube." },
        { prompt: "Anna befindet sich oft in d... Garten, an d... Teich, vor d... Mühle, hinter d... Scheune, auf d... Feld, über d... Wasser, unter d... Baum, zwischen d... Strauch und d... Laube.", task: "Izvēlies pareizo locījumu: wohin? → Akkusativ, wo? → Dativ.", answer: "Anna befindet sich oft in dem Garten, an dem Teich, vor der Mühle, hinter der Scheune, auf dem Feld, über dem Wasser, unter dem Baum, zwischen dem Strauch und der Laube." }
      ] },
      { title: "Pārtulko", type: "translationCards", cards: [
  ...
  kurssLesson20: {
    ...
    sections: [
      ...
      { title: "Vingrinājums", cards: [
        { prompt: "Der Wolf lebt in (der Wald).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Der Wolf lebt in dem Wald." },
        { prompt: "Dieser Mann lebt in (das Haus).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Dieser Mann lebt in dem Haus." },
        { prompt: "Der Schornsteinfeger steht auf (das Dach).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Der Schornsteinfeger steht auf dem Dach." },
        { prompt: "Der Knecht arbeitet auf (das Feld).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Der Knecht arbeitet auf dem Feld." },
        { prompt: "Die Magd arbeitet auf (die Wiese).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Die Magd arbeitet auf der Wiese." },
        { prompt: "Der Holzhauer sägt das Holz in (die Scheune).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Der Holzhauer sägt das Holz in der Scheune." },
        { prompt: "Der Schüler stellt das Glas auf (die Kommode).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Der Schüler stellt das Glas auf die Kommode." },
        { prompt: "Der Jäger geht in (der Wald).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Der Jäger geht in den Wald." },
        { prompt: "Die Katze kriecht unter (die Bank).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Die Katze kriecht unter die Bank." },
        { prompt: "Der Ball rollt unter (der Schrank).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Der Ball rollt unter den Schrank." },
        { prompt: "Dieser Mann geht über (die Brücke).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Dieser Mann geht über die Brücke." },
        { prompt: "Jener Mann steht unter (die Brücke).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Jener Mann steht unter der Brücke." },
        { prompt: "Ein Spiegel hängt an (die Wand).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Ein Spiegel hängt an der Wand." },
        { prompt: "Der Bruder stellt die Vase vor (der Spiegel).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Der Bruder stellt die Vase vor den Spiegel." },
        { prompt: "Das Kind geht gern auf (die Straße).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Das Kind geht gern auf die Straße." },
        { prompt: "Das Kind spielt gern auf (die Straße).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Das Kind spielt gern auf der Straße." },
        { prompt: "Das Kind spielt gern in (der Garten).", task: "Izvēlies pareizo locījumu: wo/wann → Dativ, wohin → Akkusativ.", answer: "Das Kind spielt gern in dem Garten." }
      ] },
      { title: "Pārtulko", type: "translationCards", cards: [
  ...
  kurssLesson21: {
    ...
    sections: [
      ...
      { title: "Vingrinājums", cards: [
        { prompt: "Woher kommt der Vater?", task: "Atbildi pēc lasīšanas teksta.", answer: "Der Vater kommt von dem Felde." },
        { prompt: "Wohin geht er?", task: "Atbildi pēc lasīšanas teksta.", answer: "Er geht in die Scheune." },
        { prompt: "Wo spricht er mit den Holzhauern?", task: "Atbildi pēc lasīšanas teksta.", answer: "Er spricht in der Scheune mit den Holzhauern." },
        { prompt: "Woher steigt der Mann?", task: "Atbildi pēc lasīšanas teksta.", answer: "Der Mann steigt von dem Berge." },
        { prompt: "Wohin kommt er?", task: "Atbildi pēc lasīšanas teksta.", answer: "Er kommt auf den Hof." },
        { prompt: "Wo findet er den Vater?", task: "Atbildi pēc lasīšanas teksta.", answer: "Er findet den Vater auf dem Hof." },
        { prompt: "Woher tritt die Mutter?", task: "Atbildi pēc lasīšanas teksta.", answer: "Die Mutter tritt aus dem Hause." },
        { prompt: "Wohin geht sie?", task: "Atbildi pēc lasīšanas teksta.", answer: "Sie geht auf den Hof." },
        { prompt: "Wo sieht sie den Mann?", task: "Atbildi pēc lasīšanas teksta.", answer: "Sie sieht den Mann auf dem Hof." },
        { prompt: "Woher kommt die Magd?", task: "Atbildi pēc lasīšanas teksta.", answer: "Die Magd kommt aus der Küche." },
        { prompt: "Wohin eilt sie?", task: "Atbildi pēc lasīšanas teksta.", answer: "Sie eilt in den Keller." },
        { prompt: "Wo steht ein Eimer mit Milch?", task: "Atbildi pēc lasīšanas teksta.", answer: "Ein Eimer mit Milch steht im Keller." },
        { prompt: "Woher steigt sie?", task: "Atbildi pēc lasīšanas teksta.", answer: "Sie steigt aus dem Keller." },
        { prompt: "Wohin geht sie zurück?", task: "Atbildi pēc lasīšanas teksta.", answer: "Sie geht in die Küche zurück." },
        { prompt: "Wo arbeitet sie fleißig?", task: "Atbildi pēc lasīšanas teksta.", answer: "Sie arbeitet fleißig in der Küche." }
      ] },
      { title: "Pārtulko", type: "translationCards", cards: [
