const B2_WORDS = [
  ...
  {
    "de": "chartern",
    "lv": "īrēt lidmašīnu vai kuģi noteiktam braucienam",
    "level": "B2"
  },
  {
    "de": "Chefarzt",
  ...
  },
  {
    ...
    "lv": "modeļu demonstrētājs modes skatēs",
    "level": "B2"
  },
  {
    "de": "dringen",
  ...
  },
  {
    ...
    "lv": "galda piederumi vienai personai",
    "level": "B2"
  },
  {
    "de": "gedeihen",
  ...
  },
  {
    ...
    "study": {
      ...
      "explanation": [
        "Glavna ideja: die Haube lahko pomeni kapo/kapuco ali kapuco/pokrivalo – kontekst določa pomen.",
        "Na glavi: die Haube = kapa, kapuca ali avtorska tehnika v določenem kontekstu (z. B. Nonne mit Haube).",
        "Na avtomobilu: die Motorhaube ali einfach die Haube = pokrov motorja.",
        "V kuhinji: die Dunsthaube = napa nad štedilnikom. V tehniki: kapuca ali pokrov nad napravo."
      ],
      "examples": [
        {
      ...
      "tip": [
        "Govorimo o glavi, nuni, klobuku → kapa / kapuca.",
        "Gre za avto, motor → hauba.",
        "Govorimo o štedilniku, aparatu → napi ali napi."
      ],
      "important": [
        "die Haube = cepurīte/kapuce VAI motora pārsegs VAI nosūcējs/pārsegs — atkarībā no konteksta.",
        "Pomoč spojin: Motorhaube (avto), Dunstaube (kuhinja)."
      ],
      "sectionAccents": {
        "explanation": {
          "blue": [
  ...
  },
  {
    ...
    "de_article": "das",
    "de_plural": "die HIV",
    "lv": "HIV (virus humane imunske pomanjkljivosti)",
    "level": "B2"
  },
  {
    "de": "HIV-negativ",
  ...
  },
  {
    ...
    "study": {
      ...
      "explanation": [
        "Glavna misel: das Hoch z veliko začetnico in členkom das je samostalnik - slavnostni vzklik/zdravica (Ein Hoch auf...! = Naj živi...!) ali v vremenu - območje visokega zračnega tlaka.",
        "hoch ar mazo burtu ir īpašības vārds — augsts (der Berg ist hoch).",
        "Besedna zveza ein Hoch ausbringen pomeni nazdraviti.",
        "V vremenu das Hoch pomeni anticiklon, območje visokega zračnega tlaka (nasprotno: das Tief)."
      ],
      "examples": [
        {
      ...
      "important": [
        ...
        "Kontrast v vremenu: das Hoch ↔ das Tief."
      ],
      "sectionAccents": {
        "explanation": {
          "blue": [
  ...
  },
  {
    ...
    "study": {
      ...
      "explanation": [
        "Glavna ideja: das Leiden z veliko začetnico in členkom das je samostalnik - trpljenje, dolgotrajna/huda bolezen.",
  ...
  },
  {
    ...
    "lv": "profesionāls aktieru grimētājs un frizieris",
    "level": "B2"
  },
  {
    "de": "Massaker",
  ...
  },
  {
    ...
    "lv": "starpnieks starp pretiniekiem vai partneriem",
    "level": "B2"
  },
  {
    "de": "mitwirken",
  ...
  },
  {
    ...
    "study": {
      ...
      "explanation": [
        "Glavna ideja: der Nachdruck lahko pomeni poudarek ali ponatis knjige.",
        "Nachdruck auf etwas legen = poudarjati kaj, vztrajati pri čem.",
        "Der Nachdruck eines Buches = ponatis knjige.",
        "Pravilen pomen določa kontekst (transakcije/pogajanja ali objava)."
      ],
      "examples": [
        {
      ...
      "tip": [
        "V razpravah in zahtevah: Nachdruck = poudarek.",
        "V založništvu in knjigah: Nachdruck = ponatis."
      ],
      "important": [
        "Nachdruck auf etwas legen = poudariti.",
  ...
  },
  {
    ...
    "lv": "lielu datoru apkalpes speciālists",
    "level": "B2"
  },
  {
    "de": "Opposition",
  ...
  },
  {
    ...
    "lv": "orgāna došana transplantācijai",
    "level": "B2"
  },
  {
    "de": "Organist",
  ...
  },
  {
    ...
    "lv": "katoļu priesteris • piederīgs kādam ordenim",
    "level": "B2"
  },
  {
    "de": "Peepshow",
    ...
    "lv": "erotiska programma, ko noskatās atsevišķi caur lodziņu",
    "level": "B2"
  },
  {
    "de": "Pegel",
  ...
  },
  {
    ...
    "lv": "automašīnas atbīdāmais jumts",
    "level": "B2"
  },
  {
    "de": "Schieber",
  ...
  },
  {
    ...
    "study": {
      ...
      "translation": "esamība",
      "explanation": [
        "Glavna ideja: das Sein z veliko začetnico in členkom das je samostalnik - obstoj, obstoj (filozofski pojem).",
        "sein ar mazo burtu ir darbības vārds — būt.",
        "das Sein bieži lieto filozofiskā vai abstraktā kontekstā (das menschliche Sein).",
        "Substantivacija: sein → das Sein, kot können → das Können."
      ],
      "examples": [
        {
      ...
      "important": [
        ...
        "Ta beseda je substantiviran glagol, kot das Können."
      ],
      "sectionAccents": {
        "explanation": {
          "blue": [
  ...
  },
  {
    ...
    "study": {
      ...
      "explanation": [
        "Glavna ideja: sofät je pogojni veznik - pomeni, če/pod pogojem, da.",
      ...
      "tip": [
        ...
        "'ker' (vzrok) v nemščini je da/weil, ne soufen."
      ],
      "important": [
        "sofern ir nosacījuma, ne cēloņa savienojums.",
        "Nepravilno: soufen = kot → Pravilno: da/weil = kot."
      ],
      "sectionAccents": {
        "explanation": {
          "blue": [
  ...
  },
  {
    ...
    "de_article": "der",
    "de_plural": "die Spuke",
    "lv": "rēgs • spoks • parādība",
    "level": "B2"
  },
  {
    "de": "spurlos",
    "lv": "bez pēdām • bez vēsts",
    "level": "B2"
  },
  {
    "de": "Staatenlose",
  ...
  },
  {
    ...
    "lv": "transporta līdzekļa bojājumi, kas pēc avārijas vairs nav labojami",
    "level": "B2"
  },
  {
    "de": "Totenschein",
  ...
  {
    "de": "überstehen",
    "lv": "pārciest • izturēt nepatikšanas",
    "level": "B2"
  },
  {
    "de": "übertragen",
  ...
  {
    "de": "verhandeln",
    "lv": "apspriesties • vest sarunas",
    "level": "B2"
  },
  {
    "de": "verhasst",
    "lv": "ienīsts • neieredzēts",
    "level": "B2"
  },
  {
    "de": "verheeren",
  ...
  },
  {
    ...
    "study": {
      ...
      "explanation": [
        "Glavna ideja: Spremeniti določeno stvar ali informacijo - načrt, termin, naslov, odločitev.",
        "ändern galvenokārt nozīmē: labot vai mainīt detaļu.",
        "Pogosto opisuje: določeno stvar.",
      ...
      "tip": [
        ...
        "Uporabite ändern, kadar kontekst ustreza temu pomenu."
      ],
      "important": [
        "ändern = mainīt konkrētu lietu (Termin, Adresse, Plan).",
        "Načrt, termin, naslov: ändern.",
        "Mainīt konkrētu lietu vai informāciju — plānu, termiņu, adresi, lēmumu."
      ],
      "sectionAccents": {
        "explanation": {
  ...
  },
  {
    ...
    "study": {
      ...
      "explanation": [
        "Glavna ideja: zamenjati ali zamenjati nekaj za nekaj drugega - denar, oblačila, delo, šolo, predmet.",
        "wechseln galvenokārt nozīmē: nomainīt pret citu.",
        "Pogosto je značilno: menjava / menjava.",
      ...
      "tip": [
        "Zamenjati ali zamenjati nekaj za nekaj drugega - denar, oblačila, delo, šolo, predmet.",
        "Uporabite wechseln, kadar kontekst ustreza temu pomenu."
      ],
      "important": [
        "wechseln = samainīt vai nomainīt pret citu (Geld, Schule, Thema).",
        "Denar, šola, služba, tema: wechseln.",
        "Zamenjati ali zamenjati nekaj za nekaj drugega - denar, oblačila, delo, šolo, predmet."
      ],
      "sectionAccents": {
        "explanation": {
  ...
  },
  {
    ...
    "study": {
      ...
      "explanation": [
        "Glavna ideja: Ponudite priložnosti, tečaje, storitve ali ugodnosti, ki jih ponuja kraj ali program.",
        "bieten galvenokārt nozīmē: sniegt iespēju / labumu.",
        "Pogosto opisuje: kaj ponuja kraj/program.",
        "bieten galvenokārt nozīmē: nodrošināt iespēju.",
        "Pogosto značilno: bolj formalno.",
      ...
      "tip": [
        "Ponudite priložnosti, tečaje, storitve ali ugodnosti, ki jih ponuja lokacija ali program.",
        "Uporabite peso, kadar kontekst ustreza temu pomenu."
      ],
      "important": [
        "bieten: Die Schule bietet Kurse. (nesadalāms)",
        "Kaj kraj/program ponuja: Rdeča pesa."
      ],
      "sectionAccents": {
        "explanation": {
          "blue": [
  ...
  },
  {
    ...
    "study": {
      ...
      "tip": [
        "Zahtevajte denar, pravice, spremembe ali obveznosti - aktivna terjatev.",
        "Uporablja fordern, kadar kontekst ustreza temu pomenu."
      ],
      "important": [
        "fordern = pieprasīt / prasīt (bez ö).",
        "Zahteva, zahteva: fordern (brez ö).",
        "Zahtevajte denar, pravice, spremembe ali obveznosti - aktivna terjatev."
      ],
      "sectionAccents": {
        "explanation": {
  ...
  },
  {
    ...
    "study": {
      ...
      "explanation": [
        ...
        "Pogosto je značilno: podpora / napredek.",
        "fördern galvenokārt nozīmē: iegūt derīgos izrakteņus.",
        "Pogosto značilno za: v industriji.",
        "fördern galvenokārt nozīmē: attīstīt talantu.",
        "Pogosto značilno: v izobraževanju.",
      ...
      "tip": [
        ...
        "Uporabite förden, kadar kontekst ustreza temu pomenu."
      ],
      "important": [
        "fördern = veicināt / atbalstīt (ar ö).",
        "Napredovanje, podpora: förden (z ö).",
        "Veicināt attīstību, atbalstīt cilvēku, projektu vai procesu."
      ],
      "sectionAccents": {
        "explanation": {
