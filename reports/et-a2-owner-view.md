...
| OWNER README | [et-a2-owner-review-README.md](https://github.com/sandrisbrikmanis-rgb/de-lv-app/blob/cursor/et-de-a2-sectionaccents-audit-v18-4a7c/reports/et-a2-owner-review-README.md) |
| OWNER DECISIONS (indekss) | [et-a2-owner-decisions.md](https://github.com/sandrisbrikmanis-rgb/de-lv-app/blob/cursor/et-de-a2-sectionaccents-audit-v18-4a7c/reports/et-a2-owner-decisions.md) |
...
| 201–225 | 25 | [et-a2-owner-view-group05.md](https://github.com/sandrisbrikmanis-rgb/de-lv-app/blob/cursor/et-de-a2-sectionaccents-audit-v18-4a7c/reports/et-a2-owner-view-group05.md) | [et-a2-owner-decisions-group05.md](https://github.com/sandrisbrikmanis-rgb/de-lv-app/blob/cursor/et-de-a2-sectionaccents-audit-v18-4a7c/reports/et-a2-owner-decisions-group05.md) |
## Īsais saraksts
Kopā **225** findingi — pilns saturs tikai grupu VIEW failos (5 × ~50).
- **ET-A2-0002** `a2-abfahren` · HIGH
- **ET-A2-0003** `a2-abgeben` · HIGH
- **ET-A2-0004** `a2-abgeben` · HIGH
- **ET-A2-0005** `a2-absagen` · HIGH
- **ET-A2-0006** `a2-absagen` · HIGH
- **ET-A2-0007** `a2-abschließen` · HIGH
- **ET-A2-0008** `a2-abstellen` · HIGH
- **ET-A2-0009** `a2-abstellen` · HIGH
- **ET-A2-0010** `a2-angewandt` · HIGH
- **ET-A2-0011** `a2-angreifen` · HIGH
- … un vēl **215** (skatīt grupas)