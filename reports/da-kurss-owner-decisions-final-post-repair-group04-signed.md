...
**OWNER_DECISION:** reinigen — at rense
...
**OWNER_DECISION:** machen — at gøre / lave
...
**OWNER_DECISION:** halten — at holde
...
**OWNER_DECISION:** Hvis præfikset er ubetonet, adskilles det ikke.
...
**OWNER_DECISION:** Feminine navneord dannet med -in får -nen i flertal.
...
**OWNER_DECISION:** I ordet Kopf udtales pf, så begge konsonanter kan høres.
...
**OWNER_DECISION:** Han laver gymnastik.
...
**OWNER_DECISION:** Hvordan laver de gymnastik?
...
**OWNER_DECISION:** De strækker begge arme ud.
...
**OWNER_DECISION:** Peter og Anna trækker vejret dybt.
...
**OWNER_DECISION:** Nej, Robert og Jan laver ikke gymnastik.
...
**OWNER_DECISION:** ß skrives i midten eller slutningen af et ord efter en lang vokal eller en diftong: die Füße, die Straße, ich muss, er muss.
...
**OWNER_DECISION:** Hvis andre former har ss, kan ß stå før endelsen: müssen, ich muss, du musst, ihr müsst.
...
**OWNER_DECISION:** Når g efterfølges af t, lyder g tættere på k: du magst, ihr mögt.
...
**OWNER_DECISION:** Tilsvarende lyder g før s i det lettiske ord “smags” tættere på k.
...
**OWNER_DECISION:** Du skal skrive brevet.
...
**OWNER_DECISION:** Jeg vil ikke spise suppen, for jeg kan ikke lide den.
...
**OWNER_DECISION:** die Äpfel — æbler
...
**OWNER_DECISION:** die Pflaume — blomme
...
**OWNER_DECISION:** die Pflaumen — blommer
...
**OWNER_DECISION:** die Kirschen — kirsebær
...
**OWNER_DECISION:** müssen — at være nødt til på grund af nødvendighed eller overbevisning
...
**OWNER_DECISION:** I ordet Äpfel udtales ä kort, fordi der følger to konsonanter efter vokalen.
...
**OWNER_DECISION:** I ordet schälen udtales ä langt, fordi der følger én konsonant efter vokalen.
...
**OWNER_DECISION:** Husk: diftongen ei udtales som ai: reif, unreif.
...
**OWNER_STATUS:** NELABOT

**OWNER_DECISION:** Franz er rask, han må arbejde.
...
**OWNER_DECISION:** Spiser du et æble eller en pære?
...
**OWNER_DECISION:** Pæren smager meget godt.
...
**OWNER_STATUS:** NEEDS_SOURCE_REVIEW

**OWNER_DECISION:** DA-feltet kan lokaliseres til `I ordene wem, dem, den, der udtales e langt og smalt.`, men DE_CURRENT indeholder selv lettisk tekst (`Vārdos ...`). DE = STRICT READ-ONLY, tāpēc DE avots jāizskata atsevišķi.
...
**OWNER_DECISION:** Han kalder på sin søn og datter.
...
**OWNER_DECISION:** Hunden er trofast.
...
**OWNER_DECISION:** Hvem nærmer sig eleverne?
...
**OWNER_DECISION:** Læreren nærmer sig eleverne.
...
**OWNER_DECISION:** Det tyske spørgsmål om med hvem/med hvad udtrykkes på to måder: mit wem? — om personer, womit? — om ting.
...
**OWNER_DECISION:** Hvad klipper han papiret over med?
...
**OWNER_DECISION:** Hvad holder du spaden med?
...
**OWNER_DECISION:** Jeg holder spaden med hånden.
...
**OWNER_DECISION:** Med hvem går broren?
...
**OWNER_DECISION:** Broren går med sin far, med sin mor, med sin lærer, med sin onkel, med sin tante, med sin fætter og med sin kusine.
...
**OWNER_DECISION:** Wohin / wo, Akkusativ eller Dativ med an / in / auf
...
**OWNER_DECISION:** Hvis handlingen angiver en retnings- eller stedsændring, bruges Akkusativ. Spørgsmål: wohin? — hvorhen?
...
**OWNER_DECISION:** Manden stiller bænken hen til vinduet.
...
**OWNER_DECISION:** Børnene går ind i skoven.
...
**OWNER_DECISION:** De leder efter bær i skoven.
