...
## NEEDS_SOURCE_REVIEW — 9 objekti

| # | Objekts | Finding ID |
|---|---------|------------|
| 1 | `COURSE_LESSON_DATA.kurssLesson1.legacyHtml` | DA-KURSS-0001 |
| 2 | `COURSE_LESSON_DATA.kurssLesson2.legacyHtml` | DA-KURSS-0002 |
| 3 | `COURSE_LESSON_DATA.kurssLesson3.legacyHtml` | DA-KURSS-0003 |
| 4 | `COURSE_LESSON_DATA.kurssLesson4.legacyHtml` | DA-KURSS-0004 |
| 5 | `COURSE_LESSON_DATA.kurssLesson5.legacyHtml` | DA-KURSS-0005 |
| 6 | `COURSE_LESSON_DATA.kurssLesson6.legacyHtml` | DA-KURSS-0006 |
| 7 | `COURSE_LESSON_DATA.kurssLesson7.legacyHtml` | DA-KURSS-0007 |
| 8 | `COURSE_LESSON_HTML.kurssPronunciationLesson` | DA-KURSS-0009 |
| 9 | `COURSE_LESSON_HTML.kurssConsonantsLesson` | DA-KURSS-0010 |

## Saistītie faili (95 findingu posms)
...
**DE changes:** 0 · **Production changes (šis posms):** 0
