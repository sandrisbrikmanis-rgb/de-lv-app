...
|---|---|---|---|---|---|---|
| ET-B2-0001 | STRUCT | study.count | 64 | LABOT | Remove `study` only from `b2-genosse`, `b2-genossin`, `b2-neger`, `b2-pacht`; final ET Study count = 60 | The 64→60 mismatch is a real structural finding, not a false positive. Exact TRUE_EXTRA_STUDY objects are known. |
| ET-B2-0002 | b2-hochwasser | entry[1145].study.comparison[0].example | Es gibt Hochwasser. = Ir plūdi. | LABOT | Es gibt Hochwasser. = On üleujutus. | Corrects the generated erroneous `On on üleujutused.` |
| ET-B2-0003 | b2-hochwasser | entry[1145].study.comparison[1].example | Die Überschwemmung zerstörte Häuser. = Plūdi izpostīja mājas. | LABOT | Die Überschwemmung zerstörte Häuser. = Üleujutus hävitas maju. | Match singular German subject naturally in ET. |
...
| ET-B2-0022 | b2-angeblich-28 | lv | justkui • näiliselt | LABOT | väidetavalt • väidetav | `angeblich` = alleged/allegedly; `oletatav` is less exact here. |
| ET-B2-0023 | b2-abbringen-36 | lv | ümber veenma • hoiatama • kõrvale juhtima | LABOT | ümber veenma • millestki loobuma panema • kõrvale juhtima | `abbringen` is dissuade/divert, not generic `ära hoidma`. |
...
| ET-B2-0035 | b2-Äußerlichkeit-103 | lv | väline sära | LABOT | välised tunnused • pealiskaudsus | More natural ET than `välisus`. |
...
| ET-B2-0043 | b2-ausweisen-117 | lv | välja saatma • välja saatma • kinnitama • tõestama | LABOT | välja saatma • isikut tõendama • kinnitama • tõestama | `ausweisen` includes expel and identify/prove; `välja tõrjuma` was not the correct second sense. |
...
| ET-B2-0050 | b2-beispiellos-163 | lv | enneolematu • nähtamatu • võrreldamatu | LABOT | enneolematu • võrreldamatu | Remove duplicated `enneolematu`. |
...
| ET-B2-0052 | b2-Straßenbelag-174 | lv | tänavakate | FALSE_POSITIVE |  | `tänavakate` is already a correct natural ET equivalent of `Straßenbelag`; no repair required. |
...
| ET-B2-0061 | b2-bestürzt-218 | lv | üllatunud • segaduses • hämmingus | LABOT | vapustatud • kohkunud | `bestürzt` is stronger than simple surprise/confusion. |
...
| ET-B2-0065 | b2-Beute-227 | lv | saak • võit • trofee | LABOT | saak • röövsaak | `saagis` is crop/yield and is not the correct `Beute` sense. |
...
| ET-B2-0070 | b2-Bodensatz-280 | lv | sete • pärme | LABOT | sete • pärmisete | More precise than bare `pärm` for sediment/dregs context. |
...
| ET-B2-0077 | b2-bürgerlich-321 | lv | kodanlik • kodanike • kodanlik | LABOT | kodanlik • kodaniku- | Remove duplicate and keep valid adjective/compound stem. |
...
| ET-B2-0080 | b2-Dealer-361 | lv | nartkootikumide illegaalne müüja | LABOT | narkodiiler | Natural concise ET lexical equivalent. |
...
| ET-B2-0093 | b2-durchbringen-471 | lv | läbi viima • välja kannatama • saavutama • välja ravima • raiskama | LABOT | läbi aitama • läbi viima • ülal pidama • raiskama | Better coverage of `durchbringen`; remove inaccurate `saavutama` / `välja ravima` chain. |
...
| ET-B2-0099 | b2-Eheschließung-504 | lv | abielu • laulumine | LABOT | abiellumine • abielu sõlmimine | Avoid narrowing to religious `laulatamine`. |
| ET-B2-0100 | b2-ehren-505 | lv | austama • lugu pidama • auhindama | LABOT | austama • lugu pidama | `au sees hoidma` is unnecessary as a third main gloss. |
...
| ET-B2-0130 | b2-Erlass-683 | lv | korraldus • käsk • dekreet • vallandamine | LABOT | määrus • korraldus • dekreet • võlast vabastamine | `Erlass` includes decree/order and remission. |
...
| ET-B2-0143 | b2-Fetzen-786 | lv | räbalad | LABOT | räbal • riba | Keep dictionary headword forms singular. |
...
| ET-B2-0147 | b2-freilich-831 | lv | muidugi • kahtlemata • aga • ainult | LABOT | muidugi • tõsi küll | Natural core senses of `freilich`; avoid overloading with generic `aga`. |
...
| ET-B2-0152 | b2-Führernatur-847 | lv | liidritüüp • liider | LABOT | juhiloomus • juhivõimed | Natural ET for `Führernatur`. |
...
| ET-B2-0158 | b2-Gasableser-870 | lv | gaasiarvesti | LABOT | gaasiarvesti näidu lugeja | `Gasableser` is the person who reads the gas meter. |
| ET-B2-0159 | b2-gebrechlich-877 | lv | nõrk • kidur • vilets • vigane • vigadega | LABOT | põdur • nõrk | Natural concise ET for `gebrechlich`. |
...
| ET-B2-0163 | b2-Gefallen-885 | lv | meeldivus | LABOT | teene • heameel | `Gefallen` includes favour/pleasure; generated mapping omitted the central `teene` sense. |
...
| ET-B2-0165 | b2-gelaunt-903 | lv | meeleolu | LABOT | tujus | Natural adjective-like equivalent for `gelaunt`. |
| ET-B2-0166 | b2-Geliebte-910 | lv | kallis • armastatud • lemmik | LABOT | armastatu • kallim | Natural noun equivalents. |
| ET-B2-0167 | b2-Gemisch-918 | lv | segu • segamini • kokteil | LABOT | segu • kokteil | `segum` is unnecessary/nonstandard here. |
...
| ET-B2-0170 | b2-Geratewohl-936 | lv | hea õnn | LABOT | huupi • hea õnne peale | Correct idiomatic meaning of `aufs Geratewohl`. |
...
| ET-B2-0175 | b2-Gesinnung-958 | lv | vaated • meeleolu | LABOT | hoiak • veendumused | `Gesinnung` = attitude/convictions, not mood. |
...
| ET-B2-0183 | b2-Glatze-995 | lv | paljas peanahk | LABOT | kiilaspea • kiilaspäisus | Better lexical coverage of `Glatze`. |
...
| ET-B2-0190 | b2-Grußwort-1041 | lv | lühike ametlik kõne | LABOT | tervitussõnad • tervituskõne | `Grußwort` can be greeting words/address; more exact than only speech. |
...
| ET-B2-0193 | b2-Güte-1048 | lv | heasüdamlikkus • kvaliteet • kasu | LABOT | headus • kvaliteet | `Güte` = goodness/quality; use natural noun `headus`. |
...
| ET-B2-0204 | b2-Hinsicht-1121 | lv | teade | LABOT | aspekt • suhe | `Hinsicht` = respect/aspect; `seisukoht` is not the core lexical equivalent. |
...
| ET-B2-0207 | b2-hitzig-1131 | lv | kuum • õhin • järsk • kiiresti vihastuv | LABOT | tuline • äge • kiiresti vihastuv | Remove literal/general `kuum` from the main gloss chain. |
| ET-B2-0208 | b2-hochwertig-1146 | lv | kõrgväärtuslik | LABOT | kvaliteetne • kõrgekvaliteediline | More exact for `hochwertig`. |
...
| ET-B2-0254 | b2-Sandbank-1548 | lv | madalik | LABOT | liivamadal | Exact `Sandbank` meaning. |
...
| ET-B2-0278 | b2-Strafanzeige-1705 | lv | kriminaalasja algatamine kellegi vastu | LABOT | kuriteoteade • avaldus politseile | `Strafanzeige` is a criminal complaint/report, not the opening of a case itself. |
| ET-B2-0279 | b2-streitbar-1708 | lv | tülinorija | LABOT | võitluslik • vaidlushimuline | Generated `tülivõimeline` is unnatural ET. |
...
| ET-B2-0291 | b2-umhören, sich-1791 | lv | kuulatlema | LABOT | ringi küsima • maad kuulama | Natural ET for `sich umhören`; avoid `ringi küsitlema`. |
| ET-B2-0292 | b2-umschließen-1797 | lv | sisse lülitama • hõlmama • ümbritsema | LABOT | sisse piirama • hõlmama • ümbritsema | Natural transitive senses of `umschließen`. |
| ET-B2-0293 | b2-umschreiben-1798 | lv | kirjeldama | LABOT | ümber sõnastama • kirjeldama | Preserve both principal senses of `umschreiben`. |
...
| ET-B2-0304 | b2-Vermächtnis-1906 | lv | testament | LABOT | pärand • annak | `Vermächtnis` = legacy/bequest, not the testament document. |
| ET-B2-0305 | b2-Vermögen-1908 | lv | omand | LABOT | vara • võime | `Vermögen` covers wealth/property and ability/capacity. |
...
| ET-B2-0317 | b2-vollkommen-1980 | lv | täielik • täielikult • hoopis | LABOT | täielik • täiesti | Remove mixed/duplicative adverb chain. |
| ET-B2-0318 | b2-vollzählig-1982 | lv | täisarvuline | LABOT | täies koosseisus | Natural ET for `vollzählig`. |
...
| ET-B2-0340 | b2-haube | study.examples[2].lv | ta avab auto mootorikapoti. | LABOT | Ta avab auto kapoti. | Sentence capitalization + natural wording. |
| ET-B2-0341 | b2-haube | study.examples[3].lv | mootorikapott on katki. | LABOT | Auto kapott on katki. | Sentence capitalization + natural wording. |
| ET-B2-0342 | b2-haube | study.examples[5].lv | pane kaas pajale kattena. | LABOT | Pane pajale kaas. | Sentence capitalization + natural wording. |
...
| ET-B2-0344 | b2-sich-herausstellen | study.translation | selguma milleks | LABOT | osutuma millekski • selguma | Preserve both common senses of `sich herausstellen`. |
...
| ET-B2-0352 | b2-zuwider | study.examples[2].lv | see ei meeldi mulle / see kurvastab mind. | LABOT | See ei meeldi mulle. | Sentence capitalization. |
