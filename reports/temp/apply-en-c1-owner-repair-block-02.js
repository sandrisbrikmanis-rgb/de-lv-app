...
const REPAIRS = path.join(__dirname, "en-c1-owner-repair-block-02-repairs.json");
...
const LOG = path.join(__dirname, "en-c1-owner-repair-block-02-apply-log.json");
...
function main() {
  ...
  const out = {
    ...
    deReadOnly: deHashBefore === deHashAfter && deWwwBefore === deWwwAfter,
    referenceFilesUnchanged: deHashBefore === deHashAfter && deWwwBefore === deWwwAfter,
    syntaxPass,
    results: log.results,
