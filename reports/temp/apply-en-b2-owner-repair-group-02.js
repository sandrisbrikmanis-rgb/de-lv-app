#!/usr/bin/env node
/**
 * Apply EN-DE B2 OWNER-approved repairs Group 2 (items 051-100).
 * Usage: node reports/temp/apply-en-b2-owner-repair-group-02.js [--dry-run]
 */
const fs = require("fs");
...
const REPAIRS_JSON = path.join(__dirname, "en-b2-owner-repair-group-02-repairs.json");
