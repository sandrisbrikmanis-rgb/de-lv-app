#!/usr/bin/env node
/**
 * Apply EN-DE B2 OWNER-decided Group 7 (items 451-470): 48 APPLY + 2 KEEP.
 * Usage: node reports/temp/apply-en-b2-owner-repair-group-10.js [--dry-run]
 */
const fs = require("fs");
...
const REPAIRS_JSON = path.join(__dirname, "en-b2-owner-repair-group-10-repairs.json");
