...
**Generated:** 2026-09-13T18:48:28.635Z
**Source commit:** `e3fbba943700eb892628ed0e38cacba7c5e7c27b`
**Branch:** `cursor/lrb-081-owner-authorization-ed35`
**Overrides SHA256:** `b2c2ba942eeb66671d1b72c43e7b14ddd1615638325377309df9dee1088600f7`
...
```json
{
  ...
  "study": {
    ...
    "important": [
      ...
      "Baden pune accentul mai degrabă pe faptul de a sta sau de a se recrea în apă, iar schwimmen pe mișcarea de înot."
    ]
  },
  "index": 68
}
...
```json
{
  ...
  "study": {
    ...
    "translation": "vizită",
    "explanation": [
      "Ideea principală: der Besuch înseamnă o vizită sau vizitarea unei persoane ori a unui loc; pentru un eveniment poate desemna participarea la acesta.",
      "Pentru un loc, der Besuch desemnează vizitarea lui; pentru un eveniment, participarea la acesta.",
    ...
    "important": [
      "Der Besuch înseamnă „vizită” și poate desemna vizitarea unei persoane ori a unui loc sau participarea la un eveniment.",
      "Pluralul este die Besuche."
    ]
  },
  "index": 87
...
```json
{
  ...
  "study": {
    ...
    "explanation": [
      "Ideea principală: besuchen înseamnă de obicei «a vizita»; cu un curs sau un eveniment poate însemna «a frecventa» ori «a participa la».",
      "Cu un loc sau o persoană, besuchen se traduce de obicei prin «a vizita».",
      "Cu un curs sau un eveniment, româna cere adesea «a frecventa» sau «a participa la».",
    ...
    "important": [
      ...
      "Traducerea românească depinde de obiect: a vizita o persoană sau un loc, a frecventa un curs, a participa la un eveniment."
    ]
  },
  "index": 89
}
...
```json
{
  ...
  "study": {
    ...
    "important": [
      "În germană, Ich habe înseamnă «eu am» și este urmat adesea de un complement în acuzativ.",
