...
```json
{
  ...
  "study": {
    "id": "a1-liegen",
    "layout": "standardStudy",
    "translation": "лежати • знаходитися",
    "explanation": [
...
```json
{
  ...
  "study": {
    "id": "a1-probieren",
    "layout": "standardStudy",
    "translation": "пробувати • куштувати",
    "explanation": [
...
```json
{
  ...
  "study": {
    ...
    "layout": "standardStudy",
    "translation": "рис",
    "explanation": "У німецькій мові der Reis є незлічуваним іменником в однині, тому присудок також стоїть в однині: Der Reis ist fertig, а не sind. Українське слово «рис» так само зазвичай уживають в однині.",
    "examples": [
      {
