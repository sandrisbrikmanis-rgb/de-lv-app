...
**PROPOSED_ET (audit ieteikums):** mitte an, vaid auf: horisontaalsel pinnal
...
**PROPOSED_ET (audit ieteikums):** Ma soovin teile ka ilusat päeva.
...
**PROPOSED_ET (audit ieteikums):** vertikaalsel pinnal
...
**PROPOSED_ET (audit ieteikums):** peale / -le (Akk.)
...
**PROPOSED_ET (audit ieteikums):** Mine kiiresti paati!
...
**PROPOSED_ET (audit ieteikums):** kellegi juures ollakse; juurde minnakse: zu
