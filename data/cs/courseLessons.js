const COURSE_LESSON_HTML = {
  ...
  "kurssPronunciationLesson": "\n            <h3>Samohlásky - dlouhé a krátké</h3>\n            <p class=\"kurss-lesson-intro\">V němčině mohou být samohlásky dlouhé nebo krátké. To má vliv na výslovnost slova.</p>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Dlouhá samohláska</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Teplý (varm) — teplý</div><div class=\"kurss-example\">Střevo (dostat) — dobrý</div><div class=\"kurss-example\">Tat (tat) - práce / akce</div><div class=\"kurss-example\">Flur (flūr) - chodba</div><div class=\"kurss-example\">Weg (weg) - silnice</div><div class=\"kurss-example\">Hut (hūt) - klobouk</div><div class=\"kurss-example\">Hof (hōf) - dvůr</div><div class=\"kurss-example\">Schlaf - spánek</div></div>\n              <p>Pokud za samohláskou následuje jedna souhláska, samohláska se často vyslovuje dlouze.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Krátká samohláska</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Pilz (pilc) - houba</div><div class=\"kurss-example\">Wort (vort) - slovo</div><div class=\"kurss-example\">Mund (munt) - ústa</div><div class=\"kurss-example\">Lysý (bílý) - brzy</div><div class=\"kurss-example\">Scharf (шарф) - ostrý</div><div class=\"kurss-example\">Feld (plsť) — pole</div><div class=\"kurss-example\">Voll (fol) - plný</div></div>\n              <p>Když za samohláskou následují dvě nebo více souhlásek, samohláska se často vyslovuje krátce.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Koncovky en / el / er</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Singen (zingen) - zpívat</div><div class=\"kurss-example\">Tragen (trägen) — nést</div><div class=\"kurss-example\">Garten (garten) - zahrada</div><div class=\"kurss-example\">Vogel (fogel) - pták</div><div class=\"kurss-example\">Segel - plachta</div><div class=\"kurss-example\">Braten (bratr) - pečeně</div><div class=\"kurss-example\">Bogen (bōgen) - luk</div><div class=\"kurss-example\">Spiegel (spiegel) - zrcadlo</div><div class=\"kurss-example\">Finger (prst) - prst</div><div class=\"kurss-example\">Halter (ohlávka) - držák</div><div class=\"kurss-example\">Arbeiter (arbaiter) - dělník</div><div class=\"kurss-example\">Häuser (hoizer) - domy</div><div class=\"kurss-example\">Wieder - znovu</div><div class=\"kurss-example\">Breiter (braiter) - širší</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Písmeno h jako zeměpisná délka</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Rahmen (rämen) - rám</div><div class=\"kurss-example\">Ohr (ōr) — ucho</div><div class=\"kurss-example\">Kohle (kōle) - uhlí</div><div class=\"kurss-example\">Zahl (kuře) - číslo</div><div class=\"kurss-example\">Ihn (īn) - jeho</div><div class=\"kurss-example\">Ihm (īm) — jemu</div><div class=\"kurss-example\">Huhn (hūn) - kuře</div><div class=\"kurss-example\">Nahm (nām) — vzal</div><div class=\"kurss-example\">Nehmen (nēmen) — vzít</div><div class=\"kurss-example\">Schuh - bota</div></div>\n              <p>V některých slovech h prodlužuje předchozí samohlásku. V takových případech je h obvykle nevyslovováno.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Koncovky na e</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Lampe (lampa) - lampa</div><div class=\"kurss-example\">Hase (opar) - zajíc</div><div class=\"kurss-example\">Knabe (zobák) - chlapec</div><div class=\"kurss-example\">Rabe - havran</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Dlouhé i = tzn</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Zemřít (dī) - článek \"zemřít\"</div><div class=\"kurss-example\">Diese - toto / tyto</div><div class=\"kurss-example\">Wieder - znovu</div><div class=\"kurss-example\">Fliege (fliege) - moucha</div><div class=\"kurss-example\">Ziege (tsīge) - koza</div><div class=\"kurss-example\">Stiel (stīl) - kmen</div><div class=\"kurss-example\">Dieb (दीप) - zloděj</div><div class=\"kurss-example\">Hier (hīr) — zde</div></div>\n              <p>Dlouhé i se v němčině často píše jako ie.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Dvojhlásky</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Saal (tráva) - sál</div><div class=\"kurss-example\">Saat (zeť) - setí</div><div class=\"kurss-example\">Staat (stát) - země</div><div class=\"kurss-example\">Pivo (pohřební) - bobule</div><div class=\"kurss-example\">Viz (zee) - jezero / moře</div><div class=\"kurss-example\">Řepa (бет) - postel</div><div class=\"kurss-example\">Boot (bōt) - člun</div><div class=\"kurss-example\">Moor (mōr) - bažina</div><div class=\"kurss-example\">Moos (mōs) - mech</div></div>\n              <p>Dvojhlásky se obvykle vyslovují dlouze.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>ä</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Hůlka (vant) — stěna</div><div class=\"kurss-example\">Wände (vende) - stěny</div><div class=\"kurss-example\">Vater (otec) - otec</div><div class=\"kurss-example\">Väter (fēter) - otcové</div><div class=\"kurss-example\">Schrank (shrank) - skříň</div><div class=\"kurss-example\">Schränke (schrenke) - skříně</div><div class=\"kurss-example\">Bank (bank) - lavička / banka</div><div class=\"kurss-example\">Bänke (benke) - krok</div><div class=\"kurss-example\">Tal (daleko) - údolí</div><div class=\"kurss-example\">Täler (tēler) - údolí</div></div>\n              <p>Ä je transpozice a.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>ö</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Rose (rōze) - růže</div><div class=\"kurss-example\">Röschen (rēschen) - rozeta</div><div class=\"kurss-example\">Ofen (ōfen) - trouba</div><div class=\"kurss-example\">Öfen (öfen) - pece</div><div class=\"kurss-example\">Rock (rok) - sukně</div><div class=\"kurss-example\">Röcke (röke) - sukně</div></div>\n              <p>Ö je ladění o.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>ü</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Kurz (kurc) — krátký</div><div class=\"kurss-example\">Kürzer (kurcer) - kratší</div><div class=\"kurss-example\">Kunst (kunst) — umění</div><div class=\"kurss-example\">Künste (künste) — umění</div><div class=\"kurss-example\">Mutter (muter) - matka</div><div class=\"kurss-example\">Mütter (mumlat) - matky</div></div>\n              <p>Ü je transpozice u.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Dvojhlásky: äu</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Baum (baum) - strom</div><div class=\"kurss-example\">Bäume (boime) - stromy</div><div class=\"kurss-example\">Haus (haus) — dům</div><div class=\"kurss-example\">Häuser (hoizer) - domy</div><div class=\"kurss-example\">Strauch (štrauh) - keř</div><div class=\"kurss-example\">Sträucher (štroiher) - keře</div><div class=\"kurss-example\">Maus (maus) - myš</div><div class=\"kurss-example\">Mäuse (moise) - myši</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Dvojhlásky: eu</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Heute (hoite) - dnes</div><div class=\"kurss-example\">Leute (loite) – lidé</div><div class=\"kurss-example\">Neu (noi) - nový</div><div class=\"kurss-example\">Neun (noin) - devět</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Dvojhlásky: Ahoj</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Mein (hlavní) - můj</div><div class=\"kurss-example\">Dein (dain) — tvůj</div><div class=\"kurss-example\">Sein (zain) - ona / její / být</div><div class=\"kurss-example\">Frei (frai) - zdarma</div><div class=\"kurss-example\">Arbeiten (arbaiten) - pracovat</div></div>\n            </section>\n            <section class=\"kurss-lesson-section\">\n              <h4>Přednáška 2 poznámky výslovnosti</h4>\n              <ul class=\"kurss-summary-list\"><li>Ve slovech ich, nicht, rechnen, zeichnen se „ch“ vyslovuje měkce</li><li>V arbeiten a zeichnen se „ei“ vyslovuje jako „ai“</li><li>\"sp\" na začátku slova se vyslovuje jako \"šp\"</li><li>Ve slovesu tun se písmeno „u“ vyslovuje dlouze</li></ul>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Shrnutí</h4>\n              <ul class=\"kurss-summary-list\"><li>Jedna souhláska po samohlásce → často dlouhá samohláska</li><li>Dvě a více souhlásek → často krátká samohláska</li><li>H může prodloužit samohlásku</li><li>Tj. často stojí dlouho i</li><li>Dvojhlásky jsou obvykle dlouhé</li></ul>\n            </section>",
  "kurssConsonantsLesson": "\n            <h3>Souhlásky a kombinace písmen</h3>\n            <p class=\"kurss-lesson-intro\">V němčině se některé souhlásky a kombinace písmen vyslovují jinak, než se píší. Tato přednáška obsahuje nejdůležitější příklady pro začátečníky.</p>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Souhlásky</h4>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Das Rad (rāt) — kolo</div><div class=\"kurss-example\">Die Räder (räder) - kola</div><div class=\"kurss-example\">Bad (बाट) - koupel</div><div class=\"kurss-example\">Bäder (bäder) - koupele</div></div>\n              <p>Souhlásky na konci slova se často nevyslovují tak, jak jsou napsány.</p>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Ch</h4>\n              <p>\"ch\" může být vyslovováno měkké nebo tvrdé. V některých slovech to zní jako \"h\", v jiných blíže k \"k\".</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Rechnen (rehnen) - vypočítat</div><div class=\"kurss-example\">Zeichnen (caihnen) - kreslit</div><div class=\"kurss-example\">Nicht (niht) - ne</div><div class=\"kurss-example\">Schlecht (šleht) - špatný</div><div class=\"kurss-example\">Mich (mih) - já</div><div class=\"kurss-example\">Dich (dih) - ty</div><div class=\"kurss-example\">Strauch (štrauh) - keř</div><div class=\"kurss-example\">Noch (noh) - ještě</div><div class=\"kurss-example\">Nacht (naht) - noc</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Sch</h4>\n              <p>„sch“ se v němčině vyslovuje jako českýé „š“.</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Schule - škola</div><div class=\"kurss-example\">Schüler (schüler) - student</div><div class=\"kurss-example\">Schiff (šif) - loď</div><div class=\"kurss-example\">Schraube (šroub) - šroub</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Sp a st na začátku slova</h4>\n              <p>Na začátku slova nebo slabiky se „sp“ často vyslovuje jako „šp“ a „st“ jako „št“.</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Spielen (špīlen) - hrát si</div><div class=\"kurss-example\">Pružina - skok</div><div class=\"kurss-example\">Stehen (steen) - stát</div><div class=\"kurss-example\">Stáj (štal) - stodola</div><div class=\"kurss-example\">Stand (stant) - pozice / místo</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Qu</h4>\n              <p>„qu“ se v němčině obvykle vyslovuje jako „kv“.</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Qual (kvāl) - muka</div><div class=\"kurss-example\">Quartier (quartier) - čtvrť / ubytování</div><div class=\"kurss-example\">Quer (квер) — napříč</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>S a z</h4>\n              <p>\"S\" na začátku slova často zní jako \"z\". Písmeno „z“ v němčině zní jako českýé „c“.</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Sagen (zagen) — říci</div><div class=\"kurss-example\">Singen (zingen) - zpívat</div><div class=\"kurss-example\">Rose (rōze) - růže</div><div class=\"kurss-example\">Zahl (kuře) - číslo</div><div class=\"kurss-example\">Zeit (cait) - čas</div><div class=\"kurss-example\">Zink (cink) - zinek</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>v</h4>\n              <p>V němčině se „v“ často vyslovuje jako „f“. V cizích slovech to často zní jako českýé „v“.</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Vater (otec) - otec</div><div class=\"kurss-example\">Von (fon) — od</div><div class=\"kurss-example\">Viel (fīl) — hodně</div><div class=\"kurss-example\">Vier (fīr) — čtyři</div><div class=\"kurss-example\">Vila (vila) - vila</div><div class=\"kurss-example\">Klavier (klavír) - klavír</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>X a y</h4>\n              <p>\"x\" se vyslovuje jako \"ks\". \"y\" se v některých slovech vyslovuje jako \"ü\".</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Felix (Felix) - Felix</div><div class=\"kurss-example\">Axt (akst) - sekera</div><div class=\"kurss-example\">Mystik (mūstik) - mystika</div><div class=\"kurss-example\">Nyx - Nix</div><div class=\"kurss-example\">Mythe (ústa) - mýtus</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>ß</h4>\n              <p>„ß“ se v němčině vyslovuje jako „s“.</p>\n              <div class=\"kurss-examples\"><div class=\"kurss-example\">Fuß - noha</div><div class=\"kurss-example\">Füße (füse) - nohy</div><div class=\"kurss-example\">Grüße - pozdravy</div></div>\n            </section>\n\n            <section class=\"kurss-lesson-section\">\n              <h4>Shrnutí</h4>\n              <ul class=\"kurss-summary-list\"><li>Sch → š</li><li>Sp / st na začátku → šp / št</li><li>Qu → sq</li><li>Z → c</li><li>V často → f</li><li>X → ks</li><li>SS → s</li></ul>\n            </section>",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          "Český valodā atgriezeniskiem darbības vārdiem ir sava galotne un konjugācija. Vācu valodā sevišķas konjugācijas nav. Tos loka tāpat kā citus darbības vārdus, pievienojot atgriezenisko vietniekvārdu sich.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          {
            "heading": "Haben",
            "text": "Pomocné sloveso haben v němčině vyjadřuje pojem sounáležitosti. V češtiněě se často vyjadřuje pomocí: já mám, ty máš, on má atd. t. t."
          },
          {
          ...
          },
          {
            ...
            "text": "V češtiněě je osoba, které něco patří, v dativu a předmět v nominativu. V němčině je osoba v nominativu a posedlý předmět v akuzativu."
          },
          {
            "heading": "Piemēri",
            "examples": [
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          {
            "heading": "Svarīgi",
            "text": "V češtiněě často říkáme „musím se učit“, „musíš psát“, „musí přijít“. Němčina v takových větách často používá müssen.",
            "examples": [
              "Ich muss lernen.",
