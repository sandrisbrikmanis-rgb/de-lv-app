const C1_WORDS = [
  ...
  },
  {
    ...
    "study": {
      ...
      "explanation": [
        ...
        "Не мешајте со die Zusammenfassung - онаа со голема буква и статијата die - именка што означува само резиме (резултат, готов текст).",
  ...
  {
    "de": "beschlagnahmen",
    "lv": "Апсење • Конфискување • Експропријација",
    "level": "C1"
  },
  {
    "de": "beschuldigen",
  ...
  },
  {
    ...
    "study": {
      ...
      "important": [
        ...
        "Свесна намера да се изврши дејство во иднина. Не за врските, туку за плановите."
      ],
      "sectionAccents": {
        "explanation": {
          "green": [
