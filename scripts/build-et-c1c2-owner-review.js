...
const AUDIT_JSON = path.join(ROOT, "reports/temp/et-c1c2-full-audit.json");
const VALIDATION_JSON = path.join(ROOT, "reports/temp/et-c1c2-pr603-owner-history-validation.json");
const HISTORY_FILTER = process.argv.includes("--history-filtered") || process.env.OWNER_HISTORY_FILTER === "1";
const AUDIT_MD = "et-c1c2-full-audit.md";
...
const OUT = {
  view: path.join(ROOT, "reports/et-c1c2-owner-view.md"),
  decisions: path.join(ROOT, "reports/et-c1c2-owner-decisions.md"),
  github: path.join(ROOT, "reports/et-c1c2-owner-review-GITHUB.md"),
  readme: path.join(ROOT, "reports/et-c1c2-owner-review-README.md"),
};
...
function loadFindings() {
  if (!fs.existsSync(AUDIT_JSON)) {
    console.error(`Missing ${AUDIT_JSON}. Run: node scripts/run-et-c1c2-full-audit.js`);
    process.exit(1);
  }
  ...
  if (!fs.existsSync(VALIDATION_JSON)) {
    console.error(`Missing ${VALIDATION_JSON}. Run: node scripts/build-et-c1c2-pr603-owner-history-validation.js`);
    process.exit(1);
  }
  ...
  return filtered.map((f, i) => {
    ...
    const newId = `ET-C1C2-${String(i + 1).padStart(4, "0")}`;
    return {
      ...f,
      findingId: newId,
...
function buildView(findings) {
  cleanStaleGroupFiles("et-c1c2-owner-view");
  cleanStaleGroupFiles("et-c1c2-owner-decisions");
  const groups = [];
  ...
  groups.forEach((slice, gi) => {
    ...
    const viewName = `et-c1c2-owner-view-group${id}.md`;
    const decName = `et-c1c2-owner-decisions-group${id}.md`;
    ...
    const content = [
      ...
      "| Navigācija | Saite |",
      "|------------|-------|",
      `| GitHub indekss | [et-c1c2-owner-review-GITHUB.md](${gh("reports/et-c1c2-owner-review-GITHUB.md")}) |`,
      `| OWNER VIEW (visi) | [et-c1c2-owner-view.md](${gh("reports/et-c1c2-owner-view.md")}) |`,
      `| Decisions (šī grupa) | [${decName}](${gh(decRel)}) |`,
      `| Decisions (viss) | [et-c1c2-owner-decisions.md](${gh("reports/et-c1c2-owner-decisions.md")}) |`,
      "",
  ...
  const main = [
    ...
    "|-------|--------|",
    `| GitHub indekss | [et-c1c2-owner-review-GITHUB.md](${gh("reports/et-c1c2-owner-review-GITHUB.md")}) |`,
    `| OWNER README | [et-c1c2-owner-review-README.md](${gh("reports/et-c1c2-owner-review-README.md")}) |`,
    `| OWNER DECISIONS (indekss) | [et-c1c2-owner-decisions.md](${gh("reports/et-c1c2-owner-decisions.md")}) |`,
...
function buildDecisions(findings, groupFiles) {
  const header = [
    ...
    "|-------|--------|",
    `| GitHub indekss | [et-c1c2-owner-review-GITHUB.md](${gh("reports/et-c1c2-owner-review-GITHUB.md")}) |`,
    `| OWNER VIEW | [et-c1c2-owner-view.md](${gh("reports/et-c1c2-owner-view.md")}) |`,
    ...groupFiles.map(
...
function buildReadme(findings, groupFiles) {
  ...
  const content = [
    ...
    `**Audit PR:** [#${PR_NUMBER}](https://github.com/${REPO}/pull/${PR_NUMBER})`,
    "",
    `Avots: [${AUDIT_MD}](${gh(`reports/${AUDIT_MD}`)}) · [GitHub indekss](${gh("reports/et-c1c2-owner-review-GITHUB.md")})`,
    "",
    "## Kopsavilkums",
    "",
    "| Metrika | Skaitlis |",
    ...
    "| Tips | Fails | Apraksts |",
    "|------|-------|----------|",
    `| README | [et-c1c2-owner-review-README.md](${gh("reports/et-c1c2-owner-review-README.md")}) | Šis fails |`,
    `| Indekss | [et-c1c2-owner-review-GITHUB.md](${gh("reports/et-c1c2-owner-review-GITHUB.md")}) | Visas saites |`,
    `| VIEW | [et-c1c2-owner-view.md](${gh("reports/et-c1c2-owner-view.md")}) | Cilvēkam ērts pārskats |`,
    `| DECISIONS | [et-c1c2-owner-decisions.md](${gh("reports/et-c1c2-owner-decisions.md")}) | **Aizpildīt šeit** — PENDING |`,
    "",
    "## Grupas",
    "",
    ...
    "3. Konsolidē lēmumus `et-c1c2-owner-decisions.md` vai group failos.",
...
function buildGithub(findings, groupFiles, coverage, auditData) {
  ...
  const content = [
    ...
    "| Fails | Apraksts |",
    "|-------|----------|",
    `| [OWNER README](${gh("reports/et-c1c2-owner-review-README.md")}) | Workflow un kopsavilkums |`,
    ...
    "|------|-------|",
    `| OWNER VIEW | [et-c1c2-owner-view.md](${gh("reports/et-c1c2-owner-view.md")}) |`,
    `| OWNER DECISIONS (PENDING) | [et-c1c2-owner-decisions.md](${gh("reports/et-c1c2-owner-decisions.md")}) |`,
    `| Audit JSON | [et-c1c2-full-audit.json](${gh("reports/et-c1c2-full-audit.json")}) |`,
    ...
    "## OWNER workflow",
    "",
    `1. Atver grupu pārus no tabulas zemāk (piem. [VIEW 1–50](${gh("reports/et-c1c2-owner-view-group01.md")}) + [DECISIONS 1–50](${gh("reports/et-c1c2-owner-decisions-group01.md")})).`,
    "2. Katram finding — aizpildi OWNER STATUS un OWNER_DECISION (precīzs ET teksts LABOT gadījumā).",
    "3. Atgriez aizpildītu `et-c1c2-owner-decisions.md` COPY-ONLY remontam.",
    "",
    "**Production changes = 0 · DE changes = 0**",
    "",
  ].join("\n");
