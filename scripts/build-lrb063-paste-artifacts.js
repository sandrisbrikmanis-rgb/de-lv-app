...
const BATCH = "LRB-063";
const PASTE_PATH = process.argv[2] || path.join(ROOT, "scripts/data/g2-a1-owner-pending/LRB-063-decisions-COPY-PASTE.json");
const EXPECTED_PASTE_SHA = "b2b3983a62880ce5decac89ac6627db4b4e84828ac26cb7363f732f04a462e52";
...
function main() {
  ...
  const galaOut = {
    ...
    classification: "LRB_063_COPY_PASTE_COMPLETE_AWAITING_GALA_VERDICT",
    cards: galaCards,
  };
