...
function main() {
  ...
  if (copyPaste.cards_161_180_gala_pass?.classification !== PASS_CLASSIFICATION) {
  ...
  if (proof && proof.cards_161_180_payload_sha256 !== liveSha) {
    blockers.push("cards_161_180_payload_sha_mismatch");
  }
  ...
  const out = {
    ...
    cards_161_180_payload_sha256: liveSha,
