...
function progressPath(dataset) {
  if (isFinalClosureAuditOnMainA1(dataset)) {
    return finalClosureAuditOnMainPaths(dataset).progressFile;
  }
  if (isFinal702AuditOnMainA1(dataset)) {
    return final702AuditOnMainPaths(dataset).progressFile;
  }
  if (isFinalAuditOnMainA1(dataset)) {
    return finalAuditOnMainPaths(dataset).progressFile;
  }
