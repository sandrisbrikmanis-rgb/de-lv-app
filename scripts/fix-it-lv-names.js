...
["a1", "a2", "b1", "b2", "c1", "c2"].forEach((level) => {
  processJsFile(`data/it/${level}.js`);
});
processJsFile("data/it/sentences.js", "SENTENCE_ENTRIES");
processJsFile("data/it/verbs.js", "VERB_ENTRIES");
processJsFile("data/it/dialogueIdMap.js", "DIALOGUE_ID_MAP");
processJsFile("data/it/courseLessons.js");
