...
function main() {
  ...
  if (copyPaste.cards_041_060_gala_pass?.classification !== PASS_CLASSIFICATION) {
  ...
  if (proof && proof.cards_041_060_payload_sha256 !== liveSha) {
    blockers.push("cards_041_060_payload_sha_mismatch");
  }
