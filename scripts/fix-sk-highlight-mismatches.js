#!/usr/bin/env node
/**
 * Fixes sectionAccents "term does not appear in text" mismatches for SK
 * (data/sk/{level}.js), the same class of defect the ET-DE audit found via
