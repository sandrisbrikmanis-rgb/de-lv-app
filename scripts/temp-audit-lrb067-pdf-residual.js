...
const proof = {
  batch_id: BATCH,
  classification: pass
    ? "LRB_067_OWNER_PREP_READY_FOR_LINGUISTIC_REVIEW"
    : "LRB_067_OWNER_PREP_BLOCKED",
  pdf_reaudit: true,
  ...
  gates: {
    ...
    de_source_mismatches_across_10_full_composites: deSourceMismatchesAcrossFullComposites,
