#!/usr/bin/env node
/**
 * ET-DE A1 full audit collector (read-only). Writes reports/temp/et-a1-audit-data.json
 */
const fs = require("fs");
...
const OUT = path.join(ROOT, "reports", "temp", "et-a1-audit-data.json");
...
function main() {
  ...
  const data = {
    meta: {
      ...
      lvFile: "data/a1.js",
      etFile: "data/et/a1.js",
      wwwFile: "www/data/et/a1.js",
      lvCount: lv.length,
      etCount: et.length,
    },
  ...
  if (!data.layerIdentity.identical) {
    ...
    data.structural.issues.push({ severity: "critical", message: "data/et/a1.js and www/data/et/a1.js are not identical" });
  }
