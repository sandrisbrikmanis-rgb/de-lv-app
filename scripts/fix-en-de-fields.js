...
writeArrayFile(path.join(ROOT, "data/en/verbs.js"), "VERB_ENTRIES", csVerbs);
...
const csDlgCode = fs.readFileSync(path.join(ROOT, "data/en/dialogueIdMap.js"), "utf8");
