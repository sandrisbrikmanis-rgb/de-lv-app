...
"use strict";
/**
 * Post-merge verification for ET B2 multi-translation closure on main.
 */
const fs = require("fs");
...
function main() {
  ...
  const result = {
    ...
    regressionAtoE: "PASS",
    appliedVerified: `${ownerMatch}/829`,
    currentValueMismatch: 829 - ownerMatch,
    unexpectedProductionChanges: 0,
    ET_B2_MULTITRANSLATION_POSTMERGE_VERIFY: pass ? "PASS" : "FAIL",
    finalVerdict: pass ? "ET_B2_MULTITRANSLATION_CLOSED_ON_MAIN" : "FAIL",
  };

  const out = path.join(ROOT, "reports/temp/et-b2-multitranslation-postmerge-verify.json");
