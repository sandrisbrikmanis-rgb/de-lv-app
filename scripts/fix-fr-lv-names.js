...
["a1", "a2", "b1", "b2", "c1", "c2"].forEach((level) => {
  processJsFile(`data/fr/${level}.js`);
});
processJsFile("data/fr/sentences.js", "SENTENCE_ENTRIES");
processJsFile("data/fr/verbs.js", "VERB_ENTRIES");
processJsFile("data/fr/dialogueIdMap.js", "DIALOGUE_ID_MAP");
processJsFile("data/fr/courseLessons.js");
