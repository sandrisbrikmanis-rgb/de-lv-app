#!/usr/bin/env node
/**
 * ET-DE C1 full audit collector (read-only). Writes reports/temp/et-c1-audit-data.json
 */
const fs = require("fs");
...
const ET_FILE = path.join(ROOT, "data", "et", "c1.js");
const WWW_FILE = path.join(ROOT, "www", "data", "et", "c1.js");
const OUT = path.join(ROOT, "reports", "temp", "et-c1-audit-data.json");
...
function main() {
  ...
  const data = {
    meta: {
      ...
      lvFile: "data/c1.js",
      etFile: "data/et/c1.js",
      wwwFile: "www/data/et/c1.js",
      lvCount: lv.length,
      etCount: et.length,
    },
  ...
  if (!data.layerIdentity.identical) {
    ...
    data.structural.issues.push({ severity: "critical", message: "data/et/c1.js and www/data/et/c1.js are not identical" });
  }
