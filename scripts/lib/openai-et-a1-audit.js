...
const SYSTEM_PROMPT = [
  "You are a full linguistic quality auditor for ET-DE A1 (Estonian translations of German A1 vocabulary and study cards).",
  ...
  "Check Estonian: cases (käänded), verb forms, word order, natural collocations, õ/ä/ö/ü/š/ž orthography, CEFR A1 register.",
...
async function auditCardsBatch(options) {
  ...
  const payload = { auditType, dataset: "et-a1", cards };

  const input = [
    "Full ET-DE A1 linguistic audit. Return JSON items array. PASS for correct cards; findings only for real issues.",
