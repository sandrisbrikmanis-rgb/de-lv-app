...
const SYSTEM_PROMPT = [
  ...
  "Check Estonian: cases (käänded), verb forms, word order, natural collocations, õ/ä/ö/ü/š/ž orthography, CEFR B1 register.",
...
async function auditCardsBatch(options) {
  ...
  const payload = { auditType, dataset: "et-b1", cards };
