...
const SCOPE_REGISTRY = {
  ...
  "fr-a1": {
    scope: "fr-a1",
    builders: ["build-fr-a1-owner-review.js"],
    viewPath: "reports/fr-a1-owner-view.md",
    decisionsPath: "reports/fr-a1-owner-decisions.md",
    githubPath: "reports/fr-a1-owner-review-GITHUB.md",
    readmePath: "reports/fr-a1-owner-review-README.md",
    auditReportPath: "reports/fr-a1-full-audit.md",
    auditJsonPath: "reports/fr-a1-full-audit.json",
    viewHeadingRegex: /^## (FR-A1-\d+)/gm,
    decisionRowPrefix: "| FR-A1-",
    commitPaths: [
      "reports/fr-a1-owner-view.md",
      "reports/fr-a1-owner-decisions.md",
      "reports/fr-a1-owner-review-GITHUB.md",
      "reports/fr-a1-owner-review-README.md",
      "reports/fr-a1-owner-view-group*.md",
      "reports/fr-a1-owner-decisions-group*.md",
    ],
  },
  "kurss-full": {
    scope: "da-kurss",
