...
const SCOPE_REGISTRY = {
  ...
  "et-kurss-full": {
    scope: "et-kurss",
    builders: ["build-et-kurss-owner-review.js"],
    viewPath: "reports/et-kurss-owner-view.md",
    legacyViewPath: "reports/et-kurss-owner-review.md",
    decisionsPath: "reports/et-kurss-owner-decisions.md",
    githubPath: "reports/et-kurss-owner-review-GITHUB.md",
    readmePath: "reports/et-kurss-owner-review-README.md",
    auditReportPath: "reports/et-kurss-full-audit.md",
    auditJsonPath: "reports/temp/et-kurss-full-audit.json",
    viewHeadingRegex: /^## Finding (\d+) \(Kurss\)/gm,
    decisionRowRegex: /^\| (\d+) \|/,
    commitPaths: [
      "reports/et-kurss-owner-view.md",
      "reports/et-kurss-owner-review.md",
      "reports/et-kurss-owner-decisions.md",
      "reports/et-kurss-owner-accepted.md",
      "reports/et-kurss-owner-review-GITHUB.md",
      "reports/et-kurss-owner-review-README.md",
      "reports/et-kurss-owner-review-group*.md",
      "reports/et-kurss-owner-decisions-group*.md",
    ],
  },
  "kurss-full": {
    scope: "da-kurss",
