...
const TEMP_DIR = path.join(ROOT, "reports", "temp", "et-b2-full-audit-luna");
const LUNA_JSON = path.join(ROOT, "reports", "temp", "et-b2-linguistic-audit.json");
const PROGRESS_FILE = path.join(ROOT, "scripts", ".et-b2-luna-progress.json");

const NATIVE_KEYS = new Set(["lv", "translation", "text", "meaning", "title", "lead"]);

function loadArray(filePath, globalKey = "B2_WORDS") {
