...
const SYSTEM_PROMPT = [
  "You are a full linguistic quality auditor for ET-DE B2 (Estonian translations of German B2 vocabulary and study cards).",
  ...
  "Check Estonian: cases (käänded), verb forms, word order, natural collocations, õ/ä/ö/ü/š/ž orthography, CEFR B2 register.",
...
async function auditCardsBatch(options) {
  ...
  const payload = { auditType, dataset: "et-b2", cards };

  const input = [
    "Full ET-DE B2 linguistic audit. Return JSON items array. PASS for correct cards; findings only for real issues.",
