...
const TEMP_DIR = path.join(ROOT, "reports", "temp", "et-a1-full-audit-luna");
const LUNA_JSON = path.join(ROOT, "reports", "temp", "et-a1-linguistic-audit.json");
const PROGRESS_FILE = path.join(ROOT, "scripts", ".et-a1-luna-progress.json");
