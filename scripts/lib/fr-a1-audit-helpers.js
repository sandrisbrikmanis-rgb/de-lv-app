...
const TEMP_DIR = path.join(ROOT, "reports", "temp", "fr-a1-full-audit-luna");
const LUNA_JSON = path.join(ROOT, "reports", "temp", "fr-a1-linguistic-audit.json");
const PROGRESS_FILE = path.join(ROOT, "scripts", ".fr-a1-luna-progress.json");
