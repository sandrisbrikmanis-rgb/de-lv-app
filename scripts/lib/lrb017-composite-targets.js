...
const COMPOSITE_BY_ID = {
  "g2/a1/fi|vom|idx:634|study|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": {
    ...
    "study.explanation[0]":
      "Vom on preposition von ja artikkelin dem lyhenne.",
  ...
  "g2/a1/fi|Zug|idx:671|lv; study.translation; study.explanation; study.tip; study.important|WRONG_LANGUAGE|gpt-5.6-luna":
    {
      ...
      "study.important[0]": "der Zug otsikossa tulkittaan junan.",
      "study.important[1]":
        "Harvinaisemmat merkitykset eivät ole tarpeen pääotsikossa A1-tasolla.",
