...
"use strict";
/**
 * Validate FR-DE B1 full audit deliverables.
 */
const fs = require("fs");
const path = require("path");
const { execSync } = require("child_process");
const { ROOT, isSyncedWithWww } = require("./lib/audit-common");
const { loadArray, entryId } = require("./lib/fr-b1-audit-helpers");
const { PRODUCTION_PATH } = require("./lib/fr-b1-discovery-config");
const { getAt } = require("./lib/da-a1-owner-path");

const AUDIT_JSON = path.join(ROOT, "reports/fr-de-b1-full-audit.json");
const OWNER_JSON = path.join(ROOT, "reports/fr-de-b1-full-audit-owner-source.json");
