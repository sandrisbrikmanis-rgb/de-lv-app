#!/usr/bin/env node
/**
 * CS-DE A1 FINAL 702/702 AUDIT ON MAIN — read-only orchestrator (GPT-5.6 Luna).
 * Locks to origin/main @ d658e2b591837e9656bbb322fa039faee2293c8d
 *
 * Usage:
 *   node scripts/audit-cs-a1-final-702-audit-on-main.js
 *   node scripts/audit-cs-a1-final-702-audit-on-main.js --deterministic-only
 *   node scripts/audit-cs-a1-final-702-audit-on-main.js --linguistic-only
 *   node scripts/audit-cs-a1-final-702-audit-on-main.js --validate-only
 */
...
const EXPECTED_MAIN_SHA = 'd658e2b591837e9656bbb322fa039faee2293c8d';
...
const FLAG = '--final-702-audit-on-main';
const ENV = { ...process.env, CS_A1_FINAL_702_AUDIT_ON_MAIN: '1' };
...
function main() {
  ...
  console.log('CS-DE A1 FINAL 702/702 AUDIT ON MAIN');
  ...
  if (!LINGUISTIC_ONLY && !VALIDATE_ONLY) {
    ...
    run(`node scripts/cs-a1-final-702-audit-repair-retention.js`);
  ...
  run(`node scripts/write-cs-a1-final-702-audit-report.js ${FLAG}`);
  console.log('\n=== CS-DE A1 final 702 audit on main complete ===');
}
