 ...
 * Usage: OPENAI_API_KEY=... node scripts/audit-da-kurss-full-luna-api.js [--force]
 */
const fs = require("fs");
...
async function main() {
  if (!fs.existsSync(LUNA_DIR)) {
    console.error("Luna batch dir missing. Run: node scripts/audit-da-kurss-full.js --export-only");
    process.exit(1);
  }
