...
function note(lang, cardKey) {
  ...
  if (lang === "fr") {
    return `FR ${card} full composite repair from data/fr/a1.js merge: LV/ET leak → French; DE↔FR aligned. DE untouched.`;
  }
  ...
  JSON.stringify(
    {
      ...
      nelabot,
      pending: 0,
      fr_rows: Object.values(FINDING_TO_LANG).filter((l) => l === "fr").length,
