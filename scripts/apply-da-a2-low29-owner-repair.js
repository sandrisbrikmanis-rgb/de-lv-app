...
"use strict";
/**
 * COPY-ONLY apply for 29 LOW sectionAccent owner decisions only.
 */
const fs = require("fs");
...
const MAP = path.join(ROOT, "reports/temp/da-a2-low29-owner-apply-map.json");
const LOG = path.join(ROOT, "reports/temp/da-a2-low29-owner-apply-log.json");
...
function main() {
  execSync("node scripts/build-da-a2-low29-owner-apply-map.js", { cwd: ROOT, stdio: "pipe" });
