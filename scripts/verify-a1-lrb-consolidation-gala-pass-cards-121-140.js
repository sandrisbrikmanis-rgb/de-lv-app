...
function main() {
  ...
  if (copyPaste.cards_121_140_gala_pass?.classification !== PASS_CLASSIFICATION) {
  ...
  if (proof && proof.cards_121_140_payload_sha256 !== liveSha) {
    blockers.push("cards_121_140_payload_sha_mismatch");
  }
  ...
  const out = {
    ...
    cards_121_140_payload_sha256: liveSha,
