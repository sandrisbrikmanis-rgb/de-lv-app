#!/usr/bin/env node
/**
 * BS-DE A1 audit report generator (read-only). Writes reports/temp/bs-b1-findings-consolidated.json
 */
const fs = require("fs");
...
const OUT = path.join(ROOT, "reports", "temp", "bs-b1-findings-consolidated.json");
...
function main() {
  ...
  function add(f) {
    ...
    seen.add(key);
    findings.push({ ...f, file: "data/bs/b1.js" });
  }
