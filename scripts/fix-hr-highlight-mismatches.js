#!/usr/bin/env node
/**
 * Fixes sectionAccents "term does not appear in text" mismatches for HR
 * (data/hr/{level}.js), the same class of defect the ET-DE audit found via
...
fs.writeFileSync("/tmp/hr-highlight-unresolved-sample.json", JSON.stringify(unresolvedSample, null, 1));
