...
const ET_LEAK =
  /\b(Kasutama|Mägi|Parem|Parim|Kasutama|Õhtu|Aga|Järgima|Aadress|Lihtne|Üks|Jäätise|Üksteist|Vanemad|Lõpp|eesti keeles|latviaksi|umbmäärane)\b/i;
...
const proof = {
  ...
  nelabot_cards: ["deutsch", "dritte", "Ei"],
  failures: issues,
  verdict: pass
    ? "LRB_008_FULL_50_50_LINGUISTIC_REVIEW_PASS"
    : "LRB_008_LINGUISTIC_REVIEW_BLOCKED",
