...
"use strict";
/**
 * Validate ES-DE module full audit deliverables.
 * Usage: node scripts/validate-es-de-module-full-audit.js --module=b2|c1|c2|sentences|verbs
 */
const fs = require("fs");
...
const { loadArray, resolveCard, normalizeFieldPath } = require("./lib/es-de-audit-helpers");
