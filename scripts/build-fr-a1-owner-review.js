...
"use strict";
/**
 * Build FR–DE A1 OWNER-PREP package per PROJECT_LANGUAGE_MASTER_STANDARD.md §7.6 / §7.10.
 */
const fs = require("fs");
...
const AUDIT_JSON = path.join(ROOT, "reports/temp/fr-a1-full-audit.json");
const VALIDATION_JSON = path.join(ROOT, "reports/temp/fr-a1-pr603-owner-history-validation.json");
const HISTORY_FILTER = process.argv.includes("--history-filtered") || process.env.OWNER_HISTORY_FILTER === "1";
const AUDIT_MD = "fr-a1-full-audit.md";
const VALIDATION_MD = "fr-a1-pr603-owner-history-validation.md";
...
const OUT = {
  view: path.join(ROOT, "reports/fr-a1-owner-view.md"),
  decisions: path.join(ROOT, "reports/fr-a1-owner-decisions.md"),
  github: path.join(ROOT, "reports/fr-a1-owner-review-GITHUB.md"),
  readme: path.join(ROOT, "reports/fr-a1-owner-review-README.md"),
};
...
function loadFindings() {
  if (!fs.existsSync(AUDIT_JSON)) {
    console.error(`Missing ${AUDIT_JSON}. Run: node scripts/run-fr-a1-full-audit.js`);
    process.exit(1);
  }
...
function buildView(findings) {
  cleanStaleGroupFiles("fr-a1-owner-view");
  cleanStaleGroupFiles("fr-a1-owner-decisions");
  const groups = [];
  ...
  groups.forEach((slice, gi) => {
    ...
    const viewName = `fr-a1-owner-view-group${id}.md`;
    const decName = `fr-a1-owner-decisions-group${id}.md`;
    ...
    const content = [
      ...
      "| Navigācija | Saite |",
      "|------------|-------|",
      `| GitHub indekss | [fr-a1-owner-review-GITHUB.md](${gh("reports/fr-a1-owner-review-GITHUB.md")}) |`,
      `| OWNER VIEW (visi) | [fr-a1-owner-view.md](${gh("reports/fr-a1-owner-view.md")}) |`,
      `| Decisions (šī grupa) | [${decName}](${gh(decRel)}) |`,
      `| Decisions (viss) | [fr-a1-owner-decisions.md](${gh("reports/fr-a1-owner-decisions.md")}) |`,
      "",
  ...
  const main = [
    ...
    "|-------|--------|",
    `| GitHub indekss | [fr-a1-owner-review-GITHUB.md](${gh("reports/fr-a1-owner-review-GITHUB.md")}) |`,
    `| OWNER README | [fr-a1-owner-review-README.md](${gh("reports/fr-a1-owner-review-README.md")}) |`,
    `| OWNER DECISIONS | [fr-a1-owner-decisions.md](${gh("reports/fr-a1-owner-decisions.md")}) |`,
...
function buildDecisions(findings, groupFiles) {
  const header = [
    ...
    "|-------|--------|",
    `| GitHub indekss | [fr-a1-owner-review-GITHUB.md](${gh("reports/fr-a1-owner-review-GITHUB.md")}) |`,
    `| OWNER VIEW | [fr-a1-owner-view.md](${gh("reports/fr-a1-owner-view.md")}) |`,
    ...groupFiles.map(
...
function buildReadme(findings, groupFiles) {
  ...
  const content = [
    ...
    `**Audit PR:** [#${PR_NUMBER}](https://github.com/${REPO}/pull/${PR_NUMBER})`,
    "",
    `Avots: [${AUDIT_MD}](${gh(`reports/${AUDIT_MD}`)}) · [History validation](${gh(`reports/${VALIDATION_MD}`)}) · [GitHub indekss](${gh("reports/fr-a1-owner-review-GITHUB.md")})`,
    "",
    "## Kopsavilkums",
    "",
    "| Metrika | Skaitlis |",
    ...
    "| Tips | Fails | Apraksts |",
    "|------|-------|----------|",
    `| README | [fr-a1-owner-review-README.md](${gh("reports/fr-a1-owner-review-README.md")}) | Šis fails |`,
    `| Indekss | [fr-a1-owner-review-GITHUB.md](${gh("reports/fr-a1-owner-review-GITHUB.md")}) | Visas saites |`,
    `| VIEW | [fr-a1-owner-view.md](${gh("reports/fr-a1-owner-view.md")}) | Cilvēkam ērts pārskats |`,
    `| DECISIONS | [fr-a1-owner-decisions.md](${gh("reports/fr-a1-owner-decisions.md")}) | **Aizpildīt šeit** — PENDING |`,
    "",
    "## Grupas",
    "",
    ...
    "3. Konsolidē lēmumus `fr-a1-owner-decisions.md` vai group failos.",
...
function buildGithub(findings, groupFiles, coverage, auditData) {
  ...
  const content = [
    ...
    "| Fails | Apraksts |",
    "|-------|----------|",
    `| [OWNER README](${gh("reports/fr-a1-owner-review-README.md")}) | Workflow un kopsavilkums |`,
    `| [Šis indekss](${gh("reports/fr-a1-owner-review-GITHUB.md")}) | Visas GitHub saites |`,
    ...
    "|------|-------|",
    `| OWNER VIEW | [fr-a1-owner-view.md](${gh("reports/fr-a1-owner-view.md")}) |`,
    `| OWNER DECISIONS (PENDING) | [fr-a1-owner-decisions.md](${gh("reports/fr-a1-owner-decisions.md")}) |`,
    `| Audit JSON | [fr-a1-full-audit.json](${gh("reports/fr-a1-full-audit.json")}) |`,
    ...
    "## OWNER workflow",
    "",
    `1. Atver [OWNER VIEW](${gh("reports/fr-a1-owner-view.md")}) un [OWNER DECISIONS](${gh("reports/fr-a1-owner-decisions.md")}) (vai grupu pāri).`,
    "2. Katram finding — aizpildi OWNER STATUS un OWNER_DECISION (precīzs ET teksts LABOT gadījumā).",
    "3. Atgriez aizpildītu `fr-a1-owner-decisions.md` COPY-ONLY remontam.",
    "",
    "**Production changes = 0 · DE changes = 0**",
    "",
  ].join("\n");
