...
const ET_LEAK =
  /\b(Naisõpetaja|Kerge|Kahjuks|Õppima|Lugema|Viimane|Inimesed|Valgus|Armastus|Armastama|Laul|Limonaad|Joonlaud|Nimekiri|Liiter|Lusikas|Õhk|Lõbus|Tüdruk|Söögikord|Vahel|Mandariin|Moos|Märts|Hiir|Jahu|Rohkem|Minu|Inimene|Nuga|Meeter|Piim|Miljon|Minut|Kaasa võtma|Keskpäev|Lõunasöök|Vasakule|Vasak|Maalima|Värvima|Vaikne|Asuma|Lamama|Tegema|Valmistama|Kord|Mees|Abikaasa|Põhiidee|Avama|Sageli|Ilma|Kõrv|Oktoober|Onu|Apelsin|Lihavõtted|Paber|Vaheaeg|Isik|Hobune|Taim|Pitsa|Plaan|Koht|Politsei|Hind|Proovima|Probleem|Kampsun|Puhastama|Jalgrattaga|Kustutuskumm|Suitsetama|Paremale|Parem|Rääkima|Vihm|Vihmavari|Vihma sadama|Riis|Õige|Roos|Punane|Hüüdma|Ümmargune|Asi|Mahl|Ütlema|Sool|Puhas|Sobima|See sobib|tähendab peamiselt|eesti keeles|Latviaksi|Palun, ole vaikne|Ma olen|Ma teen|Ma panen|Ma tulen|Mul ei ole|Kes see|Mis see|Milline ilm|Ilm on|Me räägime|Homme läheb|Ma lähen|Me läheme)\b/i;
...
const FORBIDDEN_FRAGMENTS = {
  "g2/a1/fi|vor|idx:636|study|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Atceries", "Põhiidee"],
  "g2/a1/fi|wenn|idx:655|study|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Atceries", "Põhiidee"],
  "g2/a1/fi|werden|idx:657|lv; study.translation; study.explanation; study.tip; study.important|WRONG_LANGUAGE|gpt-5.6-luna": ["Atceries", "Põhiidee", "saama"],
  "g2/a1/fi|Zug|idx:671|lv; study.translation; study.explanation; study.tip; study.important|WRONG_LANGUAGE|gpt-5.6-luna": ["Atceries", "rong"],
  [WER_ID]: ["Mis see on", "Põhiidee"],
};

const SOURCE_FIDELITY = {};

const COMPOSITE_REQUIRED = {
  "g2/a1/fi|vom|idx:634|study|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Pääajatus", "von dem", "rautatieasemalta"],
  "g2/a1/fi|vor|idx:636|study|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Ennen", "Edessä", "Pääajatus"],
  "g2/a1/fi|was|idx:644|study|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Mitä", "Mikä", "Pääajatus"],
  "g2/a1/fi|wenn|idx:655|study|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Jos", "Kun", "Pääajatus"],
  [WER_ID]: ["Kuka", "Pääajatus", "Kuka se on?"],
  "g2/a1/fi|werden|idx:657|lv; study.translation; study.explanation; study.tip; study.important|WRONG_LANGUAGE|gpt-5.6-luna": ["Tulla", "Pääajatus"],
  "g2/a1/fi|Wetter|idx:658|lv; study.translation; study.explanation; study.tip; study.important|WRONG_LANGUAGE|gpt-5.6-luna": ["Sää", "Pääajatus"],
  "g2/a1/fi|wie|idx:660|lv; study.translation; study.explanation; study.tip; study.important|WRONG_LANGUAGE|gpt-5.6-luna": ["Miten", "Kuinka", "Pääajatus"],
  "g2/a1/fi|Zeit|idx:699|lv, study|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Aika", "Pääajatus", "Minulla ei ole aikaa"],
  "g2/a1/fi|zu|idx:668|lv; study.translation; study.explanation; study.tip; study.important|WRONG_LANGUAGE|gpt-5.6-luna": ["-lle", "Liian", "Pääajatus"],
  "g2/a1/fi|Zug|idx:671|lv; study.translation; study.explanation; study.tip; study.important|WRONG_LANGUAGE|gpt-5.6-luna": ["Juna", "Pääajatus"],
};
...
const STALE_HIGHLIGHT =
  /\b(Atceries|Põhiidee|aega|ilm|Pulkstenis|Laiks)\b/i;
...
if (labot !== 49) {
  issues.push({ type: "LABOT_COUNT", msg: `expected 49 LABOT, got ${labot}` });
  semanticViolations++;
}
...
const proof = {
  batch_id: BATCH,
  classification: pass
    ? "LRB_017_FULL_50_50_LINGUISTIC_REVIEW_PASS"
    : "LRB_017_LINGUISTIC_REVIEW_BLOCKED",
  pdf_reaudit: true,
