...
const ET_LEAK_FI =
  /\b(Kellestki|millestki|Päritolu|Vastand|Vastuväide|Siiski|Seega|Järelikult|Juures|Peal|Ligi|Pinna küljes|Serva ääres|Välja|Tooma|Viima|Kuhu\?)\b/i;

const FI_EXPECTED = {
  "g2/a1/fi|a1-ab|a1.card.a1-ab.study.comparison[1].meaning|MULTI_TRANSLATION|deterministic/multi-translation":
    "Jostakin • Alkuperä",
  "g2/a1/fi|a1-aber|a1.card.a1-aber.study.comparison[0].meaning|MULTI_TRANSLATION|deterministic/multi-translation":
    "Vastakohta • Vastaväite • Kuitenkin",
  "g2/a1/fi|a1-also|a1.card.a1-also.study.comparison[0].meaning|MULTI_TRANSLATION|deterministic/multi-translation":
    "Siis • Näin ollen",
  "g2/a1/fi|a1-an|a1.card.a1-an.native|MULTI_TRANSLATION|deterministic/multi-translation":
    "Luona • Päällä • Lähellä",
  "g2/a1/fi|a1-an|a1.card.a1-an.study.translation|MULTI_TRANSLATION|deterministic/multi-translation":
    "Kiinni • Pinnalla • Reunalla",
  "g2/a1/fi|a1-aufs|a1.card.a1-aufs.native|MULTI_TRANSLATION|deterministic/multi-translation":
    "Päälle • Pinnalle • Minne?",
  "g2/a1/fi|a1-aufs|a1.card.a1-aufs.study.translation|MULTI_TRANSLATION|deterministic/multi-translation":
    "Päälle • Pinnalle • Minne?",
  "g2/a1/fi|a1-aus|a1.card.a1-aus.native|MULTI_TRANSLATION|deterministic/multi-translation":
    "-sta/-stä • Ulos",
  "g2/a1/fi|a1-aus|a1.card.a1-aus.study.translation|MULTI_TRANSLATION|deterministic/multi-translation":
    "-sta/-stä • Ulos",
  "g2/a1/fi|a1-besuch|a1.card.a1-besuch.study.comparison[0].meaning|MULTI_TRANSLATION|deterministic/multi-translation":
    "Käynti • Vierailu • Kyläily",
  "g2/a1/fi|a1-besuchen|a1.card.a1-besuchen.study.comparison[0].meaning|MULTI_TRANSLATION|deterministic/multi-translation":
    "Vierailla paikassa tai tapahtumassa • Käydä jonkun luona",
  "g2/a1/fi|a1-bringen|a1.card.a1-bringen.native|MULTI_TRANSLATION|deterministic/multi-translation":
    "Tuoda • Viedä",
  "g2/a1/fi|a1-bringen|a1.card.a1-bringen.study.translation|MULTI_TRANSLATION|deterministic/multi-translation":
    "Tuoda • Viedä",
};
...
const LABOT_EXPECTED = {
  ...
  "g2/a1/et|essen|idx:690|lv, study.*|LANGUAGE_MISMATCH|gpt-5.6-luna": {
    lv: "sööma",
  ...
  "g2/a1/et|Fernsehen|idx:688|lv, study.*|LANGUAGE_MISMATCH|gpt-5.6-luna": {
    lv: "televisioon",
  ...
  "g2/a1/et|sie|idx:549|lv; study.*|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": {
    lv: "nemad / nad",
    "study.examples[1].lv": "Ta teeb süüa.",
    "study.important[1]":
      "Viisakas Teie (Sie kochen, bitte.) õpetatakse Sie-kaardil, mitte siin.",
  },
  "g2/a1/et|sollen|idx:564|lv; study.*|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": {
...
const FORBIDDEN_FRAGMENTS = {
  ...
  "g2/a1/et|sollen|idx:564|lv; study.*|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": [
    ...
    "peab midagi tegema juhise järgi",
  ],
};
...
const DE_EXAMPLE_ALIGN = {
  ...
  "g2/a1/et|essen|idx:690|lv, study.*|LANGUAGE_MISMATCH|gpt-5.6-luna": {
    "Ich esse gern Pizza.": "Ma söön meelsasti pitsat.",
    "Das Essen ist fertig.": "Toit on valmis.",
    "Das Essen schmeckt sehr gut.": "Toit maitseb väga hästi.",
  },
  "g2/a1/et|Fernsehen|idx:688|lv, study.*|LANGUAGE_MISMATCH|gpt-5.6-luna": {
    "Was gibt es heute im Fernsehen?": "Mida täna televisioonis näidatakse?",
    "Ich sehe heute Abend fern.": "Täna õhtul vaatan ma telerit.",
    "Das Fernsehen ist heute langweilig.": "Televisiooniprogramm on täna igav.",
  },
  "g2/a1/et|morgen|idx:417|lv; study.explanation; study.examples; study.tip; study.important|WRONG_TARGET_LANGUAGE|gpt-5.6-luna": {
  ...
  "g2/a1/et|sie|idx:549|lv; study.*|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": {
    "Sie kochen.": "Nad teevad süüa.",
    "Sie kocht.": "Ta teeb süüa.",
    "Sie isst.": "Ta sööb.",
    "Sie spielen Fußball.": "Nad mängivad jalgpalli.",
  },
  "g2/a1/et|sollen|idx:564|lv; study.*|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": {
    "Was soll ich machen?": "Mida ma peaksin tegema?",
    "Ich muss jetzt gehen.": "Ma pean nüüd minema.",
    cmp0: "Was soll ich machen? – Mida ma peaksin tegema?",
    cmp1: "Ich muss gehen. – Ma pean minema.",
  },
};

const INTERNAL_CONTRADICTION_CHECKS = {
  "g2/a1/et|essen|idx:690|lv, study.*|LANGUAGE_MISMATCH|gpt-5.6-luna": (merged) => {
    const expl = flattenStrings(merged.study?.explanation || []).join(" ");
    if (/\bessen tähendab peamiselt: toit\b/i.test(expl))
      return "essen explained as toit/söögikord";
    if (merged.lv !== "sööma") return `lv=${merged.lv} not sööma`;
    return null;
  },
  "g2/a1/et|Fernsehen|idx:688|lv, study.*|LANGUAGE_MISMATCH|gpt-5.6-luna": (merged) => {
    const expl = flattenStrings(merged.study?.explanation || []).join(" ");
    if (/das Fernsehen tähendab peamiselt: saadet vaatama/i.test(expl))
      return "das Fernsehen = saadet vaatama";
    return null;
  },
  "g2/a1/et|sollen|idx:564|lv; study.*|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": (merged) => {
  ...
  "g2/a1/et|sie|idx:549|lv; study.*|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": (merged) => {
    ...
    if (!Array.isArray(examples)) return null;
    for (const ex of examples) {
      if (ex?.de === "Sie kocht." && /nad/i.test(ex.lv || ""))
        return "Sie kocht translated as plural nad";
      if (ex?.de === "Sie kochen." && /ta teeb/i.test(ex.lv || ""))
        return "Sie kochen translated as singular ta";
    }
    return null;
  },
};
...
function extractOwnerValue(ownerNewStr, fieldPath) {
  const patches = JSON.parse(ownerNewStr);
  if (fieldPath.endsWith(".native")) return patches.lv;
...
for (const row of rows) {
  ...
  if (row.languages === "fi" && ET_LEAK_FI.test(allText)) {
    wrongLanguage++;
    issues.push({ id, type: "WRONG_LANG_ET_FI", msg: allText.slice(0, 120) });
  }
  ...
  if (d.owner_decision === "LABOT") {
    if (row.languages === "fi") {
      const expected = FI_EXPECTED[id];
      const ownerVal = extractOwnerValue(d.owner_new, row.field_path);
      if (!expected) {
        issues.push({ id, type: "NO_FI_EXPECTED", msg: "FI LABOT missing FI_EXPECTED" });
        semanticViolations++;
      } else if (String(ownerVal) !== expected) {
        semanticViolations++;
        issues.push({
          id,
          type: "FI_EXPECTED_MISMATCH",
          expected,
          got: ownerVal,
        });
      }
      if (ownerVal && hasDupes(ownerVal)) {
        duplicateMeanings++;
        issues.push({ id, type: "DUPLICATE", msg: ownerVal });
      }
      const srcSegs = segments(row.lv_source);
      const outSegs = segments(ownerVal);
      if (outSegs.length < srcSegs.length) {
        semanticNarrowingFromSource += srcSegs.length - outSegs.length;
        issues.push({
          id,
          type: "SEMANTIC_NARROWING_FROM_SOURCE",
          msg: `${outSegs.length} < ${srcSegs.length}: ${ownerVal}`,
        });
      }
    } else {
    ...
    if (srcFid && row.languages === "et") {
      ...
      if (segs.length < srcFid.maxSegments) {
        semanticNarrowingFromSource += srcFid.maxSegments - segs.length;
        issues.push({
          id,
          type: "SEMANTIC_NARROWING_FROM_SOURCE",
          msg: `${segs.length} < ${srcFid.maxSegments}: ${lvVal}`,
    ...
    if (row.languages === "et") {
      ...
      const contradiction = INTERNAL_CONTRADICTION_CHECKS[id];
      if (contradiction) {
        const msg = contradiction(merged);
        if (msg) {
          internalCardContradictions++;
          semanticViolations++;
          issues.push({ id, type: "INTERNAL_CONTRADICTION", msg });
        }
      }

      const requiredStudyKeys = [
        "translation",
        "explanation",
        "examples",
        "comparison",
      ...
      const prodStudy = flatToNested(flat).study || {};
      for (const key of requiredStudyKeys) {
        if (prodStudy[key] != null && merged.study?.[key] == null) {
          fullCompositeCompletenessFails++;
          issues.push({
            id,
            type: "COMPOSITE_INCOMPLETE",
            field: `study.${key}`,
          });
        }
      }
...
const fullCompositeCompleteness =
  fullCompositeCompletenessFails === 0 ? "PASS" : "FAIL";
