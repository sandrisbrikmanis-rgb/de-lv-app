...
function main() {
  ...
  if (copyPaste.cards_181_200_gala_pass?.classification !== PASS_CLASSIFICATION) {
  ...
  if (proof && proof.cards_181_200_payload_sha256 !== liveSha) {
    blockers.push("cards_181_200_payload_sha_mismatch");
  }
  ...
  const out = {
    ...
    cards_181_200_payload_sha256: liveSha,
