...
if (Object.keys(COMPOSITE_TARGETS).length !== 13) {
  console.error(`Expected 13 composites, got ${Object.keys(COMPOSITE_TARGETS).length}`);
  process.exit(1);
}
...
const ET_LEAK =
  /\b(Naisõpetaja|Kerge|Kahjuks|Õppima|Lugema|Viimane|Inimesed|Valgus|Kallis|Armastus|Armastama|Laul|Limonaad|Joonlaud|Nimekiri|Liiter|Lusikas|Õhk|Lõbus|Tüdruk|Söögikord|Vahel|Mandariin|Moos|Märts|Hiir|Jahu|Rohkem|Minu|Inimene|Nuga|Meeter|Piim|Miljon|Minut|Kaasa võtma|Keskpäev|Lõunasöök|Vasakule|Vasak|Maalima|Värvima|Vaikne|Asuma|Lamama|Tegema|Valmistama|Kord|Mees|Abikaasa|Põhiidee|Meeldima|Homme|Hommik|Pidama|Võtma|Uus|Veel kord|Veel|Muidugi|Loomulik|tähendab peamiselt|eesti keeles|Latviaksi|Palun, ole vaikne|Ma olen|Ma teen|Ma panen)\b/i;

const LV_LEAK =
  /\b(Atceries|Galvenā doma|latviaksi|kaut kas|nedaudz|dzirdēt|klausīties|Latvian kieli)\b/i;

const FORBIDDEN_FRAGMENTS = {
  "g2/a1/fi|mögen|idx:413|lv; study.explanation; study.important|TARGET_LANGUAGE_ISSUE|gpt-5.6-luna": ["Meeldima", "Põhiidee"],
  "g2/a1/fi|morgen|idx:417|lv; study.explanation; study.tip; study.important|TARGET_LANGUAGE_ISSUE|gpt-5.6-luna": ["Homme", "Põhiidee"],
  "g2/a1/fi|Morgen|idx:418|lv; study.explanation; study.tip; study.important|TARGET_LANGUAGE_ISSUE|gpt-5.6-luna": ["Hommik", "Põhiidee"],
  "g2/a1/fi|müssen|idx:423|lv, study.translation, study.explanation, study.examples, study.comparison, study.tip, study.important|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Pidama", "Põhiidee"],
  "g2/a1/fi|nach|idx:426|lv, study.translation, study.explanation, study.examples, study.comparison, study.tip, study.important|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Pärast", "Põhiidee"],
  "g2/a1/fi|natürlich|idx:433|lv, study.translation, study.explanation, study.examples, study.tip, study.important|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Muidugi", "Loomulik", "Põhiidee"],
  "g2/a1/fi|nehmen|idx:435|lv, study.translation, study.explanation, study.examples, study.comparison, study.tip, study.important|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Võtma", "Põhiidee"],
  "g2/a1/fi|neu|idx:439|lv, study.translation, study.explanation, study.examples, study.tip, study.important|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Põhiidee"],
  "g2/a1/fi|noch mal|idx:701|lv, study|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Veel kord", "Põhiidee"],
  "g2/a1/fi|noch|idx:451|lv; study.explanation; study.tip; study.important|TARGET_LANGUAGE_ERROR|gpt-5.6-luna": ["Veel", "Põhiidee"],
  "g2/a1/fi|nur|idx:456|lv; study.explanation; study.tip; study.important|TARGET_LANGUAGE_ERROR|gpt-5.6-luna": ["Ainult", "Põhiidee"],
  "g2/a1/fi|ob|idx:457|lv; study.explanation; study.important|TARGET_LANGUAGE_ERROR|gpt-5.6-luna": ["Kas", "Põhiidee"],
  "g2/a1/fi|oder|idx:459|lv; study.explanation; study.important|TARGET_LANGUAGE_ERROR|gpt-5.6-luna": ["Või", "Põhiidee"],
  "g2/a1/fi|nicht|idx:447|lv|TARGET_LANGUAGE|gpt-5.6-luna": ["Ei"]
};

const SOURCE_FIDELITY = {
  "g2/a1/fi|nicht|idx:447|lv|TARGET_LANGUAGE|gpt-5.6-luna": { maxSegments: 1 },
};

const COMPOSITE_REQUIRED = {
  "g2/a1/fi|mögen|idx:413|lv; study.explanation; study.important|TARGET_LANGUAGE_ISSUE|gpt-5.6-luna": ["Tykätä", "möchte"],
  "g2/a1/fi|morgen|idx:417|lv; study.explanation; study.tip; study.important|TARGET_LANGUAGE_ISSUE|gpt-5.6-luna": ["Huomenna", "morgen = huomenna"],
  "g2/a1/fi|Morgen|idx:418|lv; study.explanation; study.tip; study.important|TARGET_LANGUAGE_ISSUE|gpt-5.6-luna": ["Aamu", "der Morgen"],
  "g2/a1/fi|müssen|idx:423|lv, study.translation, study.explanation, study.examples, study.comparison, study.tip, study.important|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Täytyä", "Ich muss"],
  "g2/a1/fi|nach|idx:426|lv, study.translation, study.explanation, study.examples, study.comparison, study.tip, study.important|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["-Väliin", "nach Hause"],
  "g2/a1/fi|natürlich|idx:433|lv, study.translation, study.explanation, study.examples, study.tip, study.important|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Tietysti", "luonnollinen"],
  "g2/a1/fi|nehmen|idx:435|lv, study.translation, study.explanation, study.examples, study.comparison, study.tip, study.important|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Ottaa", "bringen"],
  "g2/a1/fi|neu|idx:439|lv, study.translation, study.explanation, study.examples, study.tip, study.important|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Uusi (asioista)", "jung"],
  "g2/a1/fi|noch mal|idx:701|lv, study|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": ["Uudestaan", "uudestaan"],
  "g2/a1/fi|noch|idx:451|lv; study.explanation; study.tip; study.important|TARGET_LANGUAGE_ERROR|gpt-5.6-luna": ["Vielä", "noch = vielä"],
  "g2/a1/fi|nur|idx:456|lv; study.explanation; study.tip; study.important|TARGET_LANGUAGE_ERROR|gpt-5.6-luna": ["Vain", "ainoastaan"],
  "g2/a1/fi|ob|idx:457|lv; study.explanation; study.important|TARGET_LANGUAGE_ERROR|gpt-5.6-luna": ["-ko/-kö", "oder"],
  "g2/a1/fi|oder|idx:459|lv; study.explanation; study.important|TARGET_LANGUAGE_ERROR|gpt-5.6-luna": ["Vai", "ob"]
};

const DE_EXAMPLE_ALIGN = {
  "g2/a1/fi|müssen|idx:423|lv, study.translation, study.explanation, study.examples, study.comparison, study.tip, study.important|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": {
    "Ich muss gehen.": "Minun täytyy lähteä.",
    "Ich muss heute arbeiten.": "Minun täytyy työskennellä tänään."
  },
  "g2/a1/fi|nach|idx:426|lv, study.translation, study.explanation, study.examples, study.comparison, study.tip, study.important|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": {
    "Ich fahre nach Berlin.": "Ajan Berliiniin.",
    "Wir gehen nach Hause.": "Menemme kotiin."
  },
  "g2/a1/fi|natürlich|idx:433|lv, study.translation, study.explanation, study.examples, study.tip, study.important|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": {
    "Kommst du mit? – Natürlich!": "Tuletko mukaan? – Tietysti!"
  },
  "g2/a1/fi|nehmen|idx:435|lv, study.translation, study.explanation, study.examples, study.comparison, study.tip, study.important|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": {
    "Nimm das Buch!": "Ota kirja!",
    "Ich bringe dir das Buch.": "Tuon sinulle kirjan."
  },
  "g2/a1/fi|neu|idx:439|lv, study.translation, study.explanation, study.examples, study.tip, study.important|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": {
    "Mein Handy ist neu.": "Puhelimeni on uusi.",
    "Wir haben ein neues Auto.": "Meillä on uusi auto."
  },
  "g2/a1/fi|noch mal|idx:701|lv, study|TARGET_LANGUAGE_MISMATCH|gpt-5.6-luna": {
    "Noch mal, bitte.": "Uudestaan, olkaa hyvä.",
    "Sag das noch mal.": "Sano se uudestaan."
  }
};
...
const proof = {
  ...
  pdf_reaudit_repairs: ["nicht", "noch mal"],
  row_audit: rowAudit,
  failures: issues,
  verdict: pass
    ? "LRB_013_FULL_50_50_LINGUISTIC_REVIEW_PASS"
