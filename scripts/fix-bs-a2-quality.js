#!/usr/bin/env node
/**
 * BS-DE A2 quality fix: remove Latvian remnants and correct base-form translations.
 */
const fs = require("fs");
...
const LV_SOURCE = path.join(ROOT, "data", "a2.js");
...
const REPORT_PATH = path.join(ROOT, "scripts", ".bs-a2-quality-fix-report.json");
...
async function main() {
  ...
  console.log("Fixing 1640 main Bosnian translations...");
  ...
  writeA2(BS_FILE, fixedWords);
  writeA2(WWW_FILE, fixedWords);
  saveCache(cache);
