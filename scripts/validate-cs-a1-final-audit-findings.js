...
const STUDY_GAP_CARDS = isFinal702AuditOnMainA1("a1") ? new Set() : new Set([
...
const PARTIAL_STUDY_GAP = isFinal702AuditOnMainA1("a1") ? new Set() : new Set(["a1-bitte", "a1-bitte-study", "a1-ein", "a1-es"]);
