...
function buildDataFlow() {
  return {
    rows: [
      ...
      {
        stage: "LRB helper (production path)",
        script: "scripts/lib/g2-a1-lrb-consolidation-owner-review-artifacts.js",
        function: "loadProductionA1Words(lang)",
        fileSource: "dataRel(lang, a1.js) — lv → data/a1.js",
        role: "Production lookup for LRB consolidation",
        authoritativeCurrent: "JĀ (via dataRel)",
        chain: "findProductionEntry → loadProductionA1Words → dataRel",
      },
      {
        stage: "www mirror",
