#!/usr/bin/env node
/**
 * Verify NL-DE creation compliance:
 * 1. German (de) fields in NL data match LV source exactly (READ-ONLY)
...
for (const level of LEVELS) {
  ...
  const nl = loadArray(`data/nl/${level}.js`);
...
const nlSent = loadArray("data/nl/sentences.js");
lvSent.forEach((lv, i) => {
...
const nlVerbs = loadArray("data/nl/verbs.js");
