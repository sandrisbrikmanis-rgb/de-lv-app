#!/usr/bin/env node
/**
 * Fixes sectionAccents "term does not appear in text" mismatches for SL
 * (data/sl/{level}.js), the same class of defect the ET-DE audit found via
 ...
 *
 * Run: node scripts/fix-sl-highlight-mismatches.js [--dry-run]
 */
const fs = require("fs");
...
fs.writeFileSync("/tmp/sl-highlight-unresolved-sample.json", JSON.stringify(unresolvedSample, null, 1));
