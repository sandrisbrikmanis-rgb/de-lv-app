...
["a1", "a2", "b1", "b2", "c1", "c2"].forEach((level) => {
  processJsFile(`data/en/${level}.js`);
});
processJsFile("data/en/sentences.js", "SENTENCE_ENTRIES");
processJsFile("data/en/verbs.js", "VERB_ENTRIES");
processJsFile("data/en/dialogueIdMap.js", "DIALOGUE_ID_MAP");
processJsFile("data/en/courseLessons.js");
// courseTrainingCards.js uses multiple window.* assignments — regenerate separately

console.log("EN name replacement complete.");
