...
function buildReport(ctx) {
  ...
  const lines = [];
  lines.push("# ET–DE A1 pilns lingvistiskais audits (post-closure baseline)");
  lines.push("");
  ...
  lines.push(`| **PR593_FINDINGS_STATUS** | ${ctx.baseline.pr593FindingsStatus} |`);
  lines.push("");
...
async function main() {
  console.log("\n=== ET–DE A1 FULL_DISCOVERY (post-closure) — MASTER v1.5 ===\n");
