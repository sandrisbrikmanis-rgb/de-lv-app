...
function main() {
  ...
  if (copyPaste.cards_101_120_gala_pass?.classification !== PASS_CLASSIFICATION) {
  ...
  if (proof && proof.cards_101_120_payload_sha256 !== liveSha) {
    blockers.push("cards_101_120_payload_sha_mismatch");
  }
  ...
  const out = {
    ...
    cards_101_120_payload_sha256: liveSha,
