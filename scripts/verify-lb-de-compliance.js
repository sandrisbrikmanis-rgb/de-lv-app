#!/usr/bin/env node
/**
 * Verify LB-DE creation compliance:
...
for (const level of LEVELS) {
  ...
  const nl = loadArray(`data/lb/${level}.js`);
...
const nlSent = loadArray("data/lb/sentences.js");
lvSent.forEach((lv, i) => {
...
const nlVerbs = loadArray("data/lb/verbs.js");
