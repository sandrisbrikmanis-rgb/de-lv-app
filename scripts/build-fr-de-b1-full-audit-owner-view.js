...
"use strict";
/**
 * Build FR-DE B1 full audit monolithic OWNER view (MASTER v1.9).
 */
const fs = require("fs");
const path = require("path");
const { ROOT } = require("./lib/audit-common");

const IN_JSON = path.join(ROOT, "reports/fr-de-b1-full-audit.json");
const OUT_MD = path.join(ROOT, "reports/fr-de-b1-full-audit-owner-view.md");
...
function main() {
  ...
  const lines = [
    "# FR–DE B1 — pilns OWNER pārskatīšanas skats",
    "",
