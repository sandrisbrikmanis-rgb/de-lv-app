#!/usr/bin/env node
/**
 * Fix UK-DE sectionAccents highlight terms that don't match section text.
 ...
 *
 * Run: node scripts/fix-uk-section-accents.js [--dry-run]
 */
const fs = require("fs");
...
const UK_FILES = [
  ["data/uk/a1.js", "A1_WORDS"],
  ["data/uk/a2.js", "A2_WORDS"],
  ["data/uk/b1.js", "B1_WORDS"],
  ["data/uk/b2.js", "B2_WORDS"],
  ["data/uk/c1.js", "C1_WORDS"],
  ["data/uk/c2.js", "C2_WORDS"],
  ["data/uk/sentences.js", "SENTENCE_ENTRIES"],
];
...
function ukInflectionCandidates(term) {
  const candidates = [String(term)];
  const t = String(term);
  const stripSuffixes = [
    "ться", "тися", "ннями", "ннях", "ння", "истю", "ості", "ість",
    "ами", "ями", "ах", "ях", "ів", "ий", "ій", "ого", "ому", "ими",
    "ою", "ею", "ти", "ла", "ло", "ли", "в", "а", "я", "е", "є", "і", "и", "у", "ю", "о",
  ];
  const addSuffixes = [
    "ти", "тися", "в", "ла", "ло", "ли", "є", "ю", "уть",
    "а", "и", "і", "у", "ів", "ами", "ах", "ій", "ого", "ому", "е", "я",
  ];
...
function findReplacementInTexts(texts, term) {
  ...
  for (const candidate of [...ukInflectionCandidates(term), ...germanStemCandidates(term)]) {
    for (const text of texts) {
...
for (const [relPath, varName] of UK_FILES) {
