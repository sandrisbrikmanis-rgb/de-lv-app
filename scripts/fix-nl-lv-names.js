...
["a1", "a2", "b1", "b2", "c1", "c2"].forEach((level) => {
  processJsFile(`data/nl/${level}.js`);
});
processJsFile("data/nl/sentences.js", "SENTENCE_ENTRIES");
processJsFile("data/nl/verbs.js", "VERB_ENTRIES");
processJsFile("data/nl/dialogueIdMap.js", "DIALOGUE_ID_MAP");
processJsFile("data/nl/courseLessons.js");
// courseTrainingCards.js uses multiple window.* assignments — regenerate separately

console.log("NL name replacement complete.");
