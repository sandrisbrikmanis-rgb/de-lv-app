...
"use strict";
/**
 * Build FR-DE module OWNER source + view (MASTER v1.9).
 * Usage: node scripts/build-fr-de-module-owner.js --module=b2|c1|c2|sentences|verbs
 */
const fs = require("fs");
...
function main() {
  ...
  const lines = [
    `# FR–DE ${cfg.moduleKey} — pilns OWNER pārskatīšanas skats`,
    "",
