...
const ET_LEAK =
  /\b(Naisõpetaja|Kerge|Kahjuks|Õppima|Lugema|Viimane|Inimesed|Valgus|Armastus|Armastama|Laul|Limonaad|Joonlaud|Nimekiri|Liiter|Lusikas|Õhk|Lõbus|Tüdruk|Söögikord|Vahel|Mandariin|Moos|Märts|Hiir|Jahu|Rohkem|Minu|Inimene|Nuga|Meeter|Piim|Miljon|Minut|Kaasa võtma|Keskpäev|Lõunasöök|Vasakule|Vasak|Maalima|Värvima|Vaikne|Asuma|Lamama|Tegema|Valmistama|Kord|Mees|Abikaasa|Põhiidee|tähendab peamiselt|eesti keeles|Latviaksi|Palun, ole vaikne|Ma olen|Ma teen|Ma panen|Avama|Sageli|Ilma|Kõrv|Oktoober|Onu|Apelsin|Lihavõtted|Paber|Vaheaeg|Isik|Hobune|Taim|Pitsa|Plaan|Koht|Politsei|Hind|Proovima|Probleem|Kampsun|Puhastama|Jalgrattaga|Kustutuskumm|Suitsetama|Paremale|Parem|Rääkima|Vihm|Vihmavari|Vihma sadama|Riis|Õige|Roos|Punane|Hüüdma|Ümmargune|Asi|Mahl|Ütlema|Sool|Puhas|Sobima)\b/i;
...
// Post-PDF-reaudit canonical proof is written by temp-audit-lrb014-pdf-residual.js.
