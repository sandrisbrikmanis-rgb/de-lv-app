...
const BATCH = "LRB-064";
const PASTE_PATH = process.argv[2] || path.join(ROOT, "scripts/data/g2-a1-owner-pending/LRB-064-decisions-COPY-PASTE.json");
const EXPECTED_PASTE_SHA = "9befb369c7968c0589547cab22859dbc6a5e489529db2afdae76db5c8420d740";
...
function main() {
  ...
  const galaOut = {
    ...
    classification: "LRB_064_COPY_PASTE_COMPLETE_AWAITING_GALA_VERDICT",
    cards: galaCards,
  };
