#!/usr/bin/env node
/**
 * Fixes sectionAccents "term does not appear in text" mismatches for ET
 * (data/et/{level}.js), the same class of defect the ET-DE audit found via
 ...
 *
 * Run: node scripts/fix-et-highlight-mismatches.js [--dry-run]
 */
const fs = require("fs");
