#!/usr/bin/env node
/**
 * Generate LB-DE data from NL baseline with batched translation (NL → LB).
...
async function main() {
  ...
  console.log("\nLB-DE data generation complete (NL→LB with LV DE preservation).");
}
