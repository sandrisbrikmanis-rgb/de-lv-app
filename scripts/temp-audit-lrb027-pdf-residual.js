...
const BATCH = "LRB-027";
const EXPECTED_UNIQUE_CARDS = 32;
...
const proof = {
  batch_id: BATCH,
  classification: pass
    ? "LRB_027_OWNER_PREP_READY_FOR_LINGUISTIC_REVIEW"
    : "LRB_027_OWNER_PREP_BLOCKED",
  pdf_reaudit: true,
  ...
  gates: {
    ...
    LABOT: `${labot}/50`,
    NELABOT: nelabot,
    HU_ROWS: `${rows.filter((r) => r.languages === "hu").length}/5`,
    IS_ROWS: `${rows.filter((r) => r.languages === "is").length}/45`,
  ...
  productionSource: "data/hu/a1.js + data/is/a1.js",
  languages: { hu: 5, is: 45 },
