...
function main() {
  ...
  if (copyPaste.cards_061_080_gala_pass?.classification !== PASS_CLASSIFICATION) {
  ...
  if (proof && proof.cards_061_080_payload_sha256 !== liveSha) {
    blockers.push("cards_061_080_payload_sha_mismatch");
  }
  ...
  const out = {
    ...
    cards_061_080_payload_sha256: liveSha,
