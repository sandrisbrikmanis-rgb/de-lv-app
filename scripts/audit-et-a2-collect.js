#!/usr/bin/env node
/**
 * ET-DE A2 full audit collector (read-only). Writes reports/temp/et-a2-audit-data.json
 */
const fs = require("fs");
...
function main() {
  ...
  const data = {
    meta: {
      ...
      lvFile: "data/a2.js",
      etFile: "data/et/a2.js",
      wwwFile: "www/data/et/a2.js",
      lvCount: lv.length,
      etCount: et.length,
    },
  ...
  if (!data.layerIdentity.identical) {
    ...
    data.structural.issues.push({ severity: "critical", message: "data/et/a2.js and www/data/et/a2.js are not identical" });
  }
