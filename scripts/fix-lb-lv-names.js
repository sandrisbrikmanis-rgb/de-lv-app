...
["a1", "a2", "b1", "b2", "c1", "c2"].forEach((level) => {
  processJsFile(`data/lb/${level}.js`);
});
processJsFile("data/lb/sentences.js", "SENTENCE_ENTRIES");
processJsFile("data/lb/verbs.js", "VERB_ENTRIES");
processJsFile("data/lb/dialogueIdMap.js", "DIALOGUE_ID_MAP");
processJsFile("data/lb/courseLessons.js");
