#!/usr/bin/env node
/**
 * ET-DE B2 full audit collector (read-only). Writes reports/temp/et-b2-audit-data.json
 */
const fs = require("fs");
...
const ET_FILE = path.join(ROOT, "data", "et", "b2.js");
const WWW_FILE = path.join(ROOT, "www", "data", "et", "b2.js");
const OUT = path.join(ROOT, "reports", "temp", "et-b2-audit-data.json");
...
function main() {
  ...
  const data = {
    meta: {
      ...
      lvFile: "data/b2.js",
      etFile: "data/et/b2.js",
      wwwFile: "www/data/et/b2.js",
      lvCount: lv.length,
      etCount: et.length,
    },
  ...
  if (!data.layerIdentity.identical) {
    ...
    data.structural.issues.push({ severity: "critical", message: "data/et/b2.js and www/data/et/b2.js are not identical" });
  }
