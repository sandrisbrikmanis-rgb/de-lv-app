#!/usr/bin/env node
/**
 * ET-DE B1 full audit collector (read-only). Writes reports/temp/et-b1-audit-data.json
 */
const fs = require("fs");
...
const OUT = path.join(ROOT, "reports", "temp", "et-b1-audit-data.json");
...
function main() {
  ...
  const data = {
    meta: {
      ...
      lvFile: "data/b1.js",
      etFile: "data/et/b1.js",
      wwwFile: "www/data/et/b1.js",
      lvCount: lv.length,
      etCount: et.length,
    },
  ...
  if (!data.layerIdentity.identical) {
    ...
    data.structural.issues.push({ severity: "critical", message: "data/et/b1.js and www/data/et/b1.js are not identical" });
  }
