...
"use strict";
/**
 * DA–DE B1 OWNER COPY-ONLY repair apply.
 * Usage: node scripts/apply-da-b1-owner-repair.js [--dry-run]
 */
const fs = require("fs");
...
const { getAt, setAt, findEntry, normalizeField } = require("./lib/da-b1-owner-path");

const APPLY_MAP = path.join(ROOT, "reports/temp/da-b1-owner-apply-map.json");
const APPLY_LOG = path.join(ROOT, "reports/temp/da-b1-owner-apply-log.json");
const FILES = [path.join(ROOT, "data/da/b1.js"), path.join(ROOT, "www/data/da/b1.js")];
