#!/usr/bin/env node
/**
 * Fixes sectionAccents "term does not appear in text" mismatches for SR
 * (data/sr/{level}.js), the same class of defect the ET-DE audit found via
