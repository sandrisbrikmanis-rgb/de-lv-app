#!/usr/bin/env node
/**
 * Fixes sectionAccents "term does not appear in text" mismatches for MK
 * (data/mk/{level}.js), the same class of defect the ET-DE audit found via
 ...
 *
 * Run: node scripts/fix-mk-highlight-mismatches.js [--dry-run]
 */
const fs = require("fs");
...
fs.writeFileSync("/tmp/mk-highlight-unresolved-sample.json", JSON.stringify(unresolvedSample, null, 1));
