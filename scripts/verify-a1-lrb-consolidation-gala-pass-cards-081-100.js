...
function main() {
  ...
  if (copyPaste.cards_081_100_gala_pass?.classification !== PASS_CLASSIFICATION) {
  ...
  if (proof && proof.cards_081_100_payload_sha256 !== liveSha) {
    blockers.push("cards_081_100_payload_sha_mismatch");
  }
  ...
  const out = {
    ...
    cards_081_100_payload_sha256: liveSha,
