...
const FORBIDDEN_FRAGMENTS = {
  [PASSEN_ID]: [
    ...
    "Põhiidee",
    "See sobib",
    "sopivaa, istuvaa tai kelvollista",
    "kokoa sopivaksi",
    "hyvin sopivaa"
  ]
};
...
const proof = {
  batch_id: BATCH,
  classification: pass
    ? "LRB_014_FULL_50_50_LINGUISTIC_REVIEW_PASS"
    : "LRB_014_LINGUISTIC_REVIEW_BLOCKED",
  pdf_reaudit: true,
