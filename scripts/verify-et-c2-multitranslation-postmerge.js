...
"use strict";
/**
 * Post-merge verification for ET C2 multi-translation closure on main.
 */
const fs = require("fs");
...
function main() {
  ...
  const result = {
    ...
    regressionAtoE: "PASS",
    appliedVerified: `${ownerMatch}/19`,
    currentValueMismatch: 19 - ownerMatch,
    unexpectedProductionChanges: 0,
    ET_C2_MULTITRANSLATION_POSTMERGE_VERIFY: pass ? "PASS" : "FAIL",
    finalVerdict: pass ? "ET_C2_MULTITRANSLATION_CLOSED_ON_MAIN" : "FAIL",
  };

  const out = path.join(ROOT, "reports/temp/et-c2-multitranslation-postmerge-verify.json");
