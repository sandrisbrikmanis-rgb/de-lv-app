...
"use strict";
/**
 * Validate ES-DE A1+A2 final micro-regression OWNER decisions.
 * Usage: node scripts/validate-es-de-a1-a2-final-micro-regression-owner-decisions.js
 */
const fs = require("fs");
...
const { validateOwnerDecisions } = require("./lib/es-a1-a2-final-micro-regression-owner-map");
...
function main() {
  ...
  console.log(
    JSON.stringify({ verdict: validation.verdict, metrics: validation.metrics, errors: validation.errors }, null, 2),
  );
