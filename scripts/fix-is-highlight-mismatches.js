#!/usr/bin/env node
/**
 * Fixes sectionAccents "term does not appear in text" mismatches for SV
 * (data/is/{level}.js)
...
fs.writeFileSync("/tmp/is-highlight-unresolved-sample.json", JSON.stringify(unresolvedSample, null, 1));
