...
const VALIDATION_JSON = path.join(ROOT, "reports/temp/et-b1-pr603-owner-history-validation.json");
const HISTORY_FILTER = process.argv.includes("--history-filtered") || process.env.OWNER_HISTORY_FILTER === "1";
const AUDIT_MD = "et-b1-full-audit.md";
...
const OUT = {
  view: path.join(ROOT, "reports/et-b1-owner-view.md"),
  decisions: path.join(ROOT, "reports/et-b1-owner-decisions.md"),
  github: path.join(ROOT, "reports/et-b1-owner-review-GITHUB.md"),
  readme: path.join(ROOT, "reports/et-b1-owner-review-README.md"),
};
...
function loadFindings() {
  if (!fs.existsSync(AUDIT_JSON)) {
    console.error(`Missing ${AUDIT_JSON}. Run: node scripts/run-et-b1-full-audit.js`);
    process.exit(1);
  }
  ...
  if (!fs.existsSync(VALIDATION_JSON)) {
    console.error(`Missing ${VALIDATION_JSON}. Run: node scripts/build-et-b1-pr603-owner-history-validation.js`);
    process.exit(1);
  }
  ...
  return filtered.map((f, i) => {
    ...
    const newId = `ET-B1-${String(i + 1).padStart(4, "0")}`;
    return {
      ...f,
      findingId: newId,
...
function buildView(findings) {
  cleanStaleGroupFiles("et-b1-owner-view");
  cleanStaleGroupFiles("et-b1-owner-decisions");
  const groups = [];
  ...
  groups.forEach((slice, gi) => {
    ...
    const viewName = `et-b1-owner-view-group${id}.md`;
    const decName = `et-b1-owner-decisions-group${id}.md`;
    ...
    const content = [
      ...
      `| OWNER VIEW (visi) | [et-b1-owner-view.md](${gh("reports/et-b1-owner-view.md")}) |`,
      `| Decisions (šī grupa) | [${decName}](${gh(decRel)}) |`,
      `| Decisions (viss) | [et-b1-owner-decisions.md](${gh("reports/et-b1-owner-decisions.md")}) |`,
      "",
  ...
  const main = [
    ...
    findings.length > GROUP_SIZE
      ...
      : "> Visi ieraksti sākotnēji **PENDING**. OWNER aizpilda [et-b1-owner-decisions.md](et-b1-owner-decisions.md).",
...
function buildDecisions(findings, groupFiles) {
  const header = [
    ...
    "|-------|--------|",
    `| GitHub indekss | [et-b1-owner-review-GITHUB.md](${gh("reports/et-b1-owner-review-GITHUB.md")}) |`,
    `| OWNER VIEW | [et-b1-owner-view.md](${gh("reports/et-b1-owner-view.md")}) |`,
    ...groupFiles.map(
...
function buildReadme(findings, groupFiles) {
  ...
  const content = [
    ...
    `**Audit PR:** [#${PR_NUMBER}](https://github.com/${REPO}/pull/${PR_NUMBER})`,
    "",
    `Avots: [${AUDIT_MD}](${gh(`reports/${AUDIT_MD}`)}) · [GitHub indekss](${gh("reports/et-b1-owner-review-GITHUB.md")})`,
    "",
    "## Kopsavilkums",
    "",
    "| Metrika | Skaitlis |",
    ...
    "| Tips | Fails | Apraksts |",
    "|------|-------|----------|",
    `| README | [et-b1-owner-review-README.md](${gh("reports/et-b1-owner-review-README.md")}) | Šis fails |`,
    `| Indekss | [et-b1-owner-review-GITHUB.md](${gh("reports/et-b1-owner-review-GITHUB.md")}) | Visas saites |`,
    `| VIEW | [et-b1-owner-view.md](${gh("reports/et-b1-owner-view.md")}) | Cilvēkam ērts pārskats |`,
    `| DECISIONS | [et-b1-owner-decisions.md](${gh("reports/et-b1-owner-decisions.md")}) | **Aizpildīt šeit** — PENDING |`,
    "",
    "## Grupas",
    "",
...
function buildGithub(findings, groupFiles, coverage, auditData) {
  ...
  const content = [
    ...
    "|------|-------|",
    `| OWNER VIEW | [et-b1-owner-view.md](${gh("reports/et-b1-owner-view.md")}) |`,
    `| OWNER DECISIONS (PENDING) | [et-b1-owner-decisions.md](${gh("reports/et-b1-owner-decisions.md")}) |`,
    `| Audit JSON | [et-b1-full-audit.json](${gh("reports/et-b1-full-audit.json")}) |`,
    ...
    "## OWNER workflow",
    "",
    `1. Atver grupu pārus no tabulas zemāk (piem. [VIEW 1–50](${gh("reports/et-b1-owner-view-group01.md")}) + [DECISIONS 1–50](${gh("reports/et-b1-owner-decisions-group01.md")})).`,
    "2. Katram finding — aizpildi OWNER STATUS un OWNER_DECISION (precīzs ET teksts LABOT gadījumā).",
