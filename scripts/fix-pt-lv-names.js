...
["a1", "a2", "b1", "b2", "c1", "c2"].forEach((level) => {
  processJsFile(`data/pt/${level}.js`);
});
processJsFile("data/pt/sentences.js", "SENTENCE_ENTRIES");
processJsFile("data/pt/verbs.js", "VERB_ENTRIES");
processJsFile("data/pt/dialogueIdMap.js", "DIALOGUE_ID_MAP");
processJsFile("data/pt/courseLessons.js");
