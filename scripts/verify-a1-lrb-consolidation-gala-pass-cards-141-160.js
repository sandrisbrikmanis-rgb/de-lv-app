...
function main() {
  ...
  if (copyPaste.cards_141_160_gala_pass?.classification !== PASS_CLASSIFICATION) {
  ...
  if (proof && proof.cards_141_160_payload_sha256 !== liveSha) {
    blockers.push("cards_141_160_payload_sha_mismatch");
  }
  ...
  const out = {
    ...
    cards_141_160_payload_sha256: liveSha,
