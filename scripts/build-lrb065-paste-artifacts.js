...
const EXPECTED_PASTE_SHA =
  "5d3534ca146e57fffd70017a83ea60e3d5c91446208996f2dd466f6e1a2840d5";
...
function resolveCardDecision(mapping, cardObjectId) {
  ...
  if (mapping.labot_full_composite && cardObjectId in mapping.labot_full_composite) {
    ...
    return {
      ...
      owner_note: `LRB-065 OWNER mapping full_card_target_fields: ${cardObjectId}.`,
    };
  }
  if (mapping.labot_scalar && cardObjectId in mapping.labot_scalar) {
    return {
      ...
      replacement_scope: "finding_field_only",
      owner_note: `LRB-065 OWNER mapping scalar lv: ${cardObjectId}.`,
    };
  }
  return null;
}
...
function main() {
  ...
  const expectedInputSha =
    "8d6ffb12f977712074bf38530d95b7dd93e09e589ecd0407fa2bb0e659ab458a";
  ...
  if (labot !== 47 || nelabot !== 3 || pending !== 0) {
  ...
  if (fullCardIds.size !== 9) {
    throw new Error(`Expected 9 full composites, got ${fullCardIds.size}`);
  }
  ...
  const galaOut = {
    ...
    classification:
      mapping.correction_round >= 3
        ? "LRB_065_COPY_PASTE_CORRECTION_3_COMPLETE_AWAITING_GALA_VERDICT"
